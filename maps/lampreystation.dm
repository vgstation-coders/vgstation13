...
// Lamprey Notes placed here so that they never appear on other maps
...
DeadHarold, Project Lead - Station design and formatting, Medbay, Mining, Bars, Bridge, Escape, most of Maintenance, all Hallways, all Warehouses, excavation tunnel outposts, theming and design principles.
Kilozombie, Assistant Architect - Coding and Areas, BaR&DGo, Baby Box, Botany and Kitchen, some Maintenance, the Asteroid, Outposts and Cavern, and Lamprey Notes.

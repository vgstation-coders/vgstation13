...
/obj/item/proc/handle_attack(obj/item/I, mob/living/M as mob, mob/living/user as mob, def_zone, var/mob/originator = null)
	...
	//Moved up here so that critical hits can affect slime pushing

...
/obj/screen/radial/slice/proc/Unlock()
	locked = FALSE
	color = null

/obj/screen/radial/slice/proc/Lock()
	locked = TRUE
	color = grayscale
...
*/
/proc/show_radial_menu(mob/user,atom/anchor,list/choices,var/icon_file,var/tooltip_theme,var/callback/custom_check,var/uniqueid,var/radius,var/min_angle,var/recursive = FALSE, var/close_other_menus)

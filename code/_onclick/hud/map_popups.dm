 ...
 */
/obj/abstract/screen/background
	name = "background"
 ...
 */
/obj/abstract/screen/proc/set_position(x, y, px = 0, py = 0)
	if(assigned_map)
 ...
 * If applicable, "assigned_map" has to be assigned before this proc call.
 */
/obj/abstract/screen/proc/fill_rect(x1, y1, x2, y2)
	if(assigned_map)
 ...
 */
/client/proc/register_map_obj(obj/abstract/screen/screen_obj)
...
/client/proc/setup_popup(popup_name, width = 9, height = 9, \
	...
	var/obj/abstract/screen/background/background = new

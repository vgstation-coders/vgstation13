...
/datum/hud/proc/blob_hud()
	mymob.gui_icons.blob_bgLEFT = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_bgRIGHT = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_coverLEFT = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_coverRIGHT = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_powerbar = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_healthbar = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_spawnblob = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_spawnstrong = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_spawnresource = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_spawnfactory = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_spawnnode = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_spawncore = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_ping = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_rally = getFromPool(/obj/abstract/screen/specialblob)
	...
	mymob.gui_icons.blob_taunt = getFromPool(/obj/abstract/screen/specialblob)
	...
	for(var/i=1;i<=24;i++)
		var/obj/abstract/screen/specialblob/S = getFromPool(/obj/abstract/screen/specialblob)

...
/datum/ZAS_Setting/fire_heat_generation
	name = "Fire - Heat Generation"
	desc = "Subjective exponent for the amount of heat generated by objects burning per tick."
	valtype=ZAS_TYPE_NUMERIC
	value = 1.45

/datum/ZAS_Setting/fire_mass_consumption
	name = "Fire - Mass Consumption Ratio"
	desc = "Subjective multiplier for the amount of mass consumed by objects burning per tick."
	valtype=ZAS_TYPE_NUMERIC
	value = 0.25

/datum/ZAS_Setting/fire_oxygen_consumption
...
/datum/ZAS_Setting/fire_spread_rate
	...
	desc = "Base percent chance for fire to spread from tile to tile."
	valtype=ZAS_TYPE_NUMERIC
	value = 3

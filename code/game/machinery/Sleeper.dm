...
/obj/machinery/sleeper/RefreshParts()
	...
	switch(T)
		...
		if(6 to 8)
			available_options = list(INAPROVALINE = "Inaprovaline", STOXIN = "Soporific", DERMALINE = "Dermaline", BICARIDINE = "Bicaridine", DEXALIN = "Dexalin", IMIDAZOLINE = "Imidazoline", INACUSIATE = "Inacusiate" , TRAMADOL = "Tramadol" , TRICORDRAZINE = "Tricordrazine" )
		else
			available_options = list(INAPROVALINE = "Inaprovaline", STOXIN = "Soporific", DERMALINE = "Dermaline", BICARIDINE = "Bicaridine", DEXALIN = "Dexalin", IMIDAZOLINE = "Imidazoline", INACUSIATE = "Inacusiate" , TRAMADOL = "Tramadol" , TRICORDRAZINE = "Tricordrazine" , HYRONALIN = "Hyronalin" , CHARCOAL = "Activated Charcoal" )

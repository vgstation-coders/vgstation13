...
/obj/machinery/sleeper/RefreshParts()
	...
	switch(T)
		...
		if(6 to 8)
			available_options = list("inaprovaline" = "Inaprovaline", "stoxin" = "Soporific", "dermaline" = "Dermaline", "bicaridine" = "Bicaridine", "dexalin" = "Dexalin", "inacusiate" = "Inacusiate" , "imidazoline" = "Imidazoline" , "tricordrazine" = "Tricordrazine" )
		else
			available_options = list("inaprovaline" = "Inaprovaline", "stoxin" = "Soporific", "dermaline" = "Dermaline", "bicaridine" = "Bicaridine", "dexalin" = "Dexalin", "inacusiate" = "Inacusiate" , "imidazoline" = "Imidazoline" , "tricordrazine" = "Tricordrazine" , "alkysine" = "Alkysine" , "charcoal" = "Activated Charcoal" )

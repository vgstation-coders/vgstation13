...
/obj/machinery/shield/Cross(atom/movable/mover, turf/target = loc, height=1.5, air_group = 0)
...
/obj/machinery/shieldwall/Cross(atom/movable/mover, turf/target = loc, height=1.5, air_group = 0)

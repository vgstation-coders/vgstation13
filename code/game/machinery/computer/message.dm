...
/obj/machinery/computer/message_monitor/attack_hand(var/mob/living/user as mob)
	...
	if(auth)
		...
		dat += {"<h4><dd><A href='?src=\ref[src];auth=1'>&#09;<font color='green'>\[Authenticated\]</font></a>&#09;/
			Server Power: <A href='?src=\ref[src];active=1'>[linkedServer && linkedServer.active ? "<font color='green'>\[On\]</font>":"<font color='red'>\[Off\]</font>"]</a></h4>"}
	else

		dat += {"<h4><dd><A href='?src=\ref[src];auth=1'>&#09;<font color='red'>\[Unauthenticated\]</font></a>&#09;/
			Server Power: <u>[linkedServer && linkedServer.active ? "<font color='green'>\[On\]</font>":"<font color='red'>\[Off\]</font>"]</u></h4>"}
	if(hacking || emagged)
		screen = 2

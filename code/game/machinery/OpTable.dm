...
/obj/machinery/optable/attack_paw(mob/user as mob)
	if ((M_HULK in usr.mutations))
		...
		visible_message("<span class=\"rose\">[usr] destroys the operating table!</span>")
		src.density = 0
		del(src)
...
/obj/machinery/optable/MouseDrop_T(obj/O as obj, mob/user as mob)
	...
	if ((( istype(O, /obj/item/weapon) ) || user.get_active_hand() == O))
		...
		L.resting = 1
		L.loc = src.loc
		visible_message("<span class=\"rose\">[L] has been laid on the operating table by [user].</span>", 3)
...
/obj/machinery/optable/proc/take_victim(mob/living/carbon/C, mob/living/carbon/user as mob)
	if (C == user)
		...
		visible_message("<span class=\"rose\">[C] has been laid on the operating table by [user].</span>", 3)
	if (C.client)

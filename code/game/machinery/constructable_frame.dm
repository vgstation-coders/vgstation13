...
*/
/obj/item/weapon/circuitboard/operation_table
	name = "Circuit board (Operation Table)"
	build_path = "/obj/machinery/optable"
	board_type = "machine"
	origin_tech = "programming=2;biotech=3;engineering=2"
	frame_desc = "Requires 2 Scanning Module, 1 Manipulator, and 1 Console Screen."
	req_components = list(

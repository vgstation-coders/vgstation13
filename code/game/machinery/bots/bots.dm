...
/obj/machinery/bot/proc/calc_path(var/target, var/turf/avoid)
	REGISTER_ASTAR(src,list("target" = target, "adjacent" = /turf/proc/CardinalTurfsWithAccess, "distance" = /turf/proc/Distance, "maxnodes" = 0, "maxnodedepth" = 120, "ID"=botcard, "exclude"=avoid))
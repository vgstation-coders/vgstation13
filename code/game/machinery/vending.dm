...
/obj/machinery/vending/nazivend/emag(mob/user)
	if(!emagged)
		...
		contraband[/obj/item/clothing/head/helmet/space/void/nazi] = 3
		contraband[/obj/item/clothing/suit/space/void/nazi] = 3
...
/obj/machinery/vending/nazivend/DANGERMODE
	products = list(/obj/item/clothing/head/stalhelm = 20, /obj/item/clothing/head/panzer = 20, /obj/item/clothing/suit/soldiercoat = 20, /obj/item/clothing/under/soldieruniform = 20, /obj/item/clothing/shoes/jackboots = 20)
	contraband = list(/obj/item/clothing/head/naziofficer = 10, /obj/item/clothing/suit/officercoat = 10, /obj/item/clothing/under/officeruniform = 10, /obj/item/clothing/head/helmet/space/void/nazi = 3, /obj/item/clothing/suit/space/void/nazi = 3, /obj/item/weapon/gun/energy/plasma/MP40k = 4)
...
/obj/machinery/vending/sovietvend/emag(mob/user)
	if(!emagged)
		...
		contraband[/obj/item/clothing/head/helmet/space/void/soviet] = 3
		contraband[/obj/item/clothing/suit/space/void/soviet] = 3

...
/obj/machinery/monkey_recycler/attack_hand(var/mob/user as mob)
	...
	if(grinded >= minimum_monkeys)
		...
		to_chat(user, "<span class='warning'>The machine needs at least [minimum_monkeys] monkeys worth of material to produce a monkey cube. It only has [grinded].</span>")
	return

...
/obj/machinery/atmospherics/unary/cold_sink/freezer/crowbarDestroy(mob/user, obj/item/weapon/tool/crowbar/I)
	if(on)
...
/obj/machinery/atmospherics/unary/heat_reservoir/heater/crowbarDestroy(mob/user, obj/item/weapon/tool/crowbar/I)
	if(on)
		to_chat(user, "You have to turn off \the [src]!")
		return FALSE
	return ..()

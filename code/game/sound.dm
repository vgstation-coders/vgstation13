...
var/list/voice_radio_sound = list('sound/misc/radio-vocal1.ogg','sound/misc/radio-vocal2.ogg','sound/misc/radio-vocal3.ogg','sound/misc/radio-vocal4.ogg','sound/misc/radio-vocal5.ogg')
...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("voice-radio")
				soundin = pick(voice_radio_sound)
			if ("voice-silicon")

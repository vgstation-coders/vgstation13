...
/datum/game_mode/proc/equip_syndicate(mob/living/carbon/human/synd_mob)
	...
	if(!istype(synd_mob.species, /datum/species/phoronman))
		synd_mob.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/bulletproof(synd_mob), slot_wear_suit)
	else
		synd_mob.equip_to_slot_or_del(new /obj/item/clothing/suit/space/phoronman/nuclear(synd_mob), slot_wear_suit)
		synd_mob.equip_to_slot_or_del(new /obj/item/weapon/tank/phoron/phoronman(synd_mob), slot_s_store)
	...
	if(!istype(synd_mob.species, /datum/species/phoronman))
		...
		synd_mob.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/phoronman/nuclear(synd_mob), slot_head)

...
/obj/item/spellbook/proc/add_spell(var/spell/spell_to_add,var/mob/user)
...
//It crashed clients
/obj/item/spellbook/oneuse/mindswap/recoil(var/mob/user)
	qdel(src)
...
/obj/item/spellbook/oneuse/clown/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/mime/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/shoesnatch
	spell = /spell/targeted/shoesnatch
	spellname = "shoe snatching"
	icon_state = "bookshoe"
	desc = "This book will knock you off your feet."

/obj/item/spellbook/oneuse/shoesnatch/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/robesummon
...
/obj/item/spellbook/oneuse/robesummon/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
		var/mob/living/carbon/human/victim = user
...
/obj/item/spellbook/oneuse/disabletech
...
/obj/item/spellbook/oneuse/disabletech/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/magicmissle
	spell = /spell/targeted/projectile/magic_missile
	spellname = "magic missle"
	icon_state = "bookmm"
	desc = "This book is a perfect prop for LARPers."

/obj/item/spellbook/oneuse/magicmissle/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/mutate
	spell = /spell/targeted/genetic/mutate
	spellname = "mutating"
	icon_state = "bookmutate"
	desc = "All the pages in this book are ripped."

/obj/item/spellbook/oneuse/mutate/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/mutate/highlander //for highlander uplink bundle
...
/obj/item/spellbook/oneuse/teleport/blink //sod coding different effects for each teleport spell
	spell = /spell/aoe_turf/blink
	spellname = "blinking"

/obj/item/spellbook/oneuse/teleport/jaunt
	spell = /spell/targeted/ethereal_jaunt
	spellname = "jaunting"

/obj/item/spellbook/oneuse/buttbot
	spell = /spell/targeted/buttbots_revenge
	spellname = "ass magic"
	icon_state = "bookbutt"
	desc = "You feel as if your ass could explode at any moment, just by looking at this."

/obj/item/spellbook/oneuse/buttbot/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/lightning
	spell = /spell/lightning
	spellname = "lightning"
	icon_state = "booklightning"
	desc = "You can hear it crackle with malevolent electricity."

/obj/item/spellbook/oneuse/lightning/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
...
/obj/item/spellbook/oneuse/timestop/recoil(mob/living/carbon/user as mob)
	if(istype(user, /mob/living/carbon/human))
		user.stunned = 5
		user.flash_eyes(visual = 1)
...
/obj/item/spellbook/oneuse/mirror_of_pain/recoil(mob/living/carbon/user as mob)
	scramble(1, user, 100)
	to_chat(user, "<span class = 'warning'>Your reflection becomes warped and distorted!</span>")

/obj/item/spellbook/oneuse/bound_object
	spell = /spell/targeted/bound_object
	spellname = "binding"
	icon_state = "bookbound"
	desc = "This book seems like it's already in your hands."

/obj/item/spellbook/oneuse/bound_object/recoil(mob/living/carbon/user as mob)
...
/obj/item/spellbook/oneuse/arcane_golem
...
/obj/item/spellbook/oneuse/firebreath
...
/obj/item/spellbook/oneuse/pie/recoil(mob/living/carbon/user)
	..()
...
/obj/item/spellbook/oneuse/ice_barrage
	spell = /spell/targeted/ice_barrage
	spellname = "Ice Barrage"
	desc = "Cold to the touch."
	icon_state = "bookAncient"

/obj/item/spellbook/oneuse/ice_barrage/recoil(mob/living/carbon/user)
	..()
...
/obj/item/spellbook/oneuse/alchemy
...
/obj/item/spellbook/oneuse/alchemy/recoil(mob/living/carbon/user)
	..()
...
/obj/item/spellbook/oneuse/absorb
...
/obj/item/spellbook/oneuse/ancient //the ancient spellbook contains weird and dangerous spells that aren't otherwise available to purchase, only available via the spellbook bundle
...
/obj/item/spellbook/oneuse/ancient/New()
	..()
	spell = pick(possible_spells)

/obj/item/spellbook/oneuse/ancient/recoil(mob/living/carbon/user)
...
/obj/item/spellbook/oneuse/ancient/winter //the winter spellbook contains spells that would otherwise only be available at christmas
...
/obj/item/spellbook/oneuse/ancient/winter/recoil(mob/living/carbon/user)

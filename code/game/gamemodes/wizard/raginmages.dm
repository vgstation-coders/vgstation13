...
/datum/game_mode/wizard/announce()
	...
	world << "<B>The <span class=\"rose\">Space Wizard Federation</span> is pissed, help defeat all the space wizards!</B>"
	...
	for(var/datum/mind/wizard in wizards)
		...
		if(wizard.current.stat==1)
			if(wizard.current.health < 0)
				wizard.current << "<span class=\"rose\"><font size='4'>The Space Wizard Federation is upset with your performance and have terminated your employment.</font></span>"

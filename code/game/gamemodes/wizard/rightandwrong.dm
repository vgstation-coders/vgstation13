...
/mob/living/carbon/human/proc/equip_swords(var/datum/role/R)
	...
	switch (randomizeswords)
		...
		if("saw")
			if(prob(40))
				new /obj/item/weapon/tool/circular_saw/plasmasaw(get_turf(src))
			else
				new /obj/item/weapon/tool/circular_saw(get_turf(src))
		if("scalpel")
			if(prob(60))
				if(prob(50))
					new /obj/item/weapon/tool/scalpel/laser(get_turf(src))
				else
					new /obj/item/weapon/tool/scalpel/laser/tier2(get_turf(src))
			else
				new /obj/item/weapon/tool/scalpel(get_turf(src))
		if("switchtool")
			if(prob(40))
				if(prob(50))

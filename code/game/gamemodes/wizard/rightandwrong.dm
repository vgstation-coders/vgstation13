	...
	for(var/mob/living/carbon/human/H in player_list)
		...
		if(prob(35) && !is_special_character(H))
			...
			for(var/datum/objective/OBJ in H.mind.objectives)
				...
				obj_count++
		var/randomizeguns = pick("taser","egun","laser","revolver","detective","smg","nuclear","deagle","gyrojet","pulse","silenced","cannon","doublebarrel","shotgun","combatshotgun","mateba","smg","uzi","crossbow","saw","hecate","osipr","gatling","bison","ricochet","spur","nagant","beegun","beretta")

	...
	for(var/mob/living/carbon/human/H in player_list)
		...
		if(!summon_type)
			switch (randomizeguns)
				...
				if("deagle")
					new /obj/item/weapon/gun/projectile/pistol/deagle/camo(get_turf(H))
				if("gyrojet")
					new /obj/item/weapon/gun/projectile/pistol/gyropistol(get_turf(H))
				if("pulse")
					new /obj/item/weapon/gun/energy/pulse_rifle(get_turf(H))
				if("silenced")
					new /obj/item/weapon/gun/projectile/pistol/stechkin(get_turf(H))
				...
				if("saw")
					new /obj/item/weapon/gun/projectile/automatic/rifles/machine_gun(get_turf(H))
				if("hecate")

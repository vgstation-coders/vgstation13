...
/datum/game_mode/proc/greet_vampire(var/datum/mind/vampire, var/you_are=1)
	...
	dat += {"To drink blood from somebody, just bite them in the head (switch to harm intent, enable biting and attack the victim in the head). Drink blood to gain new powers and use coffins to regenerate your body if injured.

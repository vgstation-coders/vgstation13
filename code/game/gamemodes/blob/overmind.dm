...
/mob/camera/blob/proc/update_health()
	if(blob_core && hud_used)
		...
		hud_used.mymob.gui_icons.blob_coverRIGHT.maptext = "<font size='[PIXEL_MULTIPLIER_SQUARE]'>[blob_core.health]"
...
/mob/camera/blob/proc/add_points(var/points)
	...
	if(hud_used)
		...
		hud_used.mymob.gui_icons.blob_coverLEFT.maptext = "<font size='[PIXEL_MULTIPLIER_SQUARE]'>[blob_points]</font>"

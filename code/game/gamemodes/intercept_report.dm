...
/datum/intercept_text/proc/build_traitor(datum/mind/correct_person)
	...
	text += {"<BR><BR>The <B>[name_1] [name_2]</B> implied an undercover operative was acting on their behalf on the station currently.
...
/datum/intercept_text/proc/build_cult(datum/mind/correct_person)
	...
	text += {"<BR><BR>It has been brought to our attention that the [name_1] [name_2] have stumbled upon some dark secrets. They apparently want to spread the dangerous knowledge onto as many stations as they can.
...
/datum/intercept_text/proc/build_rev(datum/mind/correct_person)
	...
	text += {"<BR><BR>It has been brought to our attention that the [name_1] [name_2] are attempting to stir unrest on one of our stations in your sector.
...
/datum/intercept_text/proc/build_nuke(datum/mind/correct_person)
	...
	text += {"<BR><BR>Cent. Com recently recieved a report of a plot to destroy one of our stations in your area. We believe the Nuclear Authentication Disc
...
/datum/intercept_text/proc/build_changeling(datum/mind/correct_person)
	...
	*/
	...
	text += "<BR><BR>We have received a report that a dangerous alien lifeform known only as \"[cname]\" may have infiltrated your crew.  "
	/*
	...
	*/
	...
	text += {"These lifeforms are assosciated with the [orgname1] [orgname2] and may be attempting to acquire sensitive materials on their behalf.

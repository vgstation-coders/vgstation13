/turf
	...
	var/nitrogen = 0
	var/toxins = 0
	var/list/misc_gases //associative list of gas names and amounts. eg. to add N2O to a turf, initialize with: misc_gases = new(), then misc_gases[GAS_SLEEPING] = 36000

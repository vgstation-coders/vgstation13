...
/datum/ambience/tcomms1
	...
	length = 12 SECONDS + 1 MINUTES

/datum/ambience/tcomms2
	sound = 'sound/ambience/signal.ogg'
	length = 11 SECONDS + 1 MINUTES

/datum/ambience/tcomms3
	sound = 'sound/ambience/ambigen10.ogg'
	length = 20 SECONDS + 1 MINUTES
...
/datum/ambience/maint1
	...
	length = 41 SECONDS + 5 MINUTES //smaller ""cooldown""

/datum/ambience/maint2
	sound = 'sound/ambience/spookymaint2.ogg'
	length = 34 SECONDS + 5 MINUTES //smaller ""cooldown""
...
/datum/ambience/minecraft
	...
	length = 17 SECONDS + 5 MINUTES

/datum/ambience/dorf
	sound = 'sound/ambience/song_game.ogg'
	length = 51 SECONDS + 5 MINUTES
...
/datum/ambience/ghetto
	...
	length = 6 SECONDS + 5 MINUTES


//AI ambience. Come on and slam.

/datum/ambience/AI
	sound = 'sound/ambience/ambimalf1.ogg'
	length = 18 SECONDS + 5 MINUTES

/datum/ambience/AI/back
	sound = 'sound/ambience/ambimalf2.ogg'
	length = 18 SECONDS + 5 MINUTES

/datum/ambience/AI/safe
	sound = 'sound/ambience/ambimalf3.ogg'
	length = 18 SECONDS + 5 MINUTES
	prob_fire = 50
...
/datum/ambience/holy1
	sound = 'sound/ambience/ambicha1.ogg'
	length = 24 SECONDS + 3 MINUTES

/datum/ambience/holy2
	sound = 'sound/ambience/ambicha2.ogg'
	length = 11 SECONDS + 3 MINUTES

...
/area/start            // will be unused once kurper gets his login interface patch done
	...
	dynamic_lighting = 0
	has_gravity = 1
	flags = NO_PERSISTENCE //hmmmm I wonder if someone can fuck with this
...
/area/centcom
	...
	dynamic_lighting = 0
	shuttle_can_crush = FALSE
	flags = NO_PERSISTENCE //Centcomm is always squeaky clean yo
...
/area/holodeck
	...
	dynamic_lighting = 0
	shuttle_can_crush = FALSE
	flags = NO_PERSISTENCE //I dare not see what this leads to.

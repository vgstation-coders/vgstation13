...
/area/New()
	...
	if(isspace(src))	// override defaults for space. TODO: make space areas of type /area/space rather than /area
		...
		for(var/datum/d in ambient_sounds)//can't think of a better way to do this.
			qdel(d)
		ambient_sounds = newlist(/datum/ambience/spaced1,/datum/ambience/spaced2,/datum/ambience/spaced3,/datum/ambience/spacemusic,/datum/ambience/mainmusic,/datum/ambience/traitormusic)
//		lighting_state = 4

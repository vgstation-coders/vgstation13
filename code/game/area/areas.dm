...
var/list/moved_landmarks = list(/obj/effect/landmark/latejoin, /obj/effect/landmark/wizardstart) + typesof(/obj/effect/landmark/thunderdome) //Landmarks that are moved by move_area_to and move_contents_to

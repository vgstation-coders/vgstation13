...
/area/holomed/alphadeck
	name = "\improper Holodeck Alpha"

/area/holomed/source_off
	name = "\improper Holodeck - Off"
	jammed=SUPER_JAMMED

/area/holomed/source_scanner
	name = "\improper Holodeck - Scanner"
	jammed=SUPER_JAMMED

/area/holomed/source_sleeper
	name = "\improper Holodeck - Sleeper"
	jammed=SUPER_JAMMED

/area/holomed/source_surgery
	name = "\improper Holodeck - Surgery"
	jammed=SUPER_JAMMED

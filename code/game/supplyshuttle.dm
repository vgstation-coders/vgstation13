...
/datum/controller/supply_shuttle
	...
	//shuttle movement
	var/datum/shuttle/cargo/shuttle
	var/at_station = 0
	var/movetime = 1200
	var/moving = 0
	var/eta_timeofday
...
/datum/controller/supply_shuttle/proc/initialize()
	sleep(10)
	shuttle = cargo_shuttle
...
/datum/controller/supply_shuttle/proc/send()
	...
	if(shuttle.current_area == shuttle.area_centcomm)
		shuttle.start_movement(shuttle.area_station)
	else if(shuttle.current_area == shuttle.area_station)
		shuttle.start_movement(shuttle.area_centcomm)
...
/datum/controller/supply_shuttle/proc/can_move()
	...
	if(forbidden_atoms_check(shuttle.current_area))
		return 0
...
/datum/controller/supply_shuttle/proc/sell()
	...
	for(var/atom/movable/MA in shuttle.current_area)
...
/datum/controller/supply_shuttle/proc/buy()
	...
	for(var/turf/T in shuttle.current_area)
	...
	for(var/S in shoppinglist)
		...
		var/obj/item/weapon/paper/manifest/slip = new /obj/item/weapon/paper/manifest(C)
	...
	supply_shuttle.shoppinglist = list()
	return
...
/obj/machinery/computer/ordercomp/attack_hand(var/mob/user as mob)
	...
	if(temp)
		...
		Location: [supply_shuttle.moving ? "Moving to station ([supply_shuttle.eta] Mins.)" : supply_shuttle.shuttle.current_area.name]<BR>
...
/obj/machinery/computer/supplycomp/Topic(href, href_list)
	...
	if(href_list["send"])
		if(!supply_shuttle.can_move())
			if(!supply_shuttle.shuttle)
				temp = "The supply shuttle is undergoing technical maintenance.<BR><BR><A href='?src=\ref[src];mainmenu=1'>OK</A>"
			else
...
/mob/verb/fix_cargo_shuttle()
	supply_shuttle.shuttle = cargo_shuttle

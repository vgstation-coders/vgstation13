...
/datum/job/roboticist
	...
	wage_payout = 55
	selection_color = "#ffeeff"
	access = list(access_robotics, access_tech_storage, access_morgue, access_science, access_rnd, access_xenobiology, access_tox_storage) //As a job that handles so many corpses, it makes sense for them to have morgue access.
	minimal_access = list(access_robotics, access_tech_storage, access_morgue, access_science, access_rnd, access_xenobiology, access_tox_storage) //As a job that handles so many corpses, it makes sense for them to have morgue access.

...
/datum/job/psychiatrist
	...
	equip(var/mob/living/carbon/human/H)
		...
		switch(H.backbag)
			if(2)
				H.equip_or_collect(new /obj/item/storage/backpack/medic(H), slot_back)
			if(3)
				H.equip_or_collect(new /obj/item/storage/backpack/satchel_med(H), slot_back)
			if(4)
				H.equip_or_collect(new /obj/item/storage/backpack/satchel(H), slot_back)

/datum/job/paramedic
	...
	access = list(access_paramedic, access_medical, access_morgue, access_genetics, access_sec_doors, access_maint_tunnels, access_external_airlocks)
	minimal_access=list(access_paramedic, access_medical, access_morgue, access_genetics, access_sec_doors, access_maint_tunnels, access_external_airlocks)

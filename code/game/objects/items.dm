...
/obj/item/dorfify(var/datum/material/mat, var/additional_quality, var/min_quality)
	.=..()
	if(material_type)
		armor["melee"] = min(90, armor["melee"]*(material_type.armor_mod*(quality/NORMAL))
		armor["bullet"] = min(90, armor["bullet"]*(material_type.armor_mod*(quality/NORMAL))
		armor["laser"] = min(90, armor["laser"]*(material_type.armor_mod*(quality/NORMAL))

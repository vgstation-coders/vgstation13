...
/obj/structure/bed/chair/e_chair/rotate()
	..()
	overlays.len = 0
	overlays += image('icons/obj/objects.dmi', src, "echair_over", MOB_LAYER + 1, dir,plane = MOB_PLANE)	//there's probably a better way of handling this, but eh. -Pete
	return

...
/obj/structure/m_tray/Cross(atom/movable/mover, turf/target = loc, height=1.5, air_group = 0)
...
/obj/structure/c_tray/Cross(atom/movable/mover, turf/target = loc, height=1.5, air_group = 0)
	if (istype(mover, /obj/item/weapon/dummy))
		return 1
	else
		return ..()

...
/obj/structure/kitchenspike/attackby(obj/item/W as obj, mob/user as mob)
	..()
	if (W.is_wrench(user))
		if(occupant)
...
/obj/structure/kitchenspike/proc/handleGrab(obj/item/grab/G as obj, mob/user as mob)
	if(!istype(G))
		return

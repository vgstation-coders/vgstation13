	...
	for(var/i=0;i<invocnum;i++)
		...
		switch(mob_type)
			if(1)
				...
				spawned_mobs += M
				T.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg',"#FFC0FF", anim_plane = PLANE_EFFECTS)
			if(2)
				var/mob/living/simple_animal/hostile/carp/M = new /mob/living/simple_animal/hostile/carp(T)
				M.faction = "adminbus mob"
				spawned_mobs += M
				T.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg',"#C70AF5", anim_plane = PLANE_EFFECTS)
			if(3)
				if(prob(10))
					...
					M.faction = "adminbus mob"
					spawned_mobs += M
				T.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg',"#454545", anim_plane = PLANE_EFFECTS)
			if(4)
				var/mob/living/simple_animal/hostile/tree/M = new /mob/living/simple_animal/hostile/tree(T)
				M.faction = "adminbus mob"
				spawned_mobs += M
				T.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg',"#232B2C", anim_plane = PLANE_EFFECTS)
			if(5)
				var/mob/living/simple_animal/hostile/giant_spider/M = new /mob/living/simple_animal/hostile/giant_spider(T)
				M.faction = "adminbus mob"
				spawned_mobs += M
				T.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg',"#3B2D1C", anim_plane = PLANE_EFFECTS)
			if(6)
...
/obj/structure/bed/chair/vehicle/adminbus/proc/Teleportation(mob/bususer)
	...
	warp.icon_state = ""
	forceMove(T2)
	T1.turf_animation('icons/effects/160x160.dmi',"busteleport",-WORLD_ICON_SIZE*2,-WORLD_ICON_SIZE,MOB_LAYER+1,'sound/effects/busteleport.ogg', anim_plane = PLANE_EFFECTS)
	T2.turf_animation('icons/effects/160x160.dmi',"busteleport",-WORLD_ICON_SIZE*2,-WORLD_ICON_SIZE,MOB_LAYER+1,'sound/effects/busteleport.ogg', anim_plane = PLANE_EFFECTS)
...
/obj/structure/bed/chair/vehicle/adminbus/proc/Sendto_Thunderdome_Obs(mob/bususer)
	...
	if(T)
		T.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg', anim_plane = PLANE_EFFECTS)
...
*/
		...
		if(TD)
			TD.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg',anim_plane = PLANE_EFFECTS)
...
/obj/structure/bed/chair/vehicle/adminbus/proc/join_team(var/atom/A, var/team)
	...
	if(T)
		T.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg', "#00FF00", anim_plane = PLANE_EFFECTS)
...
/obj/structure/bed/chair/vehicle/adminbus/proc/Send_Home(mob/bususer)
	...
	var/turf/T1 = get_turf(src)
	if(T1)
		T1.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg', anim_plane = PLANE_EFFECTS)
	...
	for(var/mob/M in passengers)
		...
		if(T2)
			T2.turf_animation('icons/effects/96x96.dmi',"beamin",-WORLD_ICON_SIZE,0,MOB_LAYER+1,'sound/weapons/emitter2.ogg', anim_plane = PLANE_EFFECTS)
...
/obj/structure/bed/chair/vehicle/adminbus/proc/Adminbus_Deletion(mob/bususer)//make sure to always use this proc when deleting an adminbus
	...
	var/turf/T = get_turf(src)
	T.turf_animation('icons/effects/160x160.dmi',"busteleport",-WORLD_ICON_SIZE*2,-WORLD_ICON_SIZE,MOB_LAYER+1,'sound/effects/busteleport.ogg', anim_plane = PLANE_EFFECTS)

...
/obj/structure/window/full
	...
	name = "window"
	base_icon = "window" //Base icon for update_icon
	...
	canSmoothWith = "/obj/structure/window/full=0"
	cracked_base = "fcrack"
...
/obj/structure/window/full/initialize()
	icon_smoothing()

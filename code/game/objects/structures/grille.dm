...
/obj/structure/grille/Cross(atom/movable/mover, turf/target = loc, height = 1.5, air_group = 0)
...
/obj/structure/grille/cult/Cross(atom/movable/mover, turf/target = loc, height = 1.5, air_group = 0)
	if(air_group || !broken)

...
/obj/item/stack/sheet/wax/times_two/New()
	..()
	new /obj/item/stack/sheet/wax(get_turf(src), 2)
	qdel(src)
/obj/item/stack/sheet/wax/times_three/New()
	..()
	new /obj/item/stack/sheet/wax(get_turf(src), 3)
	qdel(src)
/obj/item/stack/sheet/wax/times_four/New()
	..()
	new /obj/item/stack/sheet/wax(get_turf(src), 4)
	qdel(src)
/obj/item/stack/sheet/wax/times_ten/New()
	..()
	new /obj/item/stack/sheet/wax(get_turf(src), 10)
	qdel(src)
/obj/item/stack/sheet/wax/bigstack/New()
	..()
	new /obj/item/stack/sheet/wax(get_turf(src), 20)
	qdel(src)
/obj/item/stack/sheet/wax/biggerstack/New()
	..()
	new /obj/item/stack/sheet/wax(get_turf(src), 50)
	qdel(src)

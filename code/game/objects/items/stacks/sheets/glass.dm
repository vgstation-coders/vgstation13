...
var/list/datum/stack_recipe/glass_recipes = list (
	new/datum/stack_recipe("window", /obj/structure/window, 1, time = 10, start_unanchored = TRUE, on_floor = TRUE),
	new/datum/stack_recipe("full window", /obj/structure/window/full, 2, time = 10, start_unanchored = TRUE, on_floor = TRUE),
	)

var/list/datum/stack_recipe/rglass_recipes = list (
	new/datum/stack_recipe("window", /obj/structure/window/reinforced, 1, time = 10, start_unanchored = TRUE, on_floor = TRUE),
	new/datum/stack_recipe("full window", /obj/structure/window/full/reinforced, 2, time = 10, start_unanchored = TRUE, on_floor = TRUE),
...
var/list/datum/stack_recipe/plasmaglass_recipes = list (
	new/datum/stack_recipe("window", /obj/structure/window/plasma, 1, time = 10, start_unanchored = TRUE, on_floor = TRUE),
	new/datum/stack_recipe("full window", /obj/structure/window/full/plasma, 2, time = 10, start_unanchored = TRUE, on_floor = TRUE),
	)

var/list/datum/stack_recipe/plasmarglass_recipes = list (
	new/datum/stack_recipe("window", /obj/structure/window/reinforced/plasma, 1, time = 10, start_unanchored = TRUE, on_floor = TRUE),
	new/datum/stack_recipe("full window", /obj/structure/window/full/reinforced/plasma, 2, time = 10, start_unanchored = TRUE, on_floor = TRUE),

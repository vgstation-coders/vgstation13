...
var/list/datum/stack_recipe/gold_recipes = list ( \
	...
	new/datum/stack_recipe("legacy golden floor tile", /obj/item/stack/tile/mineral/gold/gold_old, 1, 4, 20), \
...
var/list/datum/stack_recipe/silver_recipes = list ( \
	...
	new/datum/stack_recipe("legacy silver floor tile", /obj/item/stack/tile/mineral/silver/silver_old, 1, 4, 20), \

...
var/global/list/datum/stack_recipe/metal_recipes = list (
	...
	new/datum/stack_recipe_list("couch parts", list(
		...
		new/datum/stack_recipe/chair("brown couch left end",      /obj/structure/bed/chair/comfy/couch/left/brown,         3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("brown couch right end",     /obj/structure/bed/chair/comfy/couch/right/brown,        3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("brown couch straight",      /obj/structure/bed/chair/comfy/couch/mid/brown,          3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("brown couch inwards turn",  /obj/structure/bed/chair/comfy/couch/turn/inward/brown,  3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("brown couch outwards turn", /obj/structure/bed/chair/comfy/couch/turn/outward/brown, 3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("black couch left end",      /obj/structure/bed/chair/comfy/couch/left/black,         3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("black couch right end",     /obj/structure/bed/chair/comfy/couch/right/black,        3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("black couch straight",      /obj/structure/bed/chair/comfy/couch/mid/black,          3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("black couch inwards turn",  /obj/structure/bed/chair/comfy/couch/turn/inward/black,  3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("black couch outwards turn", /obj/structure/bed/chair/comfy/couch/turn/outward/black, 3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("teal couch left end",       /obj/structure/bed/chair/comfy/couch/left/teal,          3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("teal couch right end",      /obj/structure/bed/chair/comfy/couch/right/teal,         3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("teal couch straight",       /obj/structure/bed/chair/comfy/couch/mid/teal,           3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("teal couch inwards turn",   /obj/structure/bed/chair/comfy/couch/turn/inward/teal,   3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("teal couch outwards turn",  /obj/structure/bed/chair/comfy/couch/turn/outward/teal,  3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("lime couch left end",       /obj/structure/bed/chair/comfy/couch/left/lime,          3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("lime couch right end",      /obj/structure/bed/chair/comfy/couch/right/lime,         3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("lime couch straight",       /obj/structure/bed/chair/comfy/couch/mid/lime,           3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("lime couch inwards turn",   /obj/structure/bed/chair/comfy/couch/turn/inward/lime,   3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("lime couch outwards turn",  /obj/structure/bed/chair/comfy/couch/turn/outward/lime,  3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("grey couch left end",       /obj/structure/bed/chair/comfy/couch/left,               3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("grey couch right end",      /obj/structure/bed/chair/comfy/couch/right,              3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("grey couch straight",       /obj/structure/bed/chair/comfy/couch/mid,                3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("grey couch inwards turn",   /obj/structure/bed/chair/comfy/couch/turn/inward,        3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("grey couch outwards turn",  /obj/structure/bed/chair/comfy/couch/turn/outward,       3, one_per_turf = 1, on_floor = 1),
		...
		new/datum/stack_recipe/chair("red couch straight",        /obj/structure/bed/chair/comfy/couch/mid/red,            3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("red couch inwards turn",    /obj/structure/bed/chair/comfy/couch/turn/inward/red,    3, one_per_turf = 1, on_floor = 1),
		new/datum/stack_recipe/chair("red couch outwards turn",   /obj/structure/bed/chair/comfy/couch/turn/outward/red,   3, one_per_turf = 1, on_floor = 1),
		)),

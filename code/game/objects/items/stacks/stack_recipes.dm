...
/*		new/datum/stack_recipe("multi-tile airlock assembly",    /obj/structure/door_assembly/multi_tile,                 4, time = 50, one_per_turf = 1, on_floor = 1), */
	...
	new/datum/stack_recipe_list("transit tube parts", list(
		new/datum/stack_recipe("straight tube",				/obj/structure/transit_tube_frame,				4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("diagonal tube",				/obj/structure/transit_tube_frame/diag,			4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("bent tube",					/obj/structure/transit_tube_frame/bent,			4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("inverted bent tube",		/obj/structure/transit_tube_frame/bent_invert,	4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("fork tube",					/obj/structure/transit_tube_frame/fork,			4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("inverted fork tube",		/obj/structure/transit_tube_frame/fork_invert,	4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("tube corner",				/obj/structure/transit_tube_frame/corner,		4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("station",					/obj/structure/transit_tube_frame/station,		4, time = 4 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("pod",						/obj/structure/transit_tube_frame/pod,			4, time = 4 SECONDS, one_per_turf = 1   ),
		)),
	null,

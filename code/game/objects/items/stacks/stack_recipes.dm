...
/*		new/datum/stack_recipe("multi-tile airlock assembly",    /obj/structure/door_assembly/multi_tile,                 4, time = 50, one_per_turf = 1, on_floor = 1), */
	...
	new/datum/stack_recipe_list("transit tube parts", list(
		new/datum/stack_recipe("straight tube",				/obj/structure/transit_tube_frame,				5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("diagonal tube",				/obj/structure/transit_tube_frame/diag,			5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("bent tube",					/obj/structure/transit_tube_frame/bent,			5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("inverted bent tube",		/obj/structure/transit_tube_frame/bent_invert,	5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("fork tube",					/obj/structure/transit_tube_frame/fork,			5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("inverted fork tube",		/obj/structure/transit_tube_frame/fork_invert,	5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("tube corner",				/obj/structure/transit_tube_frame/corner,		5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("station",					/obj/structure/transit_tube_frame/station,		5, time = 5 SECONDS, one_per_turf = 1   ),
		new/datum/stack_recipe("pod",						/obj/structure/transit_tube_frame/pod,			5, time = 5 SECONDS, one_per_turf = 1   ),
		)),
	null,

...
var/list/datum/stack_recipe/brass_recipes = list (
	...
	new/datum/stack_recipe("brass table", /obj/item/weapon/table_parts/clockwork, 4, time = 5, one_per_turf = 1, on_floor = 1),
	new/datum/stack_recipe("brass window", /obj/structure/window/reinforced/clockwork, 2, time = 15, one_per_turf = 1, on_floor = 1),
	...
	new/datum/stack_recipe("clockwork airlock", /obj/structure/door_assembly/clockwork, 10, time = 50, one_per_turf = 1, on_floor = 1)
	)

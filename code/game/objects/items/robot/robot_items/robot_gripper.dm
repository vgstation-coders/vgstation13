...
/obj/item/gripper/proc/gripper_safety_check(var/mob/user, var/target)
	if(issilicon(user))
...
/obj/item/gripper/attackby(obj/item/thing, mob/living/user)
	if(gripper_sanity_check(src))
...
/obj/item/gripper/preattack(var/atom/target, var/mob/living/user, proximity, params)
	if(!proximity)
...
/obj/item/gripper/chemistry //Used to handle glass containers and pills.
...
/obj/item/gripper/no_use //Used when you want to hold and put things in other things, but not able to 'use' the item

/obj/item/gripper/no_use/attack_self(mob/user as mob)
	return

/obj/item/gripper/no_use/attackby(var/atom/thing, var/mob/living/user)
	return

/obj/item/gripper/no_use/AltClick()
	return

/obj/item/gripper/no_use/CtrlClick()
	return

/obj/item/gripper/no_use/inserter //This is used to disallow building sheets.
	name = "sheet inserter"

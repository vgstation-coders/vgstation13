...
/obj/item/borg/upgrade/surgery
	...
	icon_state = "cyborg_upgrade"
	required_modules = list(MEDICAL_MODULE, SYNDIE_CRISIS_MODULE)
	modules_to_add = list(/obj/item/weapon/tool/scalpel/laser/tier2, /obj/item/weapon/tool/circular_saw/plasmasaw,
	/obj/item/weapon/tool/retractor/manager, /obj/item/weapon/tool/hemostat/pico, /obj/item/weapon/tool/surgicaldrill/diamond,
	/obj/item/weapon/tool/bonesetter/bone_mender, /obj/item/weapon/tool/FixOVein/clot)
	modules_to_remove = list(/obj/item/weapon/tool/scalpel, /obj/item/weapon/tool/hemostat, /obj/item/weapon/tool/retractor,
	/obj/item/weapon/tool/circular_saw, /obj/item/weapon/tool/cautery, /obj/item/weapon/tool/surgicaldrill, /obj/item/weapon/tool/bonesetter,
...
/obj/item/borg/upgrade/engineering
	...
	modules_to_add = list(/obj/item/weapon/tool/wrench/socket)
...
/obj/item/borg/upgrade/hydro
	...
	required_modules = list(SERVICE_MODULE)
	modules_to_add = list(/obj/item/weapon/minihoe, /obj/item/weapon/tool/wirecutters/clippers, /obj/item/weapon/storage/bag/plants/portactor, /obj/item/device/analyzer/plant_analyzer)
...
/obj/item/borg/upgrade/warden
	...
	required_modules = list(SECURITY_MODULE, HUG_MODULE)
	modules_to_add = list(/obj/item/weapon/batteringram, /obj/item/weapon/implanter/cyborg, /obj/item/weapon/card/robot/security, /obj/item/weapon/tool/wrench, /obj/item/weapon/handcuffs/cyborg) //Secborgs have cuffs, but hugborgs can't do warden job properly without them.

...
/obj/item/borg/upgrade/cult/attempt_action(var/mob/living/silicon/robot/R,var/mob/living/user)
	...
	R.add_spell(new /spell/cult/friendly_trace_rune, "cult_spell_ready", /obj/abstract/screen/movable/spell_master/bloodcult)
	R.add_spell(new /spell/cult/friendly_erase_rune, "cult_spell_ready", /obj/abstract/screen/movable/spell_master/bloodcult)

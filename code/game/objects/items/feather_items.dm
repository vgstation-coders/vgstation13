...
/obj/item/clothing/suit/feathercoat
	...
	New(loc, color = null, color_name = null)
		..(loc)
...
// Feather wreath item (can be built)
/obj/item/mounted/frame/wreath/feather
	...
	New(loc, color = null, color_name = null, singular = null)
		. = ..(loc)
		if(color)
			feather_color = color
			src.color = color
...
/obj/structure/wreath/feather
	...
	New(loc, dir, built = 1, color = null, color_name = null, singular = null)
		..(loc, dir, built)
		if(color)
			feather_color = color
			src.color = color
...
// Feather dreamcatcher item (can be built)
...
/obj/item/weapon/pillow
	...
	// Inherit overlay/color logic from bedsheet, support color and color_name inheritance from crafting
	New(loc, color = null, color_name = null)
		..(loc)
		if(color)
			src.color = color
	...
	// Optional: pillow fight proc or fluff interaction can be added here

// Feather quill pen item (inherits feather color)
...
// Feather duster item (inherits feather color, only cleans dirt, cobwebs, crumbs)
/obj/item/weapon/featherduster
	...
	proc/clean(turf/simulated/A as turf)
		var/cleaned = FALSE
...
// Feather headdress item (inherits feather color)

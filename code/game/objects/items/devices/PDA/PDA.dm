...
/obj/item/device/pda/attack_self(mob/user as mob)
	...
	var/dat = list()
	dat += "<a href='byond://?src=\ref[src];choice=Close'><span class='pda_exit'></span> Close</a>"
	if ((!isnull(cartridge)) && (mode == 0))
		dat += " | <a href='byond://?src=\ref[src];choice=Eject'><span class='pda_eject'></span> Eject [cartridge]</a>"
	if (mode)
		dat += " | <a href='byond://?src=\ref[src];choice=Return'><span class='pda_menu'></span> Return</a>"

	dat += {"| <a href='byond://?src=\ref[src];choice=Refresh'><span class='pda_refresh'></span> Refresh</a>
		<br>"}
	if (!owner)

		dat += {"Warning: No owner information entered.  Please swipe card.<br><br>
			<a href='byond://?src=\ref[src];choice=Refresh'><span class='pda_refresh'></span> Retry</a>"}
	else
		switch (mode)
			if (0)
				...
				dat += {"Station Time: [worldtime2text()]
					...
					<ul>
					<li><a href='byond://?src=\ref[src];choice=1'><span class='pda_notes'></span> Notekeeper</a></li>
					<li><a href='byond://?src=\ref[src];choice=2'><span class='pda_mail'></span> Messenger</a></li>
					<li><a href='byond://?src=\ref[src];choice=50'><span class='pda_clock'></span> Current Events</a></li>"}
				//dat += "<li><a href='byond://?src=[src];choice=chatroom'><span class='pda_chatroom'></span> Nanotrasen Relay Chat</a></li>"

				dat += "<li><a href='byond://?src=\ref[src];choice=41'><span class='pda_notes'></span> View Crew Manifest</a></li>"

				if (cartridge)
					if (cartridge.access_clown)
						dat += "<li><a href='byond://?src=\ref[src];choice=Honk'><span class='pda_honk'></span> Honk Synthesizer</a></li>"
					if(cartridge.access_status_display)
						dat += "<li><a href='byond://?src=\ref[src];choice=42'><span class='pda_status'></span> Set Status Display</a></li>"
				...
				if(applications.len == 0)
					...
					for(var/datum/pda_app/app in applications)
						if(app.menu)
							dat += {"<li><a href='byond://?src=\ref[src];choice=[app.menu]'>[app.icon ? "<span class='[app.icon]'></span> " : ""][app.name]</a></li>"}
						else
							dat += {"<li>[app.icon ? "<span class='[app.icon]'></span> " : ""][app.name]</li>"}
					dat += {"</ul>"}
				...
				if (cartridge)
					if (cartridge.access_engine || cartridge.access_atmos)
						dat += {"<h4>Engineering Functions</h4>
							<ul>
							<li><a href='byond://?src=\ref[src];choice=43'><span class='pda_power'></span> Power Monitor</a></li>
							<li><a href='byond://?src=\ref[src];choice=53'><span class='pda_alert'></span> Alert Monitor</a></li>
							</ul>"}

					if (cartridge.access_mechanic)
						dat += {"<h4>Mechanic Functions</h4>
							<ul>
							<li><a href='byond://?src=\ref[src];choice=Device Analyser'><span class='pda_scanner'></span> [scanmode == SCANMODE_DEVICE ? "Disable" : "Enable" ] Device Analyser</a></li>
							</ul>"}
					...
					if (cartridge.access_medical)
						...
						dat += {"<h4>Medical Functions</h4>
							<ul>
							<li><a href='byond://?src=\ref[src];choice=44'><span class='pda_medical'></span> Medical Records</a></li>
							<li><a href='byond://?src=\ref[src];choice=Medical Scan'><span class='pda_scanner'></span> [scanmode == SCANMODE_MEDICAL ? "Disable" : "Enable"] Medical Scanner</a></li>
							</ul>"}
					if (cartridge.access_security)

						dat += {"<h4>Security Functions</h4>
							<ul>
							<li><a href='byond://?src=\ref[src];choice=45'><span class='pda_cuffs'></span> Security Records</A></li>"}
					if(istype(cartridge.radio, /obj/item/radio/integrated/beepsky))

						dat += {"<li><a href='byond://?src=\ref[src];choice=46'><span class='pda_cuffs'></span> Security Bot Access</a></li>
							</ul>"}
					else
						dat += "</ul>"
					if(cartridge.access_quartermaster)
						...
						dat += {"<h4>Quartermaster Functions:</h4>
							<ul>
							<li><a href='byond://?src=\ref[src];choice=47'><span class='pda_crate'></span> Supply Records</A></li>
							<li><a href='byond://?src=\ref[src];choice=48'><span class='pda_mule'></span> Delivery Bot Control</A></li>
							</ul>"}
				...
				if (cartridge)
					if (cartridge.access_janitor)
						dat += "<li><a href='byond://?src=\ref[src];choice=49'><span class='pda_bucket'></span> Custodial Locator</a></li>"
					if (istype(cartridge.radio, /obj/item/radio/integrated/signal))
						dat += "<li><a href='byond://?src=\ref[src];choice=40'><span class='pda_signaler'></span> Signaler System</a></li>"
					if (cartridge.access_reagent_scanner)
						dat += "<li><a href='byond://?src=\ref[src];choice=Reagent Scan'><span class='pda_reagent'></span> [scanmode == SCANMODE_REAGENT ? "Disable" : "Enable"] Reagent Scanner</a></li>"
					if (cartridge.access_engine)
						dat += "<li><a href='byond://?src=\ref[src];choice=Halogen Counter'><span class='pda_reagent'></span> [scanmode == SCANMODE_HALOGEN ? "Disable" : "Enable"] Halogen Counter</a></li>"
					if (cartridge.access_atmos)
						dat += "<li><a href='byond://?src=\ref[src];choice=Gas Scan'><span class='pda_reagent'></span> [scanmode == SCANMODE_ATMOS ? "Disable" : "Enable"] Gas Scanner</a></li>"
					if (cartridge.access_remote_door)
						dat += "<li><a href='byond://?src=\ref[src];choice=Toggle Door'><span class='pda_rdoor'></span> Toggle Remote Door</a></li>"

				dat += {"<li><a href='byond://?src=\ref[src];choice=3'><span class='pda_atmos'></span> Atmospheric Scan</a></li>
					<li><a href='byond://?src=\ref[src];choice=Light'><span class='pda_flashlight'></span> [fon ? "Disable" : "Enable"] Flashlight</a></li>"}
				if (pai)
					if(pai.loc != src)
						pai = null
					else
			...
			if (1)
				...
				dat += {"<h4><span class='pda_notes'></span> Notekeeper V2.1</h4>
					<a href='byond://?src=\ref[src];choice=Edit'> Edit</a><br>"}
				dat += note

			if (2)

				dat += {"<h4><span class='pda_mail'></span> SpaceMessenger V3.9.4</h4>
					<a href='byond://?src=\ref[src];choice=Toggle Ringer'><span class='pda_bell'></span> Ringer: [silent == 1 ? "Off" : "On"]</a> |
					<a href='byond://?src=\ref[src];choice=Toggle Messenger'><span class='pda_mail'></span> Send / Receive: [toff == 1 ? "Off" : "On"]</a> |
					<a href='byond://?src=\ref[src];choice=Ringtone'><span class='pda_bell'></span> Set Ringtone</a> |
					<a href='byond://?src=\ref[src];choice=21'><span class='pda_mail'></span> Messages</a><br>"}
				...
				dat += {"<h4><span class='pda_menu'></span> Detected PDAs</h4>
					<ul>"}
				var/count = 0
				...
				if (!toff)
					for (var/obj/item/device/pda/P in sortNames(get_viewable_pdas()))
						...
						if (id && !istype(P,/obj/item/device/pda/ai))
							dat += " (<a href='byond://?src=\ref[src];choice=transferFunds;target=\ref[P]'><span class='pda_money'></span>*Send Money*</a>)"
						if (istype(cartridge, /obj/item/weapon/cartridge/syndicate) && P.detonate)
							dat += " (<a href='byond://?src=\ref[src];choice=Detonate;target=\ref[P]'><span class='pda_boom'></span>*Detonate*</a>)"
						if (istype(cartridge, /obj/item/weapon/cartridge/clown))
							dat += " (<a href='byond://?src=\ref[src];choice=Send Honk;target=\ref[P]'><span class='pda_honk'></span>*Send Virus*</a>)"
						if (istype(cartridge, /obj/item/weapon/cartridge/mime))
			...
			if(21)
				...
				dat += {"<h4><span class='pda_mail'></span> SpaceMessenger V3.9.4</h4>
					<a href='byond://?src=\ref[src];choice=Clear'><span class='pda_blank'></span> Clear Messages</a>
					<h4><span class='pda_mail'></span> Messages</h4>"}
				dat += tnote
				dat += "<br>"

			if (3)
				dat += "<h4><span class='pda_atmos'></span> Atmospheric Readings</h4>"
			...
			if (5)
				...
				dat += {"<h4><span class='pda_chatroom'></span> Nanotrasen Relay Chat</h4>
					<h4><span class='pda_menu'></span> Detected Channels</h4>: <li>"}
				for(var/datum/chatroom/C in chatrooms)
					dat += "<a href='byond://?src=\ref[src];pdachannel=[C.name]'>#[html_encode(lowertext(C.name))]"
					if(C.password != "")
						dat += " <span class='pda_locked'></span>"
					dat += "</li>"

			if (41) //Allows everyone to access crew

				dat += {"<h4><span class='pda_notes'></span> Crew Manifest</h4>
			...
			if (50) //Current events.
				dat += {"<h4><span class='pda_clock'></span> Current Events</h4>
			...
			if (PDA_APP_BALANCECHECK)
				...
				dat += {"<h4><span class='[app.icon]'></span> Virtual Wallet and Balance Check Application</h4>"}
				if(app)
					if(!id)
						...
						dat += {"<hr>
							...
							Balance: <b>[id.virtual_wallet.money]</b>$  <u><a href='byond://?src=\ref[src];choice=printCurrency'><span class='[app.icon]'></span>Print Currency</a></u>
...
*/
			...
			if (PDA_APP_SNAKEII)
				...
				dat += {"<h4><span class='[app.icon]'></span> Snake II  <a href='byond://?src=\ref[src];choice=snakeVolume;vChange=-1'><b>-</b></a><img src="snake_volume[app.volume].png"/><a href='byond://?src=\ref[src];choice=snakeVolume;vChange=1'><b>+</b></a></h4>"}
				if(app)
					dat += {"<br>
						<div style="position: relative; left: 0; top: 0;">
			...
			if (PDA_APP_MINESWEEPER)
				...
				dat += {"<h4><span class='[app.icon]'></span> Minesweeper</h4>"}
				if(app)
					dat += {"<br>
						<div style="position: relative; left: 0; top: 0;">
			...
			if (PDA_APP_SPESSPETS)
				...
				dat += {"<h4><span class='[app.icon]'></span> Spess Pets</h4>"}
				if(app)
	...
	var/datum/browser/clean/popup = new(user, "pda", "Personal Data Assistant", 400, 444)
	popup.set_window_options("border=1;can_resize=1;can_close=0;can_minimize=0;")
	popup.add_stylesheet("common", 'html/browser/PDA.css') //Completely fucking nuke common.css, because clean.css doesn't clean shit.

...
var/global/list/currentevents2 = list("CEO Discount Dan has been sued. Again.",
	...
	"Nanotrasen CEO John P. Nanotrasen has been photographed kicking a Tajaran to death. This shameful publicity stunt is part of the new 'NT Hates Catbeasts, do you?' campaign.",
	"Nanotrasen CEO John P. Nanotrasen has been photographed kicking a Vox in the cloaca. He commented that, 'BIRDS BELONG IN MY FUCKING MEALS DAMN IT'.",
	"Nanotrasen CEO John P. Nanotrasen is in hot water for an alleged sex scandal with a confused syndicate woman that took the motto 'Fuck NT' too seriously.",
	"Nanotrasen CEO John P. Nanotrasen issued a press release stating, 'Anybody who's fucking impersonating me is going to get fucking bluespaced unto a spike.'. We do not condone John P. Nanotrasen's use of foul language in the newsroom.",

...
var/global/list/currentevents2 = list("CEO Discount Dan has been sued. Again.",
	...
	"Nanotrasen CEO John P. Nanotrasen issued a press release stating, 'Anybody who's fucking impersonating me is going to get fucking bluespaced unto a spike.'. We do not condone Mr. Nanotrasen's use of foul language in the newsroom.",

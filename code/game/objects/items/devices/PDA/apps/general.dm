...
var/global/list/currentevents2 = list("CEO Discount Dan has been sued. Again.",
	...
	"Nanotrasen CEO John Nanotrasen and Discount Dan's CEO Discount Dan have been photographed buying a new friend necklace. The Syndicate issued a statement that 'That's cringey.'",
...
var/global/list/currentevents3 = list("Border patrol around Space America has tightened today after a wave of Tajarans yiffed their way across. We have reports of over 2000 molested Space Americans. More to come at seven.",
	...
	"Today, a man was discovered to be living with a 20 year old ghost in his house. When the ghost was questioned what killed him, he responded 'A FAGGOT!'. More at four.",

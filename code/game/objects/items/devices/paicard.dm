...
/obj/item/device/paicard/proc/setEmotion(var/emotion)
	...
	var/mutable_appearance/pai_icon = mutable_appearance(layer = src.layer, plane = src.plane, copy = src) //we also update the mob's appearance so it appears properly on the scoreboard.

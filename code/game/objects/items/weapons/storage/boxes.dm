...
/obj/item/weapon/storage/box/smartbox/clothing_box/jevil
	name = "Chaos jester outfit box"

/obj/item/weapon/storage/box/smartbox/clothing_box/jevil/New()

	new /obj/item/clothing/head/jevil(src)
	new /obj/item/clothing/mask/gas/jevil(src)
	new /obj/item/clothing/suit/jevil(src)
	new /obj/item/clothing/gloves/jevil(src)
	new /obj/item/clothing/shoes/clown_shoes/jevil(src)
	..()

/obj/item/weapon/storage/box/smartbox/clothing_box/goat_child
	name = "Dark Prince robe box"

/obj/item/weapon/storage/box/smartbox/clothing_box/goat_child/New()
	new /obj/item/clothing/head/wizard/goat_child(src)
	new /obj/item/clothing/glasses/goat_child(src)
	new /obj/item/clothing/mask/gas/goat_child(src)
	new /obj/item/clothing/suit/wizrobe/goat_child(src)
	..()
...
/obj/item/weapon/storage/box/smartbox/clothing_box/jevil_wiz
	name = "Chaos jester wizard outfit box"

/obj/item/weapon/storage/box/smartbox/clothing_box/jevil_wiz/New()
	new /obj/item/clothing/mask/gas/jevil(src)
	new /obj/item/clothing/head/wizard/jevil(src)
	new /obj/item/clothing/suit/wizrobe/jevil(src)
	new /obj/item/clothing/gloves/jevil(src)
	new /obj/item/clothing/shoes/clown_shoes/jevil/magic(src)
	..()

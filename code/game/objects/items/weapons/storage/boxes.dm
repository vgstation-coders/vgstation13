...
/obj/item/storage/box/surveillance
...
/obj/item/storage/box/surveillance/New()
	..()
...
/obj/item/storage/box/survival/vox/New()
	..()
	for(var/atom/A in src)
		qdel(A)
...
/obj/item/storage/box/survival/engineer/New()
	..()
	for(var/atom/A in src)
		qdel(A)
	new /obj/item/clothing/mask/breath(src)
...
/obj/item/storage/box/survival/ert/New()
	..()
	for(var/atom/A in src)
		qdel(A)
...
/obj/item/storage/box/survival/nuke
	icon_state = "box_nuke"

/obj/item/storage/box/survival/nuke/New()
	..()
	for(var/atom/A in src)
		qdel(A)
	...
	new /obj/item/tank/emergency_oxygen/double(src)
	new /obj/item/stack/medical/bruise_pack/bandaid(src)
	new /obj/item/reagent_containers/pill/cyanide(src) //For those who hate fun
	new /obj/item/reagent_containers/pill/laststand(src) //HOOOOOO HOOHOHOHOHOHO - N3X

/obj/item/storage/box/priority_care
...
/obj/item/storage/box/priority_care/New()
	..()
	new /obj/item/spacecash/c100(src)
	new /obj/item/reagent_containers/food/snacks/donkpocket/self_heating(src)
	for(var/i in 1 to 3)
		var/toSpawn = pick(
			...
			/obj/item/reagent_containers/food/drinks/americup,
			/obj/item/lighter/NT,
			25;/obj/item/toy/syndicateballoon/ntballoon,
			25;/obj/item/reagent_containers/food/snacks/chococoin,
			25;/obj/item/tank/emergency_oxygen/engi,
			25;/obj/item/reagent_containers/hypospray/autoinjector,
			25;/obj/item/reagent_containers/food/drinks/thermos/full
		)
		new toSpawn(src)

/obj/item/storage/box/byond
...
/obj/item/storage/box/byond/New()
	..()
...
/obj/item/storage/box/bgloves
	name = "box of black gloves"
	desc = "A box containing black gloves."
	icon_state = "bgloves"

/obj/item/storage/box/bgloves/New()
	..()
	for(var/i = 1 to 7)
		new /obj/item/clothing/gloves/black(src)

/obj/item/storage/box/sunglasses
	name = "box of sunglasses"
	desc = "A box containing sunglasses."
	icon_state = "sunglass"

/obj/item/storage/box/sunglasses/New()
	..()
	for(var/i = 1 to 7)
...
/obj/item/storage/box/syringes/New()
	...
	new /obj/item/reagent_containers/syringe/giant(src)
...
/obj/item/storage/box/injectors/New()
	..()
	for(var/i = 1 to 3)
		new /obj/item/dnainjector/nofail/h2m(src)
	for(var/i = 1 to 3)
		new /obj/item/dnainjector/nofail/m2h(src)
...
/obj/item/storage/box/syndigrenades
...
/obj/item/storage/box/syndigrenades/New()
	..()
	for(var/i = 1 to 7)
		new /obj/item/grenade/syndigrenade(src)

/obj/item/storage/box/syndisyringes
...
/obj/item/storage/box/syndisyringes/New()
	..()
	for(var/i = 1 to 7)
		new /obj/item/reagent_containers/syringe/syndi(src)
...
/obj/item/storage/box/smokebombs/New()
	..()
	for(var/i = 1 to 7)
		new /obj/item/grenade/smokebomb(src)

/obj/item/storage/box/stickybombs
	name = "box of stickybombs"
	icon_state = "stickybomb"

/obj/item/storage/box/stickybombs/New()
	..()
	for(var/i = 1 to 24)
...
/obj/item/storage/box/wind/New()
	..()
	for(var/i = 1 to 3)
		new /obj/item/grenade/chem_grenade/wind(src)
...
/obj/item/storage/box/foam/New()
	..()
	for(var/i = 1 to 7)
		new /obj/item/grenade/chem_grenade/metalfoam(src)

/obj/item/storage/box/boxen
	name = "boxen ranching kit"
	desc = "Everything you need to engage in your own horrific flesh cloning."

/obj/item/storage/box/boxen/New()
	..()
	new /obj/item/circuitboard/box_cloner(src)
	new /obj/item/reagent_containers/food/snacks/meat/box(src)
	new /obj/item/reagent_containers/food/snacks/meat/box(src)
...
/obj/item/storage/box/bolas/New()
	..()
	for(var/i = 1 to 7)
		new /obj/item/legcuffs/bolas(src)
...
/obj/item/storage/box/donkpockets/random_amount/New()
...
/obj/item/storage/box/monkeycubes
	...
	can_only_hold = list("/obj/item/reagent_containers/food/snacks/monkeycube")
...
/obj/item/storage/box/monkeycubes/mousecubes/New()
	..()
	for(var/i = 1; i <= 5; i++)
		new /obj/item/reagent_containers/food/snacks/monkeycube/wrapped/mousecube(src)
...
/obj/item/storage/box/large/securitygear/New()
	..()
...
/obj/item/storage/box/large/detectivegear/New()
	..()
	new /obj/item/device/radio/headset/headset_sec(src)
	var/glasses = pick(/obj/item/clothing/glasses/sunglasses/sechud/prescription, /obj/item/clothing/glasses/sunglasses/sechud)
	new glasses(src)
	new /obj/item/clothing/gloves/black(src)
	new /obj/item/storage/belt/detective(src)
	new /obj/item/switchtool/switchblade(src)
	new /obj/item/device/gps/secure(src)
...
/obj/item/storage/box/lethalshells
	name = "12-gauge slugs"
	icon_state = "slug_shells"
	storage_slots = 16

/obj/item/storage/box/lethalshells/New()
	..()
	for(var/i in 1 to 16)
		new /obj/item/ammo_casing/shotgun(src)

/obj/item/storage/box/beanbagshells
	name = "12-gauge beanbag shells"
	icon_state = "beanbag_shells"
	storage_slots = 16

/obj/item/storage/box/beanbagshells/New()
	..()
	for(var/i in 1 to 16)
...
/obj/item/storage/box/dartshells/New()
	..()
	for(var/i in 1 to 16)
		new /obj/item/ammo_casing/shotgun/dart(src)

/obj/item/storage/box/buckshotshells
	name = "12-gauge 00 buckshot shells"
	icon_state = "buckshot_shells"
	storage_slots = 16

/obj/item/storage/box/buckshotshells/New()
	..()
	for(var/i in 1 to 16)
		new /obj/item/ammo_casing/shotgun/buckshot(src)

/obj/item/storage/box/dragonsbreathshells
	name = "12-gauge dragon's breath shells"
	icon_state = "dragonsbreath_shells"
	storage_slots = 16

/obj/item/storage/box/dragonsbreathshells/New()
	..()
	for(var/i in 1 to 16)
...
/obj/item/storage/box/syndicatefake/space
	name = "Space Suit and Helmet Replica"
	icon_state = "box_of_doom"
	item_state = "box_of_doom"

/obj/item/storage/box/syndicatefake/space/New()
	..()
	new /obj/item/clothing/suit/syndicatefake(src)
	new /obj/item/clothing/head/syndicatefake(src)

/obj/item/storage/box/syndicatefake/ninja
	name = "Ninja Suit and Hood Replica"
	icon_state = "box_of_doom"
	item_state = "box_of_doom"

/obj/item/storage/box/syndicatefake/ninja/New()
	..()
...
/obj/item/storage/box/mugs
	name = "box of mugs"
	desc = "It's a box of mugs."
	icon_state = "box_mug"

/obj/item/storage/box/mugs/New()
	..()
	for(var/i=0,i<6,i++)
...
/obj/item/storage/box/lights
	...
	foldable = /obj/item/stack/sheet/cardboard //BubbleWrap
	storage_slots=21
	can_only_hold = list("/obj/item/light/tube", "/obj/item/light/bulb")
...
/obj/item/storage/box/lights/he
	name = "high efficiency lights"
	icon_state = "lightmixed"

/obj/item/storage/box/lights/he/New()
	..()
	for(var/i = 0; i < 14; i++)
		new /obj/item/light/tube/he(src)
	for(var/i = 0; i < 7; i++)
		new /obj/item/light/bulb/he(src)
...
/obj/item/storage/box/inflatables/New()
	..()
	for(var/i = 1 to 3)
...
/obj/item/storage/box/ornaments
...
/obj/item/storage/box/ornaments/New()
	..()
	for(var/i = 1 to 6)
...
/obj/item/storage/box/ornaments/teardrop_ornaments
...
/obj/item/storage/box/ornaments/teardrop_ornaments/New()
	..()
	for(var/atom/A in src)
		qdel(A)
	for(var/i = 1 to 7)
...
/obj/item/storage/box/spellbook
...
/obj/item/storage/box/spellbook/New()
	..()
	var/list/possible_books = subtypesof(/obj/item/spellbook/oneuse)
	for(var/S in possible_books)
		var/obj/item/spellbook/oneuse/O = S
...
/obj/item/storage/box/balloons/New()
	..()
	for(var/i = 1 to 7)
		new /obj/item/toy/balloon(src)

/obj/item/storage/box/chrono_grenades/future
	icon_state = "future_grenade"

/obj/item/storage/box/chrono_grenades/future/New()
	..()
	for(var/atom/A in src)
		qdel(A)
	for(var/i = 1 to 7)
...
/obj/item/storage/box/balloons/long/living/New()
	..()
	for(var/atom/A in src)
		qdel(A)
	for(var/i = 1 to 7)
...
/obj/item/storage/box/chrono_grenades/past
	icon_state = "past_grenade"

/obj/item/storage/box/chrono_grenades/past/New()
	..()
	for(var/atom/A in src)
		qdel(A)
	for(var/i = 1 to 7)
		new /obj/item/grenade/chronogrenade/past(src)
...
/obj/item/storage/box/actionfigure/New()
	..()
	for(var/i in 1 to 4)
...
/obj/item/storage/box/mechfigures/New()
	..()
	for(var/i in 1 to 4)
...
/obj/item/storage/box/diy_soda/New()
	..()
	new /obj/item/reagent_containers/glass/beaker/vial/tenwater(src)
	new /obj/item/reagent_containers/glass/beaker/vial/tencarbon(src)
	new /obj/item/reagent_containers/glass/beaker/vial/tenantitox(src)
	new /obj/item/reagent_containers/glass/beaker/erlenmeyer/lemonlime(src)
	new /obj/item/reagent_containers/glass/beaker/erlenmeyer/sodawater(src)
	new /obj/item/reagent_containers/glass/beaker/large/erlenmeyer(src)
	new /obj/item/paper/diy_soda(src)


//Smart boxes.
/obj/item/storage/box/smartbox
	name = "Smart-box"
...
/obj/item/storage/box/smartbox/remove_from_storage(obj/item/W, atom/new_location, var/force = 0, var/refresh = 1)
	. = ..()
...
/obj/item/storage/box/smartbox/attackby(obj/item/W, mob/user)
	if(one_way)
...
//Clothing-boxes.
/obj/item/storage/box/smartbox/clothing_box
	name = "box"
...
/obj/item/storage/box/smartbox/clothing_box/New()
    ..()
    if(contents.len)
...
/obj/item/storage/box/smartbox/clothing_box/chickensuit
	name = "Chicken suit box"

/obj/item/storage/box/smartbox/clothing_box/chickensuit/New()
	new	/obj/item/clothing/head/chicken(src)
	new /obj/item/clothing/suit/chickensuit(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/monkeysuit
	name = "Monkey suit box"

/obj/item/storage/box/smartbox/clothing_box/monkeysuit/New()
	new	/obj/item/clothing/mask/gas/monkeymask(src)
	new /obj/item/clothing/suit/monkeysuit(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/xenosuit
	name = "Xeno suit box"

/obj/item/storage/box/smartbox/clothing_box/xenosuit/New()
	new /obj/item/clothing/head/xenos(src)
	new /obj/item/clothing/suit/xenos(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/gladiatorsuit
	name = "Gladiator suit box"

/obj/item/storage/box/smartbox/clothing_box/gladiatorsuit/New()
	new /obj/item/clothing/head/helmet/gladiator(src)
	new /obj/item/clothing/under/gladiator(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/captaincasualoutfit
	name = "Captain's casual box"

/obj/item/storage/box/smartbox/clothing_box/captaincasualoutfit/New()
...
/obj/item/storage/box/smartbox/clothing_box/schoolgirloutfit
	name = "School girl outfit box"

/obj/item/storage/box/smartbox/clothing_box/schoolgirloutfit/New()
...
/obj/item/storage/box/smartbox/clothing_box/pirateoutfit
	name = "Pirate outfit box"

/obj/item/storage/box/smartbox/clothing_box/pirateoutfit/New()
...
/obj/item/storage/box/smartbox/clothing_box/sovietoutfit
	name = "Soviet outfit box"

/obj/item/storage/box/smartbox/clothing_box/sovietoutfit/New()
	new /obj/item/clothing/head/ushanka(src)
	new /obj/item/clothing/under/soviet(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/fakewizard
	name = "Wizard outfit box"

/obj/item/storage/box/smartbox/clothing_box/fakewizard/New()
	new /obj/item/clothing/head/wizard/fake(src)
	new /obj/item/clothing/suit/wizrobe/fake(src)
	new /obj/item/staff(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/witch
	name = "Witch outfit box"

/obj/item/storage/box/smartbox/clothing_box/witch/New()
	new /obj/item/clothing/head/witchwig(src)
	new /obj/item/staff/broom(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/marisa
	name = "Marisa outfit box"

/obj/item/storage/box/smartbox/clothing_box/marisa/New()
	new /obj/item/clothing/head/wizard/marisa/fake(src)
	new /obj/item/clothing/suit/wizrobe/marisa/fake(src)
	new /obj/item/staff/broom(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/sexyclown
	name = "Sexy clown outfit box"

/obj/item/storage/box/smartbox/clothing_box/sexyclown/New()
	new /obj/item/clothing/mask/gas/sexyclown(src)
	new /obj/item/clothing/under/sexyclown(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/sexymime
	name = "Sexy mime outfit box"

/obj/item/storage/box/smartbox/clothing_box/sexymime/New()
	new /obj/item/clothing/mask/gas/sexymime(src)
	new /obj/item/clothing/under/sexymime(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/jester
	name = "Jester outfit box"

/obj/item/storage/box/smartbox/clothing_box/jester/New()
...
/obj/item/storage/box/smartbox/clothing_box/clownpiece
	name = "Clownpiece outfit box"

/obj/item/storage/box/smartbox/clothing_box/clownpiece/New()
...
/obj/item/storage/box/smartbox/clothing_box/plaguedoctor
	name = "Plague doctor outfit box"

/obj/item/storage/box/smartbox/clothing_box/plaguedoctor/New()
...
/obj/item/storage/box/smartbox/clothing_box/maid
	name = "Maid outfit box"

/obj/item/storage/box/smartbox/clothing_box/maid/New()
	new /obj/item/clothing/suit/maidapron(src)
	new /obj/item/clothing/head/maidhat(src)
	new /obj/item/clothing/under/maid(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/liberty
	name = "Patriot outfit box"

/obj/item/storage/box/smartbox/clothing_box/liberty/New()
...
/obj/item/storage/box/smartbox/clothing_box/mega
	name = "Megaman outfit box"

/obj/item/storage/box/smartbox/clothing_box/mega/New()
...
/obj/item/storage/box/smartbox/clothing_box/aviator
	name = "Aviator outfit box"

/obj/item/storage/box/smartbox/clothing_box/aviator/New()
...
/obj/item/storage/box/smartbox/clothing_box/proto
	name = "Protoman outfit box"

/obj/item/storage/box/smartbox/clothing_box/proto/New()
...
/obj/item/storage/box/smartbox/clothing_box/hastur
	name = "Hastur outfit box"

/obj/item/storage/box/smartbox/clothing_box/hastur/New()
	new	/obj/item/clothing/head/hasturhood(src)
	new /obj/item/clothing/suit/hastur(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/owl
	name = "Owl outfit box"

/obj/item/storage/box/smartbox/clothing_box/owl/New()
	new /obj/item/clothing/mask/gas/owl_mask(src)
	new /obj/item/clothing/under/owl(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/lordadmiral
	name = "Lord admiral outfit box"

/obj/item/storage/box/smartbox/clothing_box/lordadmiral/New()
	new /obj/item/clothing/head/lordadmiralhat(src)
	new /obj/item/clothing/suit/lordadmiral(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/rotten
	name = "Rotten outfit box"

/obj/item/storage/box/smartbox/clothing_box/rotten/New()
	new /obj/item/clothing/under/rottensuit(src)
	new /obj/item/clothing/shoes/rottenshoes(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/frank
	name = "Dr. Frank outfit box"

/obj/item/storage/box/smartbox/clothing_box/frank/New()
...
/obj/item/storage/box/smartbox/clothing_box/mexican //is this offensive?
	name = "Mexican outfit box"

/obj/item/storage/box/smartbox/clothing_box/mexican/New()
...
/obj/item/storage/box/smartbox/clothing_box/joe
	name = "Sniper outfit box"

/obj/item/storage/box/smartbox/clothing_box/joe/New()
...
/obj/item/storage/box/smartbox/clothing_box/lola
	name = "Fighting clown outfit box"

/obj/item/storage/box/smartbox/clothing_box/lola/New()
...
/obj/item/storage/box/smartbox/clothing_box/wizard_robes
	name = "Wizard robe box"

/obj/item/storage/box/smartbox/clothing_box/wizard_robes/New()
	new /obj/item/clothing/head/wizard(src)
	new /obj/item/clothing/suit/wizrobe(src)
	new /obj/item/clothing/shoes/sandal(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/red_wizrobes
	name = "Red wizard robe box"

/obj/item/storage/box/smartbox/clothing_box/red_wizrobes/New()
	new /obj/item/clothing/head/wizard/red(src)
	new /obj/item/clothing/suit/wizrobe/red(src)
	new /obj/item/clothing/shoes/sandal(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/clown_wizrobes
	name = "Clown wizard outfit box"

/obj/item/storage/box/smartbox/clothing_box/clown_wizrobes/New()
...
/obj/item/storage/box/smartbox/clothing_box/marisa_wiz
	name = "Ordinary witch robe box"

/obj/item/storage/box/smartbox/clothing_box/marisa_wiz/New()
...
/obj/item/storage/box/smartbox/clothing_box/hallowiz
	name = "Halloween robe box"

/obj/item/storage/box/smartbox/clothing_box/hallowiz/New()
	new /obj/item/clothing/head/wizard/hallowiz(src)
	new /obj/item/clothing/suit/wizrobe/hallowiz(src)
	new /obj/item/clothing/shoes/sandal(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/mystic_robes
	name = "Mystic robe box"

/obj/item/storage/box/smartbox/clothing_box/mystic_robes/New()
	new /obj/item/clothing/head/wizard/mystic(src)
	new /obj/item/clothing/suit/wizrobe/mystic(src)
	new /obj/item/clothing/shoes/sandal(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/winter_wiz
	name = "\"Winter robes\" box"

/obj/item/storage/box/smartbox/clothing_box/winter_wiz/New()
	new /obj/item/clothing/head/wizard/winter(src)
	new /obj/item/clothing/suit/wizrobe/winter(src)
	new /obj/item/clothing/shoes/sandal(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/magician
	name = "Magician outfit box"

/obj/item/storage/box/smartbox/clothing_box/magician/New()
	new /obj/item/clothing/head/that/magic(src)
	new /obj/item/clothing/suit/wizrobe/magician(src)
	new /obj/item/clothing/shoes/sandal/marisa/leather(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/necromancer
	name = "Necromancer robe box"

/obj/item/storage/box/smartbox/clothing_box/necromancer/New()
	new /obj/item/clothing/head/wizard/necro(src)
	new /obj/item/clothing/suit/wizrobe/necro(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/pharaoh
	name = "Pharaoh robe box"

/obj/item/storage/box/smartbox/clothing_box/pharaoh/New()
	new /obj/item/clothing/head/pharaoh(src)
	new /obj/item/clothing/suit/wizrobe/pharaoh(src)
	..()

/obj/item/storage/box/smartbox/clothing_box/clownpsyche
	name = "Clown psychedelic outfit box"

/obj/item/storage/box/smartbox/clothing_box/clownpsyche/New()
...
/obj/item/storage/box/smartbox/clothing_box/gemsuit
	name = "Gemsuit outfit box"

/obj/item/storage/box/smartbox/clothing_box/gemsuit/New()

...
/obj/item/weapon/storage/briefcase/orderly
	...
	desc = "A briefcase for storing sedatives and other tools of the trade. Has a medical cross emblazoned on each side."
...
/obj/item/weapon/storage/briefcase/orderly/New()
	...
	for (var/i = 1 to 6)
		new /obj/item/weapon/reagent_containers/hypospray/autoinjector/sedative_injector(src)

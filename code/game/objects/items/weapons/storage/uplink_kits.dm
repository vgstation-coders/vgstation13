/obj/item/storage/box/syndicate/New(var/loc, var/list/conditions, var/forced_bundle)
	..()
	var/tagname
	if(!forced_bundle)
	...
	switch (tagname)
		...
		if("stealth")//12+8+6+1=27
			...
			new /obj/item/pen/paralysis(src)
		...
		if("murder")//8+6+6+2+4=26
			...
			new /obj/item/card/emag(src)
			new /obj/item/clothing/shoes/syndigaloshes(src)
			new /obj/item/storage/belt/skull(src)
		...
		if("hacker")//14+6+5+3=28
			new /obj/item/aiModule/freeform/syndicate(src)
			new /obj/item/card/emag(src)
		...
		if("hotline")//5+10+2+(hyperzine pills, 2x2?)=22
			...
			new /obj/item/clothing/mask/gas/voice(src)
			new /obj/item/kitchen/utensil/knife/large/butch/meatcleaver(src)
			new /obj/item/storage/pill_bottle/hyperzine(src)
			new /obj/item/storage/pill_bottle/hyperzine(src)
			new /obj/item/card/id/syndicate(src)
			new /obj/item/soap/syndie(src)
		...
		if ("sith")
			if("plasmaman" in conditions) //General Veers, you're too close to me
				...
				new /obj/item/spellbook/oneuse/bound_object(src)
				...
				new /obj/item/melee/energy/sword/red(src) //He had like one saber when he went ballistic but you get it
				new /obj/item/melee/energy/sword/red(src) //Combine these into a double e-sword
				new /obj/item/dnainjector/nofail/telemut(src)
				new /obj/item/dnainjector/nofail/jumpy(src)
				new /obj/item/spellbook/oneuse/bound_object(src)
				new /obj/item/spellbook/oneuse/lightning/sith(src) //UNLIMITED POWER, requires wizard garb
				new /obj/item/clothing/head/sith(src)
				new /obj/item/clothing/suit/sith(src)
				new /obj/item/clothing/shoes/sandal(src)

		if("anarchist")//14+14+6=34, plus molotovs
			new /obj/item/implanter/traitor(src)
			new /obj/item/implanter/traitor(src)
			new /obj/item/clothing/mask/bandana/red(src)
			new /obj/item/clothing/mask/bandana/red(src)
			new /obj/item/clothing/mask/bandana/red(src)
			new /obj/item/card/emag(src)
			new /obj/item/storage/box/syndie_kit/molotovs(src)

		if("emagsandglue")//(4+6+4+6+4+6+4)*5=memes
			new /obj/item/storage/box/syndie_kit/emags_and_glue(src)
			new /obj/item/storage/box/syndie_kit/emags_and_glue(src)
			new /obj/item/storage/box/syndie_kit/emags_and_glue(src)
			new /obj/item/storage/box/syndie_kit/emags_and_glue(src)
			new /obj/item/storage/box/syndie_kit/emags_and_glue(src)
		...
		if("highlander")//SCOTLAND
			...
			new /obj/item/glue(src)
			new /obj/item/vinyl/scotland(src)
			new /obj/item/spellbook/oneuse/mutate/highlander(src)
...
/obj/item/storage/box/syndie_kit/surveillance
	name = "box (S)"

/obj/item/storage/box/syndie_kit/surveillance/New()
	..()
	new /obj/item/device/handtv(src)
	new /obj/item/storage/box/surveillance(src)
	return
...
/obj/item/storage/box/syndie_kit/greytide
	name = "box (GT)"

/obj/item/storage/box/syndie_kit/greytide/New()
	..()
	new /obj/item/implanter/traitor(src)
	new /obj/item/implanter/traitor(src)
...
/obj/item/storage/box/syndie_kit/ammo
	name = "box (spare ammo)"

/obj/item/storage/box/syndie_kit/ammo/New()
	..()
	new /obj/item/ammo_storage/speedloader/a357(src)
	return

obj/item/storage/box/syndie_kit/cheaptide
	name = "box (CT)"

/obj/item/storage/box/syndie_kit/cheaptide/New()
	..()
	new /obj/item/implanter/traitor(src)
	new /obj/item/clothing/glasses/sunglasses/sechud/syndishades(src)

/obj/item/storage/box/syndie_kit/flaregun
	name = "box (modified flare gun)"

/obj/item/storage/box/syndie_kit/flaregun/New()
	..()
	new /obj/item/gun/projectile/flare/syndicate(src)
	new /obj/item/ammo_storage/box/flare(src)
	return

/obj/item/storage/box/syndie_kit/explosive_hug
	name = "box (C)"

/obj/item/storage/box/syndie_kit/explosive_hug/New()
	..()
	new /obj/item/reagent_containers/glass/bottle/antisocial(src)
	new /obj/item/reagent_containers/syringe(src)
	return

/obj/item/storage/box/syndie_kit/lethal_hyperzine
	name = "box (C)"

/obj/item/storage/box/syndie_kit/lethal_hyperzine/New()
	..()
	new /obj/item/reagent_containers/glass/bottle/hypozine(src)
	new /obj/item/reagent_containers/syringe(src)
	return

/obj/item/storage/box/syndie_kit/smokebombs
	name = "snap pop box"
...
/obj/item/storage/box/syndie_kit/smokebombs/New()
	..()
	for(var/i=1; i <= storage_slots; i++)
		new /obj/item/toy/snappop/smokebomb(src)

/obj/item/storage/box/syndie_kit/molotovs/
	name = "box (molotovs)"

/obj/item/storage/box/syndie_kit/molotovs/New()
	..()
	for(var/i = 1 to 6)
		new /obj/item/reagent_containers/food/drinks/molotov(src)
	new /obj/item/lighter/red(src)

/obj/item/storage/box/syndie_kit/emags_and_glue/ //Exactly what it sounds like.
	name = "box (E&G)"

/obj/item/storage/box/syndie_kit/emags_and_glue/New()
	..()
	new /obj/item/glue(src)
	new /obj/item/card/emag(src)
	new /obj/item/glue(src)
...
/obj/item/storage/box/syndicate_experimental/New()
	..()
	var/selection = pick("damocles", "bomber vest", "bike horn")
	switch(selection)
		if("damocles")
			new /obj/item/damocles(src)
		if("bomber vest")
			new /obj/item/clothing/suit/bomber_vest(src)
		if("bike horn")
			new /obj/item/bikehorn/syndicate(src)

/obj/item/storage/box/syndie_kit/cratesender
	name = "box (CS)"

/obj/item/storage/box/syndie_kit/cratesender/New()
	..()
	new /obj/item/device/telepad_beacon(src)
	new /obj/item/rcs/salvage/syndicate(src)

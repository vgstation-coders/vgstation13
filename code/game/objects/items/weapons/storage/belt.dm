...
/obj/item/storage/belt/can_quick_store(var/obj/item/I)
	return can_be_inserted(I,1)

/obj/item/storage/belt/quick_store(var/obj/item/I)
...
/obj/item/storage/belt/utility/complete/New()
	..()
...
/obj/item/storage/belt/utility/chief/full/New() //This is mostly for testing I guess
	..()
	new /obj/item/crowbar(src)
	new /obj/item/screwdriver(src)
	...
	new /obj/item/solder/pre_fueled(src)
...
/obj/item/storage/belt/security/batmanbelt
	name = "batbelt"
	desc = "For all your crime-fighting bat needs."
	icon_state = "bmbelt"
	item_state = "bmbelt"

/obj/item/storage/belt/security/batmanbelt/New()
	..()
	can_only_hold |= "/obj/item/gun/hookshot"
...
/obj/item/storage/belt/silicon/New()
	..()
	new /obj/item/device/aicard(src) //One freebie card

/obj/item/storage/belt/silicon/proc/GetCyberbeltMobs()
	var/list/mobs = list()
...
/proc/RenderBeltChat(var/obj/item/storage/belt/silicon/B,var/mob/living/C,var/message)
...
/obj/item/storage/belt/lazarus/remove_from_storage(obj/item/W as obj, atom/new_location, var/force = 0, var/refresh = 1)
	. = ..()
	update_icon()
...
/obj/item/storage/belt/thunderdome
	name = "Thunderdome Belt"
	desc = "Can hold the thunderdome IDs of your fallen foes."
	item_state = ""
	storage_slots = 30
	can_only_hold = list("/obj/item/card/id/thunderdome")

/obj/item/storage/belt/thunderdome/green
	icon_state = "td_belt-green"

/obj/item/storage/belt/thunderdome/red
	icon_state = "td_belt-red"

/obj/item/storage/belt/security/doomguy
	name = "Doomguy's belt"
	desc = ""
	icon_state = "doom"
	item_state = "doom"

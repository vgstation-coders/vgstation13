...
/obj/item/card/emag/New(var/loc, var/disable_tuning=0)
	..(loc)
...
/obj/item/card/emag/proc/canUse(var/mob/user, var/obj/machinery/M)
...
/obj/item/card/emag/afterattack(var/atom/target, mob/user, proximity)
	if(!proximity)
		return
...
/obj/item/card/id/get_owner_name_from_ID()
	return registered_name

/obj/item/card/id/proc/update_virtual_wallet(var/new_funds=0)
...
/obj/item/card/id/proc/add_to_virtual_wallet(var/added_funds=0, var/mob/user, var/atom/source)
	if(!virtual_wallet)
		return 0
...
/obj/item/card/id/proc/GetBalance(var/format=0)
	var/amt = 0
...
/obj/item/card/id/proc/GetJobName()
...
/obj/item/card/id/proc/GetJobRealName()
...
/obj/item/card/id/nt_disguise/attack_self(mob/user)
...
/obj/item/card/id/syndicate/commando
	name = "Hacked syndie card"

/obj/item/card/id/syndicate/commando/New()
	..()
	access = get_all_accesses()

/obj/item/card/id/syndicate/afterattack(var/obj/item/O as obj, mob/user as mob)
...
/obj/item/card/id/tunnel_clown
	name = "Tunnel Clown ID card"
	assignment = "Tunnel Clown!"

/obj/item/card/id/tunnel_clown/New()
	..()
	access = get_all_accesses()

/obj/item/card/id/syndicate/assassin
	name = "Reaper ID card"
	assignment = "Reaper"

/obj/item/card/id/syndicate/assassin/New()
	..()
	access = get_all_accesses()
...
/obj/item/card/id/death_commando/New()
	. = ..()
	access = get_centcom_access("Death Commando")

/obj/item/card/id/death_commando_leader
	name = "Sgt.Reaper ID card"
	assignment = "Death Commander"
	icon_state = "creed"

/obj/item/card/id/death_commando_leader/New()
	. = ..()

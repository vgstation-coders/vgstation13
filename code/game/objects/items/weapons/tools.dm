...
/obj/item/weapon/wrench/socket
	...
	construction_delay_mult[Co_CON_SPEED] = .5   //So it is actually better other than for one single thing
	construction_delay_mult[Co_DECON_SPEED] = .5 //So it is actually better other than for one single thing

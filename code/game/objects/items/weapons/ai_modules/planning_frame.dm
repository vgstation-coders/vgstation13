...
/obj/item/planning_frame
	...
	var/list/obj/item/aiModule/modules = list()
	var/datum/ai_laws/laws

/obj/item/planning_frame/New()
	. = ..()
	laws = new base_law_type

/obj/item/planning_frame/attackby(var/obj/item/W,var/mob/user)
	if(istype(W, /obj/item/aiModule))
		var/obj/item/aiModule/module=W
...
/obj/item/planning_frame/attack_self(var/mob/user)
	for(var/obj/item/aiModule/mod in modules)
		qdel(mod)
	modules.len = 0
...
/obj/item/planning_frame/examine(mob/user)
	..()
	laws_sanity_check()
	if(modules.len && istype(modules[1],/obj/item/aiModule/purge))
...
/obj/item/planning_frame/proc/laws_sanity_check()
	if (!src.laws)
		src.laws = new base_law_type

/obj/item/planning_frame/proc/set_zeroth_law(var/law, var/law_borg)
	laws_sanity_check()
	laws.set_zeroth_law(law, law_borg)

/obj/item/planning_frame/proc/add_inherent_law(var/law)
	laws_sanity_check()
	src.laws.add_inherent_law(law)

/obj/item/planning_frame/proc/clear_inherent_laws()
	laws_sanity_check()
	src.laws.clear_inherent_laws()

/obj/item/planning_frame/proc/add_ion_law(var/law)
	laws_sanity_check()
	src.laws.add_ion_law(law)

/obj/item/planning_frame/proc/clear_ion_laws()
	laws_sanity_check()
	src.laws.clear_ion_laws()

/obj/item/planning_frame/proc/add_supplied_law(var/number, var/law)
	laws_sanity_check()
	src.laws.add_supplied_law(number, law)

/obj/item/planning_frame/proc/clear_supplied_laws()
	laws_sanity_check()

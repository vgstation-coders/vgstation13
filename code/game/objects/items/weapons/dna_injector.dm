...
/obj/item/weapon/dnainjector/nofail/interference
	name = "DNA-Injector (Inteference)"
	desc = "Hidden in plain sight"
	datatype = DNA2_BUF_SE
	value = 0xFFF
	//block = 2

/obj/item/weapon/dnainjector/nofail/interference/initialize()
	block = INTERFERENCEBLOCK
	..()


/obj/item/weapon/dnainjector/nofail/antiinterference
	name = "DNA-Injector (Anti-Interference)"
	desc = "There are eyes everywhere"
	datatype = DNA2_BUF_SE
	value = 0x001
	//block = 2

/obj/item/weapon/dnainjector/nofail/antiinterference/initialize()
	block = INTERFERENCEBLOCK
	..()

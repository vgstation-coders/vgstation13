/obj/item/robot_parts/attack(mob/living/carbon/human/M as mob, mob/living/carbon/user as mob)
	...
	if(!((locate(/obj/machinery/optable, M.loc) && M.resting) || (locate(/obj/structure/bed/roller, M.loc) && (M.incapacitated()) && prob(75) || (locate(/obj/structure/table/, M.loc) && (M.lying || M.knockdown || M.stunned || M.paralysis || M.sleeping || M.stat) && prob(66))))
		return ..()

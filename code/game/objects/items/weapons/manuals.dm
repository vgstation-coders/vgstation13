...
/obj/item/weapon/book/manual/security_antag_guide/New(turf/loc)
	...
	dat = {"<html>
                ...
                <p>Due to the high cost of silver compared to lead and energy weaponry, Nanotrasen has declined to issue specific anti-vampire bullets. However, vampire lords have shown a surprising weakness to all that is Holy, regardless of creed and denomination. A great way to get rid of them permanently is thus to drag them in the station's chapel until their body turns to ashes. Holy Water and Harebells Incense also proves very efficient at harming them and hindering their abilities. Lastly, the Nullrods wielded by chaplains have shown efficiency at protecting them from those same powers.

...
/obj/item/weapon/book/manual/security_antag_guide/New(turf/loc)
	...
	dat = {"<html>
				...
				<p>A highly trained team of Syndicate special agents, usually equipped with red rigsuits and 12mm SMGs. With blatant disrespect for the lives of their agents, the Syndicate has rigged their brains with explosive implants, in the goal of taking  their aggressor's life in their final breath. It is recommended to keep your distance as you fight them. The Operatives' goal is to acquire the station captain's nuclear authentication disk, so they can prime the nuclear fission device they carry in their ship, and blow the station up to smithereens. Confirmed sightings of operatives are grounds the crew with armory weapons as you will need all the firepower you can muster to fight them back. Sightings of operatives with cyborgs and mechas have been reported, against which it is recommended to use the ion rifles provided in your armory. Keep track of the disk's location at all times, and secure high priority locations such as the Armory, Medbay, Telecomms, and Engineering.

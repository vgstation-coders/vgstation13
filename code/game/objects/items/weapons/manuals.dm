...
/obj/item/weapon/book/manual/security_antag_guide/New(turf/loc)
	...
	dat = {"<html>
				...
				<p>Out of all the enemies of our corporation out there, these have proven to be the most puzzling and unpredictable. Most of them suddenly appear aboard our space stations dressed in robes, sandals and large hats, and proceed to manifest a plethora of anomalous abilities that wreck havoc among our crews. Due to the unexplained nature of their powers, and their strange appearance, we label those individuals "wizards".
                <p>We've had many different reports on what they can do, dozens upon dozens of cases that would not fit inside this manual, but here are a few to give you some expectations. Some of them: have cars that can drive through walls, can touch anything to send it somewhere else on the station, can summon lightning at their fingertips, can cause your butt to spontaneously leave your body, can turn people to stone, can animate objects into fighting for them, can teleport around freely, the list just goes on and on...

...
/obj/item/weapon/book/manual/security_antag_guide/New(turf/loc)
	...
	dat = {"<html>
                ...
                <p>The Syndicate is a collaboration of enemy corporations to Nanotrasen. They are the most notorious threat to our space stations as they have made it their official goal to challenge Nanotrasen's influence on the sector. No crime is below a Syndicate agent. Thievery, murder, sabotage, and the outright destruction of stations via nuclear devices are among their observed tactics. These enemies of the corporation are to be neutralised, detained, or in extreme cases, terminated on sight. Their red attire has been attributed to their scavenging of old soviet spacesuits from the fourth Cold War era.

				<h3>Traitors</h3>
				<p>Being unable to defeat NT in the open, Syndicate agents have opted to infiltrate many of our space stations and now live among us. The Syndicate's vast network of sleeper cells defies all investigation, and as such pre-emptive attempts at discovering infiltrators is discouraged by company policy (see Space Law and Standard Operating Procedure). Agents come equipped with an uplink filled with "telecrystals" (TCs), cleverly hidden in their PDAs. With such device, they are able transport highly dangerous items aboard the station, in their foolish attempts to cause wanton sabotage and destruction. Be aware of Syndicate contraband when apprehending suspects.

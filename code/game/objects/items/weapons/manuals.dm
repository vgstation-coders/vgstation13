...
/obj/item/weapon/book/manual/security_antag_guide/New(turf/loc)
	...
	dat = {"<html>
				...
				<p>It has come to our attention that some of our employees have displayed a simultaneous propension for hematophagy, hypersensitivity to sunlight, and ability to perform various anomalous feats. Research on these symptoms has led us to find reports of similar cases a long time ago on Earth, therefore we give those individuals the same name label they were given back then: "vampires".
				<p>We don't know for sure if those crew members developed those abilities here in space, or if they came from Earth and managed to hide among the migrants to our system, but they seem to exhibit a tendency to try and turn our space stations into their own personal territories and blood banks, therefore they are to be stopped in their ambitions. Some of the anomalous powers observed include the ability to turn into bats, hypnotize humans into a paralysis, turn those humans into their thralls, and quickly regenerate their cells to heal all of their own wounds, even from a seemingly dead state.
                <p>Because of those abilities, conventional ways of fighting prove often inefficient, fortunately, experiments on a few captured individuals have revealed a deadly allergy to holy water, harebells incense, and garlic, and most importantly: they spontaneously combust until only ashes remain when in view of the sun or when they find themselves in a holy place, which has greatly reinforced the incentive to build chapels aboard our space stations. Lastly, the Nullrods carried by chaplains have shown great efficiency at protecting their wielders from the vampires' powers.
                ...
                <p>There are no notable visual differences between a regular human and a changeling most of the time, so stay alert for sudden changes in personality among the crew. However they display highly visible mutations when using their abilities: they use a proboscis to both suck a human's DNA, or to inject them with various harmful chemicals. Changelings driven into a corner may fight back. We have footage involving them mutating into a horrifying form turning them extremely lethal and resistant.
        ...
        <p>Revolutionary unionists have infiltrated the crew of some of our stations to try and wrestle its control away from us. They grow their numbers at a quick pace through use of hypnotic flash devices until they start attacking the heads of staff. If you see people getting randomly flashed in the hallways (by non-security members), inform the authorities immediately.

...
/obj/item/weapon/book/manual/security_antag_guide/New(turf/loc)
	...
	dat = {"<html>
				...
				<p>A highly trained team of Syndicate agents, usually equipped with red rigsuits and 12mm SMGs. They are not only highly dangerous to fight but even to kill, as their brains are rigged with explosive implants that will try and take their aggressor's life with theirs, keep your distance as you fight them. Their goal is to acquire the station captain's nuclear authentication disk, so they can prime the nuclear fission device they carry in their ship, and blow the station up to smithereens. If they show up, do not hesitate to provide the crew with armory weapons as you will need all the firepower you can muster to fight them back. Some of those squads even come accompanied with cyborgs and mechas, against which you will want to use the ion rifles provided in your armory. Keep track of the disk's location at all times, and secure high priority locations such as the Armory, Medbay, Telecomms, and Engineering.

				<h3>Challengers</h3>
				<p>The Syndicate trains its traitors to become nuclear operatives through a Battle Royal in which some of its agents are targeting each other. On the bright side, those challengers are here to kill each other. On the downside, they don't care about how much collateral damage they cause, AND the victor may graduate to become a fully fledged nuclear operative one day. We do not want that. Challengers often grimly display the corpse of their target on Newscasters, use this opportunity to try and figure out the identity of the victor so you may deal with them.
              ...
              <p>The second ritual allows us to know how large is the current cult presence in the sector: by taking blood from a living cultist and mixing it with some holy salts, this causes a reaction manifesting red and orange flames. Each red flame corresponds to a living cultist or construct aboard the station, while each orange flame corresponds to either one of them off station, or to a shade. A cultist can be kept alive and rendered mostly harmless by injecting them with a holy implant.
        ...
        <p>Revolutionaries are similar to cultists in that they infiltrate the station among the crew and will attempt to grow their numbers, except they appear able to do so at a much faster pace through use of hypnotic flash devices. Their goals are to eliminate or exile every head of staff, and assume control of the station for themselves. If you see people getting randomly flashed in the hallways (by non-security members), inform the authorities immediately.
        ...
        <p>The Vox Shoal's behaviour toward Nanotrasen has proven to be very random over the years. While many Vox have integrated into Nanotrasen's workforce, and many of our stations conduct direct business with the Shoal's traders, they still occasionally happen to send raiding parties to steal resources, items, or even personnel from our stations.
        <p>Their weapons primarily consist of non-lethal crossbows that inject chloral and sleep toxins, certainly a testament to their historical "Inviolate" principle in which they try not to take any lives, although it is unsure if they still respect it to this day. Regardless, they are dangerous and are to be apprehended.
        ...
        <p>The Spider Clan is an old enemy of Nanotrasen that seems to take offense for any reason, and uses those as excuses to send its ninjas to attack our space stations. They are highly mobile, armed with shuriken and plasma blades, and can blink around.
        <p>One of their frequent goals is to steal the station AI, so be sure to protect it at all costs. These things cost money, among other things.
...
<hr color=#F7D61A>
        ...
        <p>Feral Tajarans full of rabies and other diseases have been found sneaking onto our stations' shuttles, bringing not only their viruses, but most of all their bad luck. Remove them before they spread their bad mojo throughout the whole station, and quickly make a cure for the dangerous diseases they carry.
<hr color=#F7D61A>
...
<hr color=#F7D61A>
        ...
        <p>Every ship has its rats. Some are worse than others. These rodents spread their bacteria around them, infecting the food they nibble, the air you breathe, and generally causing a commotion at Medbay once people start producing ethanol in their own bodies.
<hr color=#F7D61A>

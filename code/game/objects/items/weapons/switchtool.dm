/obj/item/weapon/switchtool
	...
	var/list/obj/item/stored_modules = list("/obj/item/weapon/tool/screwdriver:screwdriver" = null,
											"/obj/item/weapon/tool/wrench:wrench" = null,
											"/obj/item/weapon/tool/wirecutters:wirecutters" = null,
											"/obj/item/weapon/tool/crowbar:crowbar" = null,
											"/obj/item/weapon/chisel:chisel" = null,
											"/obj/item/device/multitool:multitool" = null)
	var/obj/item/deployed //what's currently in use
	var/removing_item = /obj/item/weapon/tool/screwdriver //the type of item that lets you take tools out
...
/obj/item/weapon/switchtool/surgery
	...
	stored_modules = list("/obj/item/weapon/tool/scalpel:scalpel" = null,
						"/obj/item/weapon/tool/circular_saw:circular saw" = null,
						"/obj/item/weapon/tool/surgicaldrill:surgical drill" = null,
						"/obj/item/weapon/tool/cautery:cautery" = null,
						"/obj/item/weapon/tool/hemostat:hemostat" = null,
						"/obj/item/weapon/tool/retractor:retractor" = null,
						"/obj/item/weapon/tool/bonesetter:bone setter" = null,
						"/obj/item/weapon/tool/FixOVein:fixovein" = null,
						"/obj/item/weapon/tool/bonegel:bonegel"= null)

/obj/item/weapon/switchtool/surgery/undeploy(mob/user)
	playsound(src, undeploy_sound, 10, 1)
	edit_deploy(0)
	if(istype(deployed, /obj/item/weapon/tool/scalpel/laser))
		var/obj/item/weapon/tool/scalpel/laser/L = deployed
	...
	else if(istype(deployed, /obj/item/weapon/tool/retractor/manager))
		var/obj/item/weapon/tool/retractor/manager/M = deployed
		M.icon_state += "_off"
	deployed = null
	overlays.len = 0
	dynamic_overlay.len = 0
...
/obj/item/weapon/switchtool/swiss_army_knife
	...
	stored_modules = list("/obj/item/weapon/tool/screwdriver:screwdriver" = null,
						"/obj/item/weapon/tool/wrench:wrench" = null,
						"/obj/item/weapon/tool/wirecutters:wirecutters" = null,
						"/obj/item/weapon/tool/crowbar:crowbar" = null,
...
/obj/item/weapon/switchtool/holo
	...
	stored_modules = list(//scalpel and flashlight are available to start and the scalpel is logically a laser one but the basic kind.
						...
						"/obj/item/weapon/tool/scalpel/laser:basic laser scalpel" = null)
...
/obj/item/weapon/switchtool/holo/add_module(var/obj/item/D, mob/user)
	if(istype(D, /obj/item/weapon/disk/tech_disk))
		...
		if(istype(disk_tech, /datum/tech/biotech) && disk_tech.level >= 3)
			if(!(has_tech & BT))
				stored_modules["/obj/item/weapon/tool/circular_saw:circular saw"] = new /obj/item/weapon/tool/circular_saw(src)
				stored_modules["/obj/item/weapon/tool/surgicaldrill:surgical drill"] = new /obj/item/weapon/tool/surgicaldrill(src)
				stored_modules["/obj/item/weapon/tool/cautery/laser:basic laser cautery"] = new /obj/item/weapon/tool/cautery(src)
				stored_modules["/obj/item/weapon/tool/hemostat:hemostat"] = new /obj/item/weapon/tool/hemostat(src)
				stored_modules["/obj/item/weapon/tool/retractor:retractor"] = new /obj/item/weapon/tool/retractor(src)
				stored_modules["/obj/item/weapon/tool/bonesetter:bone setter"] = new /obj/item/weapon/tool/bonesetter(src)
		...
		if(istype(disk_tech, /datum/tech/engineering) && disk_tech.level >= 3)
			if(!(has_tech & ENGI))
				stored_modules["/obj/item/weapon/tool/screwdriver:screwdriver"] = new /obj/item/weapon/tool/screwdriver(src)
				stored_modules["/obj/item/weapon/tool/wrench:wrench"] = new /obj/item/weapon/tool/wrench(src)
				stored_modules["/obj/item/weapon/tool/wirecutters:wirecutters"] = new /obj/item/weapon/tool/wirecutters(src)
				stored_modules["/obj/item/weapon/tool/crowbar:crowbar"] = new /obj/item/weapon/tool/crowbar(src)
				stored_modules["/obj/item/device/multitool:multitool"] = new /obj/item/device/multitool(src)
				stored_modules["/obj/item/weapon/tool/weldingtool/experimental:experimental welding tool"] = new /obj/item/weapon/tool/weldingtool/experimental(src)
...
//It can be refulled manually, but since it starts active you will blow up welder tanks if deployed and then put to a tank.
	if(istype(deployed, /obj/item/weapon/tool/weldingtool/experimental))
		var/obj/item/weapon/tool/weldingtool/experimental/weldingtool = deployed
...
/obj/item/weapon/switchtool/holo/maxed
	stored_modules = list(
						...
						"/obj/item/weapon/tool/circular_saw:circular saw" = null,
						"/obj/item/weapon/tool/surgicaldrill:surgical drill" = null,
						"/obj/item/weapon/tool/cautery/laser:basic laser cautery" = null,
						"/obj/item/weapon/tool/hemostat:hemostat" = null,
						"/obj/item/weapon/tool/retractor:retractor" = null,
						"/obj/item/weapon/tool/bonesetter:bone setter" = null,
						"/obj/item/weapon/tool/screwdriver:screwdriver" = null,
						"/obj/item/weapon/tool/wrench:wrench" = null,
						"/obj/item/weapon/tool/wirecutters:wirecutters" = null,
						"/obj/item/weapon/tool/crowbar:crowbar" = null,
						"/obj/item/device/multitool:multitool" = null,
						"/obj/item/weapon/tool/weldingtool/experimental:experimental welding tool" = null,
...
/obj/item/weapon/switchtool/surgery/maxed
	stored_modules = list(
						"/obj/item/weapon/tool/scalpel/laser/tier2:scalpel" = null,
						"/obj/item/weapon/tool/circular_saw/plasmasaw:circular saw" = null,
						"/obj/item/weapon/tool/surgicaldrill/diamond:surgical drill" = null,
						"/obj/item/weapon/tool/cautery/laser/tier2:cautery" = null,
						"/obj/item/weapon/tool/hemostat/pico:hemostat" = null,
						"/obj/item/weapon/tool/retractor/manager:retractor" = null,
						"/obj/item/weapon/tool/bonesetter/bone_mender:bone setter" = null,
						"/obj/item/weapon/tool/FixOVein/clot:fixovein" = null,
						"/obj/item/weapon/tool/bonegel:bonegel" = null)
...
/obj/item/weapon/switchtool/engineering
	...
	stored_modules = list(
		"/obj/item/weapon/tool/crowbar:crowbar" = null,
		"/obj/item/weapon/tool/screwdriver:screwdriver" = null,
		"/obj/item/weapon/tool/weldingtool/hugetank:welding tool" = null,
		"/obj/item/weapon/tool/wirecutters:wirecutters" = null,
		"/obj/item/weapon/tool/wrench:wrench" = null,
		"/obj/item/device/multitool:multitool" = null,
		...
		"/obj/item/weapon/tool/solder/pre_fueled:soldering iron" = null,
...
/obj/item/weapon/switchtool/engineering/deploy(var/module,mob/user)
	...
	if(iswelder(deployed))
		var/obj/item/weapon/tool/weldingtool/W = deployed
		W.welding = 1
		W.status = 1
...
/obj/item/weapon/switchtool/engineering/mech
	stored_modules = list(
		"/obj/item/weapon/tool/crowbar:crowbar" = null,
		"/obj/item/weapon/tool/screwdriver:screwdriver" = null,
		"/obj/item/weapon/tool/weldingtool/hugetank/mech:welding tool" = null,
		"/obj/item/weapon/tool/wirecutters:wirecutters" = null,
		"/obj/item/weapon/tool/wrench:wrench" = null,
		"/obj/item/device/multitool:multitool" = null,
		"/obj/item/stack/cable_coil/persistent:cable coil" = null,

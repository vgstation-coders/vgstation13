...
/obj/item/retractor/suicide_act(mob/user)
...
/obj/item/retractor/manager/New()
	..()
...
/obj/item/hemostat/pico //Removes implanted things with 100% success as well.
...
/obj/item/hemostat/suicide_act(mob/user)
	to_chat(viewers(user), "<span class='danger'>[user] is pulling \his eyes out with the [src.name]! It looks like \he's  trying to commit suicide!</span>")
	return (SUICIDE_ACT_BRUTELOSS)
...
/obj/item/cautery/suicide_act(mob/user)
...
/*
/obj/item/cautery/laser/old //unused laser cautery. For the laser scalpel
	name = "laser cautery"
...
/obj/item/surgicaldrill/diamond
...
/obj/item/scalpel/laser
	...
	var/obj/item/cautery/laser/held

/obj/item/scalpel/laser/New()
	..()
	icon_state = "scalpel_laser1_off"
	held = new /obj/item/cautery/laser(src)


/obj/item/scalpel/laser/attack_self(mob/user)
	if(!cauterymode && held)
...
/obj/item/scalpel/laser/examine(mob/user)
	..()
	if(!cauterymode)
...
/obj/item/scalpel/laser/attackby(var/obj/item/used_item, mob/user)
	if(used_item.is_screwdriver(user) && cauterymode)
		if(held)
			...
			sharpness_flags = initial(sharpness_flags)
			cauterymode = 0
	else if(istype(used_item, /obj/item/cautery/laser))
		if(held)
...
/*
/obj/item/scalpel/laser/old //unused laser scalpel
	name = "laser scalpel"
...
/obj/item/scalpel/laser/old/New()
	..()
	icon_state = "scalpel_laser_old_off"
	held = new /obj/item/cautery/laser/old(src)
*/

/obj/item/scalpel/laser/tier2
...
/obj/item/scalpel/laser/tier2/New()
	..()
	icon_state = "scalpel_laser2_off"
	held = new /obj/item/cautery/laser/tier2(src)
...
/obj/item/circular_saw/suicide_act(mob/user)
...
/obj/item/bonegel/suicide_act(mob/user)
...
/obj/item/FixOVein/clot/attackby(var/obj/item/stack/W, mob/user)
...
/obj/item/revivalprod/attack(mob/target,mob/user)
	if(target.lying)

...
/obj/item/weapon/tool/retractor/suicide_act(mob/user)
...
/obj/item/weapon/tool/retractor/manager
...
/obj/item/weapon/tool/retractor/manager/New()
	..()
...
/obj/item/weapon/tool/hemostat/pico //Removes implanted things with 100% success as well.
...
/obj/item/weapon/tool/hemostat/suicide_act(mob/user)
	to_chat(viewers(user), "<span class='danger'>[user] is pulling \his eyes out with the [src.name]! It looks like \he's  trying to commit suicide!</span>")
	return (SUICIDE_ACT_BRUTELOSS)
...
/obj/item/weapon/tool/cautery/suicide_act(mob/user)
...
/obj/item/weapon/tool/cautery/laser
...
/*
/obj/item/weapon/tool/cautery/laser/old //unused laser cautery. For the laser scalpel
	name = "laser cautery"
...
/obj/item/weapon/tool/cautery/laser/tier2
...
/obj/item/weapon/tool/surgicaldrill/diamond
...
/obj/item/weapon/tool/surgicaldrill/suicide_act(mob/user)
...
/obj/item/weapon/tool/scalpel/suicide_act(mob/user)
...
/obj/item/weapon/tool/scalpel/laser
	...
	var/obj/item/weapon/tool/cautery/laser/held

/obj/item/weapon/tool/scalpel/laser/New()
	..()
	icon_state = "scalpel_laser1_off"
	held = new /obj/item/weapon/tool/cautery/laser(src)


/obj/item/weapon/tool/scalpel/laser/attack_self(mob/user)
	if(!cauterymode && held)
...
/obj/item/weapon/tool/scalpel/laser/examine(mob/user)
	..()
	if(!cauterymode)
...
/obj/item/weapon/tool/scalpel/laser/attackby(var/obj/item/used_item, mob/user)
	if(used_item.is_screwdriver(user) && cauterymode)
		if(held)
			...
			sharpness_flags = initial(sharpness_flags)
			cauterymode = 0
	else if(istype(used_item, /obj/item/weapon/tool/cautery/laser))
		if(held)
...
/*
/obj/item/weapon/tool/scalpel/laser/old //unused laser scalpel
	name = "laser scalpel"
...
/obj/item/weapon/tool/scalpel/laser/old/New()
	..()
	icon_state = "scalpel_laser_old_off"
	held = new /obj/item/weapon/tool/cautery/laser/old(src)
*/

/obj/item/weapon/tool/scalpel/laser/tier2
...
/obj/item/weapon/tool/scalpel/laser/tier2/New()
	..()
	icon_state = "scalpel_laser2_off"
	held = new /obj/item/weapon/tool/cautery/laser/tier2(src)
...
/obj/item/weapon/tool/circular_saw/plasmasaw //Orange transparent chainsaw!
	name = "plasma saw"
...
/obj/item/weapon/tool/circular_saw/suicide_act(mob/user)
...
/obj/item/weapon/tool/bonegel/suicide_act(mob/user)
...
/obj/item/weapon/tool/FixOVein/clot
...
/obj/item/weapon/tool/FixOVein/clot/examine(mob/user)
	..()
	to_chat(user, "<span class='notice'>\The [src] contains [foam] unit[foam > 1 ? "s" : ""][foam == 0 ? "s" : ""] of biofoam.</span>")

/obj/item/weapon/tool/FixOVein/clot/attack_self(mob/user)
	if(foam)
		if(!sharpness)
			sharpness= 0.5
...
/obj/item/weapon/tool/FixOVein/clot/attackby(var/obj/item/stack/W, mob/user)
...
/obj/item/weapon/tool/bonesetter/bone_mender
	name = "bone mender"

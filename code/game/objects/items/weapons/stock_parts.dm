...
/obj/item/stock_parts/console_screen/rped_rating()
...
/obj/item/stock_parts/capacitor/examine(mob/user)
	..()
	if(stored_charge)
...
/obj/item/stock_parts/capacitor/attackby(obj/item/W, mob/user)
	if(W.is_wrench(user))

...
/obj/effect/effect/smoke/bad/Cross(atom/movable/mover, turf/target = loc, height=1.5, air_group = 0)
...
/obj/structure/foamedmetal/Cross(atom/movable/mover, turf/target = loc, height=1.5, air_group = 0)

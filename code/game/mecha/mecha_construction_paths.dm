...
/datum/construction/reversible/mecha
	...
	var/mainboard = /obj/item/circuitboard/mecha/ripley/main
	var/peripherals = /obj/item/circuitboard/mecha/ripley/peripherals

	steps = list(
					//1
					list(Co_DESC="External armor is wrenched.",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/weldingtool,
					 		Co_AMOUNT = 3,
					 		Co_VIS_MSG = "{USER} weld{s} external armor layer to {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY=/obj/item/wrench,
					 		Co_VIS_MSG = "{USER} unfasten{s} the external armor layer.")
					 	),
					//2
					 list(Co_DESC="External armor is installed.",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/wrench,
					 ...
					 list(Co_DESC="The wiring is added",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/wirecutters,
...
/datum/construction/reversible/mecha/odysseus
	...
	mainboard = /obj/item/circuitboard/mecha/odysseus/main
	peripherals = /obj/item/circuitboard/mecha/odysseus/peripherals

/datum/construction/reversible/mecha/combat
	var/targeting = /obj/item/circuitboard/mecha/gygax/targeting
	...
	steps = list(
					...
					//2
					 ...
					 list(Co_DESC="Advanced scanner module is secured",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/stock_parts/capacitor/adv,
					 		Co_AMOUNT = 1,
					 ...
					 list(Co_DESC="Targeting module is secured",
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/stock_parts/scanning_module/adv,
					 		Co_AMOUNT = 1,
					 ...
					 list(Co_DESC="Targeting module is installed",
					 	...
					 	Co_BACKSTOP = list(Co_KEY=/obj/item/crowbar,
...
/datum/construction/reversible/mecha/combat/gygax
	base_icon = "gygax"
	mainboard = /obj/item/circuitboard/mecha/gygax/main
	peripherals = /obj/item/circuitboard/mecha/gygax/peripherals
	targeting = /obj/item/circuitboard/mecha/gygax/targeting
	armor_plates = /obj/item/mecha_parts/part/gygax_armour
	result = "/obj/mecha/combat/gygax"

/datum/construction/reversible/mecha/combat/durand
	mainboard = /obj/item/circuitboard/mecha/durand/main
	peripherals = /obj/item/circuitboard/mecha/durand/peripherals
	targeting = /obj/item/circuitboard/mecha/durand/targeting
	armor_plates = /obj/item/mecha_parts/part/durand_armour
	result = "/obj/mecha/combat/durand"
	base_icon = "durand"

/datum/construction/reversible/mecha/combat/marauder
	mainboard = /obj/item/circuitboard/mecha/marauder/main
	peripherals = /obj/item/circuitboard/mecha/marauder/peripherals
	targeting = /obj/item/circuitboard/mecha/marauder/targeting
...
/datum/construction/reversible/mecha/honker
	...
	steps = list(
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/bikehorn,
					 ...
					 list(
					 	...
					 	Co_BACKSTEP = list(Co_KEY = /obj/item/bikehorn)
					 	),//2
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/bikehorn),
					 	Co_BACKSTEP = list(Co_KEY = /obj/item/crowbar,
					 ...
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/circuitboard/mecha/honker/targeting,
					 		Co_AMOUNT = 1,
					 ...
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/circuitboard/mecha/honker/peripherals,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the peripherals control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY = /obj/item/bikehorn)
					 	),//8
					 ...
					 list(
					 	Co_NEXTSTEP = list(Co_KEY=/obj/item/circuitboard/mecha/honker/main,
					 		Co_AMOUNT = 1,
					 		Co_VIS_MSG = "{USER} install{s} the central control module into {HOLDER}."),
					 	Co_BACKSTEP = list(Co_KEY = /obj/item/bikehorn)
					 	),//10
...
/datum/construction/reversible/mecha/phazon
	base_icon = "phazon"
	mainboard = /obj/item/circuitboard/mecha/phazon/main
	peripherals = /obj/item/circuitboard/mecha/phazon/peripherals
...
/datum/construction/reversible/mecha/clarke
	...
	mainboard = /obj/item/circuitboard/mecha/clarke/main
	peripherals = /obj/item/circuitboard/mecha/clarke/peripherals

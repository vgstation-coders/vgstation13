/datum/outfit/striketeam/nukeops
    ...
    backpack_types = list(
		...
		SATCHEL_ALT_STRING = /obj/item/storage/backpack/satchel_sec,
    ...
    specs = list(
        ...
        "Ballistics" = list(
            ...
            slot_belt_str = /obj/item/gun/projectile/automatic/c20r,
            slot_in_backpack_str = list(
                /obj/item/ammo_storage/magazine/a12mm/ops = 2,
                /obj/item/gun/projectile/beretta = 1,
        ...
        "Energy" = list(
            ...
            slot_belt_str = /obj/item/gun/energy/laser,
            slot_in_backpack_str = list(
                /obj/item/gun/energy/ionrifle/ioncarbine = 1,
        ...
        "Demolition" = list(
            slot_glasses_str = /obj/item/clothing/glasses/sunglasses/prescription,
            slot_s_store_str = /obj/item/gun/projectile/rocketlauncher, //Only place we can store it, it will drop on the ground for plasmamen
            slot_belt_str = /obj/item/gun/grenadelauncher/syndicate,
            slot_in_backpack_str = list(
                /obj/item/ammo_casing/rocket_rpg = 3,
                /obj/item/storage/box/syndigrenades = 2
            ),
        ),
        ...
        "Melee" = list(
            slot_glasses_str = /obj/item/clothing/glasses/sunglasses/prescription,
            slot_belt_str = /obj/item/grenade/spawnergrenade/manhacks,
            slot_in_backpack_str = list(
                /obj/item/melee/energy/sword/dualsaber = 1,
                /obj/item/melee/energy/hfmachete = 1,
            ),
            slot_l_store_str = /obj/item/shield/energy,
        ...
        "Medical" = list(
            ...
            slot_belt_str = /obj/item/gun/syringe/rapidsyringe,
            slot_in_backpack_str = list(
                /obj/item/storage/box/syndisyringes = 1,
                /obj/item/storage/firstaid/adv = 1,
                /obj/item/reagent_containers/hypospray = 1,
                /obj/item/storage/pill_bottle/hyperzine = 1,
        ...
        "Engineering" = list(
            ...
            slot_s_store_str = /obj/item/gun/projectile/shotgun/pump/combat/shorty,
            slot_belt_str = /obj/item/storage/belt/utility/complete,
            slot_in_backpack_str = list(
                /obj/item/storage/box/lethalshells = 1,
        ...
        "Stealth" = list(
            ...
            slot_in_backpack_str = list(
                ...
                /obj/item/pen/paralysis = 1,
            ),
            slot_l_store_str =  /obj/item/gun/energy/crossbow,
        ),
        ...
        "Ship and Cameras" = list(
            ...
            slot_l_store_str = /obj/item/circuitboard/teleporter,
        ),
    ) // End of the specs.
    ...
    items_to_spawn = list(
        ...
        "Default" = list(
            ...
            slot_wear_id_str = /obj/item/card/id/syndicate,
        ),

...
/datum/outfit/scubadiver
	...
	items_to_spawn = list(
		"Default" = list(
			slot_ears_str = /obj/item/device/radio/headset,
			slot_w_uniform_str = /obj/item/clothing/under/color/grey,
			slot_shoes_str = /obj/item/clothing/shoes/scubafloppers,
			slot_wear_suit_str = /obj/item/clothing/suit/scuba,
			slot_wear_mask_str =  /obj/item/clothing/mask/gas/scubamask,
		),
		/datum/species/plasmaman/ = list(
			slot_ears_str = /obj/item/device/radio/headset,
			slot_w_uniform_str = /obj/item/clothing/under/color/grey,

...
/datum/outfit/chief_engineer
	...
	backpack_types = list(
		BACKPACK_STRING = /obj/item/storage/backpack/industrial,
		SATCHEL_NORM_STRING = /obj/item/storage/backpack/satchel_eng,
		SATCHEL_ALT_STRING = /obj/item/storage/backpack/satchel,
		MESSENGER_BAG_STRING = /obj/item/storage/backpack/messenger/engi,
	)
	items_to_spawn = list(
		"Default" = list(
			...
			slot_belt_str = /obj/item/storage/belt/utility/complete,
...
/datum/outfit/chief_engineer/pre_equip_priority(var/mob/living/carbon/human/H, var/species)
	items_to_collect[/obj/item/reagent_containers/food/snacks/cracker] = SURVIVAL_BOX //poly gets part of the divvy, savvy?
...
/datum/outfit/atmos
	...
	items_to_spawn = list(
		"Default" = list(
			...
			slot_shoes_str = /obj/item/clothing/shoes/workboots,
			slot_head_str = /obj/item/clothing/head/hardhat,
			slot_belt_str = /obj/item/storage/belt/utility/atmostech,
			slot_gloves_str = /obj/item/clothing/gloves/black,
		),
		/datum/species/plasmaman/ = list(
			slot_ears_str = /obj/item/device/radio/headset/headset_eng,

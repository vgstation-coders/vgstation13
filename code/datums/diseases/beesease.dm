...
/datum/disease/beesease/stage_act()
	...
	switch(stage)
		if(1)
			if(prob(2))
				affected_mob << "<span class=\"rose\">You feel like something is moving inside of you</span>"
		if(2) //also changes say, see say.dm
			if(prob(2))
				affected_mob << "<span class=\"rose\">You feel like something is moving inside of you</span>"
			if(prob(2))
				affected_mob << "<span class=\"rose\">BZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ</span>"
		if(3)

...
/datum/supply_packs/seclethal
	name = "Security Lethal gear crate"
	contains = list(/obj/item/weapon/melee/telebaton,
...
/datum/supply_packs/shotgun
	...
	cost = 50
	containertype = /obj/structure/closet/crate/secure
	containername = "Shotgun x1 crate"
	//access = access_armory //Easy cargo mode ON
	group = "Security"
...
/datum/supply_packs/randomised/markman
	name = "Military crate"
	num_contained = 1
	...
	cost = 40
	containertype = /obj/structure/closet/crate/secure
	containername = "Military crate x1 crate"
	//access = access_armory //Easy cargo mode ON
	group = "Security"

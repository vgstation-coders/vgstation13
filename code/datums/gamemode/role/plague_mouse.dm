...
/datum/role/plague_mouse/OnPostSetup()
	. = ..()
	if(!.)
		return

	var/datum/mind/mouse_mind = antag
	var/mob/living/simple_animal/mouse/mouse = mouse_mind.current
	mouse.universal_understand = 1

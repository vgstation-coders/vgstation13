...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_from_jobs = list("Security Officer", "Warden", "Head of Personnel", "AI", "Detective", "Head of Security", "Captain")
...
/datum/dynamic_ruleset/roundstart/changeling
	...
	protected_from_jobs = list("Security Officer", "Warden", "Head of Personnel", "Detective", "Head of Security", "Captain")

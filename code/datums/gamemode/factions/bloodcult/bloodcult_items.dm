...
/obj/item/weapon/friendly_pamphlet
	...
	fire_fuel = 1
	var/index = 1
	var/list/reasons = 	list("One: You'll never run out of blood! That's right, almost every creature needs blood to survive. Followers of the Geometer of BLOOD always have at least 5 blood bags handy.",

...
/datum/uplink_item/jobspecific/dangerous/caber //around 25 brute self damage and bleed if used without armor, generally crit if exploded against an unarmored victim
	name = "Ulapool Caber"

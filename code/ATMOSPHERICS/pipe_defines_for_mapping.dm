...
#define DEF_PIXELX_SUPPLY 2*(DEF_PIPELAYER_SUPPLY - PIPING_LAYER_DEFAULT) * PIPING_LAYER_P_X
#define DEF_PIXELY_SUPPLY 2*(DEF_PIPELAYER_SUPPLY - PIPING_LAYER_DEFAULT) * PIPING_LAYER_P_Y

#define DEF_PIPELAYER_SCRUBBERS 4
#define DEF_PIXELX_SCRUBBERS 2*(DEF_PIPELAYER_SCRUBBERS - PIPING_LAYER_DEFAULT) * PIPING_LAYER_P_X
#define DEF_PIXELY_SCRUBBERS 2*(DEF_PIPELAYER_SCRUBBERS - PIPING_LAYER_DEFAULT) * PIPING_LAYER_P_Y

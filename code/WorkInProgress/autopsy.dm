...
/obj/item/weapon/autopsy_scanner/verb/print_data()
	...
	if(timeofdeath)
		scan_data += "<b>Time of death:</b> [timestamp2text(timeofdeath, config.get_hour_start())]<br><br>"
	...
	for(var/wdata_idx in wdata)
		...
		scan_data += "Approximate time of wound infliction: [timestamp2text(age, config.get_hour_start())]<br>"

...
//		to_chat(world, "<span class='notice'>moles_covered: [moles_covered]</span>")
		...
		plasma_captured.adjust_gas(round(gas_covered.gas[GAS_PLASMA] * transfer_ratio))
...
//		to_chat(world, "lost [loss_ratio*100]% of held plasma")
		...
		//
		plasma_lost.adjust_gas(GAS_PLASMA, held_plasma.gas[GAS_PLASMA] * loss_ratio)
		//plasma_lost.update_values()
		held_plasma.adjust_gas(GAS_PLASMA, -held_plasma.gas[GAS_PLASMA] * loss_ratio)

...
/obj/spacepod/proc/add_cabin()
	...
	cabin_air.adjust_gas(GAS_OXYGEN, O2STANDARD*cabin_air.volume/(R_IDEAL_GAS_EQUATION*cabin_air.temperature), FALSE)
	cabin_air.adjust_gas(GAS_NITROGEN, N2STANDARD*cabin_air.volume/(R_IDEAL_GAS_EQUATION*cabin_air.temperature))
	return cabin_air

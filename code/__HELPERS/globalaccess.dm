...
/proc/readglobal(which)
	switch(which)
		...
		if("logged_sprayed_reagents")
			return global.logged_sprayed_reagents;
...
/proc/writeglobal(which, newval)
	switch(which)
		...
		if("logged_sprayed_reagents")
			global.logged_sprayed_reagents=newval;
		if("valid_random_food_types")

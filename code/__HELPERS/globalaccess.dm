...
/proc/readglobal(which)
	switch(which)
		...
		if("holidayeventchance")
			return global.holidayeventchance;
		if("event")
			return global.event;
		if("blobevent")

...
/proc/readglobal(which)
	switch(which)
		...
		if("mining_all_access")
			return global.mining_all_access;
		if("xenoarch_all_access")
			return global.xenoarch_all_access;
		if("spells")

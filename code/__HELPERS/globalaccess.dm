...
/proc/readglobal(which)
	switch(which)
		...
		if("holoMiniMaps")
			return global.holoMiniMaps;
		if("centcommMiniMaps")
			return global.centcommMiniMaps;
		if("extraMiniMaps")
			return global.extraMiniMaps;
		if("holomap_markers")
		...
		if("autoborg_silly_names")
			return global.autoborg_silly_names;
		if("panicfile")
		...
		if("SSemergency_shuttle")
			return global.SSemergency_shuttle;
		if("SSevent")
			return global.SSevent;
		if("events")
			return global.events;
		if("SSfast_machinery")
			return global.SSfast_machinery;
		if("fast_machines")
			return global.fast_machines;
		if("SSgarbage")
			return global.SSgarbage;
		if("SShtml_ui")
			return global.SShtml_ui;
		if("html_machines")
		...
		if("SSsun")
			return global.SSsun;
		if("SSsupply_shuttle")
			return global.SSsupply_shuttle;
		if("SSticker")
		...
		if("SSfinish")
			return global.SSfinish;
		if("SSgenetics")
			return global.SSgenetics;
		if("SSjob")
			return global.SSjob;
		if("SSmap")
			return global.SSmap;
		...
		if("SSmore_init")
			return global.SSmore_init;
		if("SSrust")
			return global.SSrust;
		if("SScreate_ticker")
			return global.SScreate_ticker;
		if("SSxenoarch")
		...
		if("machete_hit_sound")
			return global.machete_hit_sound;
		if("machete_throw_sound")
			return global.machete_throw_sound;
		if("machete_throw_hit_sound")
			return global.machete_throw_hit_sound;
		if("supply_shuttle")
		...
		if("station_holomaps")
			return global.station_holomaps;
		if("status_displays")
		...
		if("map_dimension_cache")
			return global.map_dimension_cache;
		...
		if("person_animation_viewers")
			return global.person_animation_viewers;
		if("item_animation_viewers")
			return global.item_animation_viewers;
		...
		if("movable_hearers")
			return global.movable_hearers;
		if("mob_hearers")
			return global.mob_hearers;
		...
		if("bad_gremlin_items")
			return global.bad_gremlin_items;
		...
		if("existing_dungeons")
			return global.existing_dungeons;
		if("dungeon_area")
			return global.dungeon_area;
		if("existing_vaults")
		...
		if("pillIcon2Name")
			return global.pillIcon2Name;
		if("special_fruits")
			return global.special_fruits;
		...
		if("falltempoverlays")
			return global.falltempoverlays;
		if("centcomm_store")
		...
		if("shop_prices")
			return global.shop_prices;
		if("circuitboards")
			return global.circuitboards;
		if("circuitboard_prices")
			return global.circuitboard_prices;
		if("clothing")
			return global.clothing;
		if("clothing_prices")
			return global.clothing_prices;
		if("hive_pylons")
			return global.hive_pylons;
		if("sc_safecode1")
...
/proc/writeglobal(which, newval)
	switch(which)
		...
		if("holoMiniMaps")
			global.holoMiniMaps=newval
		if("centcommMiniMaps")
			global.centcommMiniMaps=newval
		if("extraMiniMaps")
			global.extraMiniMaps=newval
		if("holomap_markers")
		...
		if("SSsun")
			global.SSsun=newval
		if("SSsupply_shuttle")
			global.SSsupply_shuttle=newval
		if("SSticker")
		...
		if("SSfinish")
			global.SSfinish=newval
		if("SSgenetics")
			global.SSgenetics=newval
		if("SSjob")
			global.SSjob=newval
		if("SSmap")
			global.SSmap=newval
		...
		if("SSmore_init")
			global.SSmore_init=newval
		if("SSrust")
			global.SSrust=newval
		if("SScreate_ticker")
			global.SScreate_ticker=newval
		if("SSxenoarch")
		...
		if("machete_hit_sound")
			global.machete_hit_sound=newval
		if("machete_throw_sound")
			global.machete_throw_sound=newval
		if("machete_throw_hit_sound")
			global.machete_throw_hit_sound=newval
		if("supply_shuttle")
			global.supply_shuttle=newval
		if("mechtoys")
			global.mechtoys=newval
		if("space_area")
			global.space_area=newval
		if("ignored_keys")
		...
		if("station_holomaps")
			global.station_holomaps=newval
		if("status_displays")
		...
		if("map_dimension_cache")
			global.map_dimension_cache=newval
		if("swapmaps_iconcache")
		...
		if("person_animation_viewers")
			global.person_animation_viewers=newval
		if("item_animation_viewers")
			global.item_animation_viewers=newval
		if("preferences_datums")
		...
		if("movable_hearers")
			global.movable_hearers=newval
		if("mob_hearers")
			global.mob_hearers=newval
		if("stationary_hearers")
		...
		if("bad_gremlin_items")
			global.bad_gremlin_items=newval
		if("crate_mimic_disguises")
		...
		if("existing_dungeons")
			global.existing_dungeons=newval
		if("dungeon_area")
			global.dungeon_area=newval
		if("existing_vaults")
		...
		if("pillIcon2Name")
			global.pillIcon2Name=newval
		if("special_fruits")
			global.special_fruits=newval
		if("valid_random_food_types")
		...
		if("falltempoverlays")
			global.falltempoverlays=newval
		if("centcomm_store")
		...
		if("shop_prices")
			global.shop_prices=newval
		if("circuitboards")
			global.circuitboards=newval
		if("circuitboard_prices")
			global.circuitboard_prices=newval
		if("clothing")
			global.clothing=newval
		if("clothing_prices")
			global.clothing_prices=newval
		if("hive_pylons")
			global.hive_pylons=newval
		if("sc_safecode1")

...
/obj/item/trash/bowl/attackby(obj/item/I,mob/user,params)
	if(istype(I,/obj/item/stack/sheet/metal))
		...
		S.use(1)
		var/obj/item/reagent_containers/glass/mortar/mortimer = new(get_turf(src))
...
/obj/item/reagent_containers/food/snacks/customizable/New(loc,ingredient)
	. = ..()
...
/obj/item/reagent_containers/food/snacks/customizable/sandwich/attackby(obj/item/I,mob/user)
	if(istype(I,/obj/item/reagent_containers/food/snacks/breadslice) && !addTop)
...
/obj/item/reagent_containers/food/snacks/customizable/cook/bread
	...
	slice_path = /obj/item/reagent_containers/food/snacks/customizable/slices/breadslice
	slices_num = 5
	storage_slots = 3

/obj/item/reagent_containers/food/snacks/customizable/slices/breadslice
	name = "slice"
...
/obj/item/reagent_containers/food/snacks/customizable/cook/cake
	...
	slice_path = /obj/item/reagent_containers/food/snacks/customizable/slices/cakeslicecustom
	slices_num = 5
	storage_slots = 3

/obj/item/reagent_containers/food/snacks/customizable/slices/cakeslicecustom
	name = "slice"
...
/obj/item/reagent_containers/food/drinks/bottle/customizable
	volume = 100
	gulp_size = 2
	var/list/ingredients = list()
	var/initReagent
...
/obj/item/reagent_containers/food/drinks/bottle/customizable/attackby(obj/item/I,mob/user)
...
/obj/item/reagent_containers/food/drinks/bottle/customizable/proc/updateName() //copypaste of food's updateName()
	var/i = 1
	var/new_name
	for(var/obj/item/reagent_containers/food/snacks/S in src.ingredients)
		if(i == 1)
			new_name += "[S.name]"
		else if(i == src.ingredients.len)
			new_name += " and [S.name]"
...
/obj/item/reagent_containers/food/drinks/bottle/customizable/proc/generateFilling(var/obj/item/reagent_containers/food/snacks/S)
	src.overlays.len = 0
	var/image/I = filling
...
/obj/item/reagent_containers/food/drinks/bottle/customizable/degreaser

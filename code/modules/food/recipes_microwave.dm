...
/datum/recipe/plainburger
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/meat/animal)
	result = /obj/item/reagent_containers/food/snacks/monkeyburger

/datum/recipe/appendixburger
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/organ)
...
/datum/recipe/syntiburger
	...
	result = /obj/item/reagent_containers/food/snacks/monkeyburger/synth
...
/datum/recipe/donutburger
	items = list(
		/obj/item/reagent_containers/food/snacks/meat/animal,
		/obj/item/reagent_containers/food/snacks/donut/normal,
		/obj/item/reagent_containers/food/snacks/donut/normal
		)
	result = /obj/item/reagent_containers/food/snacks/donutburger

/datum/recipe/assburger
	reagents = list(FLOUR = 5)
	items = list(/obj/item/clothing/head/butt)
	result = /obj/item/reagent_containers/food/snacks/assburger
...
/datum/recipe/gelatinburger
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/meat/slime)
	result = /obj/item/reagent_containers/food/snacks/jellyburger/gelatin

/datum/recipe/gelatinburger/alt
//Uses gelatin from cooking.
	items = list(/obj/item/reagent_containers/food/snacks/gelatin)

/datum/recipe/veggieburger
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/meat/diona)
	result = /obj/item/reagent_containers/food/snacks/veggieburger

/datum/recipe/avocadoburger
	reagents = list(FLOUR = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/grown/avocado/cut/pitted,
		/obj/item/reagent_containers/food/snacks/meat,
		)
	result = /obj/item/reagent_containers/food/snacks/avocadoburger

/datum/recipe/caramelburger
	reagents = list(FLOUR = 5, CARAMEL = 5)
	items = list(/obj/item/reagent_containers/food/snacks/meat)
	result = /obj/item/reagent_containers/food/snacks/caramelburger
...
/datum/recipe/sliders
	...
	result = /obj/item/storage/fancy/food_box/slider_box
...
/datum/recipe/sliders/synth
	...
	result = /obj/item/storage/fancy/food_box/slider_box/synth
...
/datum/recipe/sliders/xeno
	...
	result = /obj/item/storage/fancy/food_box/slider_box/xeno

/datum/recipe/sliders/chicken
	items = list(
		/obj/item/reagent_containers/food/snacks/meat/rawchicken,
		/obj/item/reagent_containers/food/snacks/meat/rawchicken
		)
	result = /obj/item/storage/fancy/food_box/slider_box/chicken
...
/datum/recipe/sliders/spider
	...
	result = /obj/item/storage/fancy/food_box/slider_box/spider
...
/datum/recipe/sliders/clown
	...
	result = /obj/item/storage/fancy/food_box/slider_box/clown
...
/datum/recipe/sliders/mime
	...
	result = /obj/item/storage/fancy/food_box/slider_box/mime
...
/datum/recipe/sliders/slippery
	...
	result = /obj/item/storage/fancy/food_box/slider_box/slippery
...
/datum/recipe/valentinebar
	...
	result = /obj/item/reagent_containers/food/snacks/chocolatebar/wrapped/valentine
...
/datum/recipe/human/burger
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/meat/human)
	result = /obj/item/reagent_containers/food/snacks/human
...
/datum/recipe/eclair
	...
	result = /obj/item/reagent_containers/food/snacks/eclair
...
/datum/recipe/eclair_big
	...
	result = /obj/item/reagent_containers/food/snacks/eclair/big
...
/datum/recipe/caramelcookie
	reagents = list(FLOUR = 5, CARAMEL = 5)
	items = list(/obj/item/reagent_containers/food/snacks/egg)
	result = /obj/item/reagent_containers/food/snacks/caramelcookie

/datum/recipe/gingerbread_man
	reagents = list(FLOUR = 5, SUGAR = 5, WATER = 5)
	items = list(/obj/item/reagent_containers/food/snacks/egg)
	result = /obj/item/reagent_containers/food/snacks/gingerbread_man
...
/datum/recipe/candy_cane
	...
	items = list(/obj/item/reagent_containers/food/snacks/egg)
	result = /obj/item/reagent_containers/food/snacks/candy_cane
...
/datum/recipe/dindumuffin
	...
	items = list(/obj/item/handcuffs)
	result = /obj/item/reagent_containers/food/snacks/muffin/dindumuffin
...
/datum/recipe/nova_bread
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/bread/nova
...
/datum/recipe/syntibread
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/meatbread/synth
...
/datum/recipe/eucharist
	...
	result = /obj/item/reagent_containers/food/snacks/eucharist
...
/datum/recipe/berryclafoutis
	reagents = list(FLOUR = 10)
	items = list(/obj/item/reagent_containers/food/snacks/grown/berries)
...
/datum/recipe/eggplantsushi
	...
	items = list(/obj/item/reagent_containers/food/snacks/grown/eggplant,
				/obj/item/reagent_containers/food/snacks/grown/chili
				)
	result = /obj/item/reagent_containers/food/snacks/eggplantsushi
...
/datum/recipe/syntisteak
	reagents = list(SODIUMCHLORIDE = 1, BLACKPEPPER = 1)
	items = list(/obj/item/reagent_containers/food/snacks/meat/syntiflesh)
	result = /obj/item/reagent_containers/food/snacks/meatsteak/synth
...
/datum/recipe/caramelcake
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/caramelcake
...
/datum/recipe/fruitcake
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/fruitcake
...
/datum/recipe/christmascake
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/fruitcake/christmascake

// Pies ////////////////////////////////////////////////////////

/datum/recipe/pie
	reagents = list(FLOUR = 10)
	items = list(/obj/item/reagent_containers/food/snacks/grown/banana)
...
/datum/recipe/cherrypie
	reagents = list(FLOUR = 10)
	items = list(/obj/item/reagent_containers/food/snacks/grown/cherries)
	result = /obj/item/reagent_containers/food/snacks/pie/cherrypie

/datum/recipe/amanita_pie
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/grown/mushroom/amanita)
...
/datum/recipe/nofruitpie
	reagents = list(FLOUR = 10)
	items = list(/obj/item/reagent_containers/food/snacks/grown/nofruit)
	result = /obj/item/reagent_containers/food/snacks/pie/nofruitpie
...
/datum/recipe/mincepie
	...
	result = /obj/item/reagent_containers/food/snacks/pie/mincepie

/datum/recipe/caramelpie
	reagents = list(FLOUR = 10, CARAMEL = 10)
	items = list()
	result = /obj/item/reagent_containers/food/snacks/pie/caramelpie
...
/datum/recipe/syntikabob
	...
	result = /obj/item/reagent_containers/food/snacks/monkeykabob/synth
...
/datum/recipe/corgikabob
	items = list(
		/obj/item/stack/rods,
		/obj/item/reagent_containers/food/snacks/meat/animal/corgi,
		/obj/item/reagent_containers/food/snacks/meat/animal/corgi,
		)
	result = /obj/item/reagent_containers/food/snacks/corgikabob
...
/datum/recipe/syntipizza
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/pizza/meatpizza/synth
...
/datum/recipe/monkeysoup
	...
	result = /obj/item/reagent_containers/food/snacks/monkeysoup
...
/datum/recipe/mushroomsoup
	...
	items = list(/obj/item/reagent_containers/food/snacks/grown/mushroom/chanterelle)
...
/datum/recipe/primordialsoup
	...
	result = /obj/item/reagent_containers/food/snacks/primordialsoup
...
/datum/recipe/avocadosoup
	...
	result = /obj/item/reagent_containers/food/snacks/avocadosoup
...
/datum/recipe/toastedsandwich
	items = list(/obj/item/reagent_containers/food/snacks/sandwich)
...
/datum/recipe/slimetoast
	...
	items = list(/obj/item/reagent_containers/food/snacks/breadslice)
...
/datum/recipe/avocadotoast
	...
	result = /obj/item/reagent_containers/food/snacks/avocadotoast
...
/datum/recipe/pbj
	...
	result = /obj/item/reagent_containers/food/snacks/pbj
...
/datum/recipe/mommispaghetti // Same as roburger, but for mommis
	...
	result = /obj/item/reagent_containers/food/snacks/mommispaghetti
...
/datum/recipe/crabspaghetti
	...
	items = list(
		/obj/item/reagent_containers/food/snacks/spaghetti,
		/obj/item/reagent_containers/food/snacks/meat/crabmeat,
		/obj/item/reagent_containers/food/snacks/meat/crabmeat,
		)
	result = /obj/item/reagent_containers/food/snacks/crabspaghetti
...
/datum/recipe/coldnoodles
	...
	result = /obj/item/reagent_containers/food/snacks/spicycoldnoodles
...
/datum/recipe/herbsalad/make_food(var/obj/container)
	var/obj/item/reagent_containers/food/snacks/herbsalad/being_cooked = ..(container)
	being_cooked.reagents.del_reagent(TOXIN)
	return being_cooked

/datum/recipe/aesirsalad
	items = list(
		/obj/item/reagent_containers/food/snacks/grown/ambrosiavulgaris/deus,
		/obj/item/reagent_containers/food/snacks/grown/ambrosiavulgaris/deus,
		/obj/item/reagent_containers/food/snacks/grown/ambrosiavulgaris/deus,
		/obj/item/reagent_containers/food/snacks/grown/goldapple,
		)
...
/datum/recipe/midnightsnack
	...
	result = /obj/item/reagent_containers/food/snacks/midnightsnack
...
/datum/recipe/starrynight
	...
	result = /obj/item/reagent_containers/food/snacks/starrynightsalad
...
/datum/recipe/chinesecoldsalad
	...
	result = /obj/item/reagent_containers/food/snacks/chinesecoldsalad
...
/datum/recipe/confederatespirit
	...
	result = /obj/item/reagent_containers/food/snacks/confederatespirit
...
/datum/recipe/nofruitsalad
	...
	result = /obj/item/reagent_containers/food/snacks/nofruitsalad
...
/datum/recipe/chickensalad
	...
	result = /obj/item/reagent_containers/food/snacks/chickensalad
...
/datum/recipe/grapesalad
	...
	result = /obj/item/reagent_containers/food/snacks/grapesalad
...
/datum/recipe/orzosalad
	...
	result = /obj/item/reagent_containers/food/snacks/orzosalad
...
/datum/recipe/mexicansalad
	...
	result = /obj/item/reagent_containers/food/snacks/mexicansalad
...
/datum/recipe/curry
	...
	result = /obj/item/reagent_containers/food/snacks/curry
...
/datum/recipe/crabcurry
	...
	result = /obj/item/reagent_containers/food/snacks/curry/crab
...
/datum/recipe/vindaloo
	...
	result = /obj/item/reagent_containers/food/snacks/curry/vindaloo
...
/datum/recipe/lemoncurry
	...
	result = /obj/item/reagent_containers/food/snacks/curry/lemon
...
/datum/recipe/xenocurry
	...
	result = /obj/item/reagent_containers/food/snacks/curry/xeno
...
/datum/recipe/chips
	...
	result = /obj/item/reagent_containers/food/snacks/chips/cookable

/datum/recipe/vinegarchips
	reagents = list (SODIUMCHLORIDE = 2, VINEGAR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/grown/potato)
	result = /obj/item/reagent_containers/food/snacks/chips/cookable/vinegar
...
/datum/recipe/cheddarchips
	...
	result = /obj/item/reagent_containers/food/snacks/chips/cookable/cheddar

/datum/recipe/clownchips
	reagents = list (BANANA = 20)
	items = list(/obj/item/reagent_containers/food/snacks/grown/potato)
	result = /obj/item/reagent_containers/food/snacks/chips/cookable/clown

/datum/recipe/nuclearchips
	reagents = list (URANIUM = 10, SODIUMCHLORIDE = 2)
	items = list(/obj/item/reagent_containers/food/snacks/grown/potato)
	result = /obj/item/reagent_containers/food/snacks/chips/cookable/nuclear

/datum/recipe/commiechips
	reagents = list (SODIUMCHLORIDE = 2, VODKA = 10)
	items = list(/obj/item/reagent_containers/food/snacks/grown/potato)
	result = /obj/item/reagent_containers/food/snacks/chips/cookable/communist
...
/datum/recipe/xenochips
	...
	result = /obj/item/reagent_containers/food/snacks/chips/cookable/xeno

/datum/recipe/tortillachips
	reagents = list (FLOUR = 20, CORNOIL = 10, SODIUMCHLORIDE = 10)
	result = /obj/item/chipbasket
...
/datum/recipe/queso
	...
	result = /obj/item/reagent_containers/food/dipping_sauce/queso
...
/datum/recipe/guacamole
	...
	result = /obj/item/reagent_containers/food/dipping_sauce/guacamole
...
/datum/recipe/salsa
	...
	result = /obj/item/reagent_containers/food/dipping_sauce/salsa
...
/datum/recipe/hummus
	...
	result = /obj/item/reagent_containers/food/dipping_sauce/hummus
...
/datum/recipe/caramel
	...
	items = list()
	result = /obj/item/reagent_containers/food/condiment/caramel

/datum/recipe/chiliconcarne
	items = list(/obj/item/reagent_containers/food/snacks/grown/koibeans,
				/obj/item/reagent_containers/food/snacks/grown/tomato,
				/obj/item/reagent_containers/food/snacks/grown/chili,
				/obj/item/reagent_containers/food/snacks/meat)
	result = /obj/item/reagent_containers/food/snacks/chiliconcarne

/datum/recipe/chilaquiles
	items = list(/obj/item/reagent_containers/food/snacks/tortillachip,
				/obj/item/reagent_containers/food/snacks/tortillachip,
				/obj/item/reagent_containers/food/snacks/tortillachip,
				/obj/item/reagent_containers/food/snacks/tortillachip,
				/obj/item/reagent_containers/food/snacks/cheesewedge,
				/obj/item/reagent_containers/food/snacks/grown/koibeans,
				/obj/item/reagent_containers/food/dipping_sauce/salsa)
	result = /obj/item/reagent_containers/food/snacks/chilaquiles

/datum/recipe/quiche
	items = list(/obj/item/reagent_containers/food/snacks/grown/bluetomato,
				/obj/item/reagent_containers/food/snacks/grown/garlic,
				/obj/item/reagent_containers/food/snacks/egg,
				/obj/item/reagent_containers/food/snacks/cheesewedge)
...
/datum/recipe/minestrone
	...
	items = list(/obj/item/reagent_containers/food/snacks/grown/koibeans,
				/obj/item/reagent_containers/food/snacks/grown/carrot,
				/obj/item/reagent_containers/food/snacks/spaghetti)
	result = /obj/item/reagent_containers/food/snacks/minestrone

/datum/recipe/gazpacho
	reagents = list(VINEGAR = 10, SODIUMCHLORIDE = 2)
	items = list(/obj/item/reagent_containers/food/snacks/grown/garlic,
				/obj/item/reagent_containers/food/snacks/grown/bluetomato)
	result = /obj/item/reagent_containers/food/snacks/gazpacho

/datum/recipe/bruschetta
	reagents = list(SODIUMCHLORIDE = 2, FLOUR = 10)
	items = list(/obj/item/reagent_containers/food/snacks/grown/tomato,
				/obj/item/reagent_containers/food/snacks/grown/garlic,
				/obj/item/reagent_containers/food/snacks/cheesewedge)
...
/datum/recipe/pannacotta
	...
	items = list(/obj/item/reagent_containers/food/snacks/grown/grapes,
				/obj/item/reagent_containers/food/snacks/gelatin,
				/obj/item/reagent_containers/food/snacks/yogurt
				)
	result = /obj/item/reagent_containers/food/snacks/pannacotta

/datum/recipe/pannacotta/alt
//Uses gelatin from butchered slime people
	items = list(/obj/item/reagent_containers/food/snacks/grown/grapes,
				/obj/item/reagent_containers/food/snacks/meat/slime,
				/obj/item/reagent_containers/food/snacks/yogurt
				)

/datum/recipe/yogurt
	reagents = list(CREAM = 10, VIRUSFOOD = 5)
	items = list(/obj/item/reagent_containers/food/snacks/grown/greengrapes)
	result = /obj/item/reagent_containers/food/snacks/yogurt

/datum/recipe/gelatin
	reagents = list(WATER = 10)
	items = list(/obj/item/stack/teeth)
	result = /obj/item/reagent_containers/food/snacks/gelatin

/datum/recipe/jectie
	reagents = list(CHERRYJELLY = 5, SUGAR = 10)
	result = /obj/item/reagent_containers/food/snacks/jectie

/datum/recipe/ramen
	reagents = list(FLOUR = 5)
	items = list(/obj/item/stack/sheet/cardboard)
	result = /obj/item/reagent_containers/food/drinks/dry_ramen

/datum/recipe/sundaeramen
	reagents = list(DRY_RAMEN = 30, SPRINKLES = 1, BLACKCOLOR = 1, BUSTANUT = 6)
	items = list(/obj/item/reagent_containers/food/snacks/chocolatebar,/obj/item/reagent_containers/food/snacks/grown/banana)
	result = /obj/item/reagent_containers/food/snacks/sundaeramen

/datum/recipe/sweetsundaeramen
	items = list(/obj/item/reagent_containers/food/snacks/sundaeramen,/obj/item/reagent_containers/food/snacks/ricepudding,/obj/item/reagent_containers/food/snacks/gigapuddi,/obj/item/reagent_containers/food/snacks/donkpocket)
	result = /obj/item/reagent_containers/food/snacks/sweetsundaeramen
...
/datum/recipe/boiledspiderleg
	reagents = list(WATER = 10)
	items = list(/obj/item/reagent_containers/food/snacks/meat/spiderleg)
...
/datum/recipe/fishburger
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/meat/carpmeat)
...
/datum/recipe/fishtacosupreme
	...
	result = /obj/item/reagent_containers/food/snacks/fishtacosupreme
...
/datum/recipe/bleachkipper
	...
	result = /obj/item/reagent_containers/food/snacks/bleachkipper
...
/datum/recipe/poissoncru
	...
	result = /obj/item/reagent_containers/food/snacks/poissoncru
...
/datum/recipe/sliders/carp
	...
	result = /obj/item/storage/fancy/food_box/slider_box/carp

/datum/recipe/sliders/carp/make_food(var/obj/container)
	var/obj/item/reagent_containers/food/snacks/meat/carpmeat/C = locate() in container
	if(C.poisonsacs)
		result = /obj/item/storage/fancy/food_box/slider_box/toxiccarp
	..()
...
/datum/recipe/chicken_nuggets
	...
	result = /obj/item/reagent_containers/food/snacks/chicken_nuggets
...
/datum/recipe/chicken_drumsticks
	...
	result = /obj/item/storage/fancy/food_box/chicken_bucket

/datum/recipe/chicken_fillet
	reagents = list(CORNOIL = 3)
	items = list(/obj/item/reagent_containers/food/snacks/meat/rawchicken)
	result = /obj/item/reagent_containers/food/snacks/chicken_fillet

/datum/recipe/crab_sticks
	reagents = list(SODIUMCHLORIDE = 1, SUGAR = 1)
	items = list(/obj/item/reagent_containers/food/snacks/meat/crabmeat)
	result = /obj/item/reagent_containers/food/snacks/crab_sticks

/datum/recipe/crabcake
	reagents = list(FLOUR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/meat/crabmeat)
	result = /obj/item/reagent_containers/food/snacks/crabcake

/datum/recipe/honeycitruschicken
	reagents = list(SOYSAUCE = 5, HONEY = 10)
	items = list(/obj/item/reagent_containers/food/snacks/meat/rawchicken,
			/obj/item/reagent_containers/food/snacks/grown/orange)
	result = /obj/item/reagent_containers/food/snacks/honeycitruschicken
...
/datum/recipe/flan
	...
	result = /obj/item/reagent_containers/food/snacks/flan
...
/datum/recipe/honeyflan
	...
	result = /obj/item/reagent_containers/food/snacks/honeyflan
...
/datum/recipe/bluespace
	...
	result = /obj/item/reagent_containers/food/snacks/muffin/bluespace
...
/datum/recipe/yellowcake
	...
	result = /obj/item/reagent_containers/food/snacks/yellowcake

/datum/recipe/yellowcupcake
	reagents = list(URANIUM = 2, RADIUM = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/egg)
	result = /obj/item/reagent_containers/food/snacks/yellowcupcake
...
/datum/recipe/cookiebowl
	...
	result = /obj/item/reagent_containers/food/snacks/cookiebowl
...
/datum/recipe/chococherrycake
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/chococherrycake
...
/datum/recipe/pumpkinbread
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/pumpkinbread
...
/datum/recipe/cornydog
	items = list(
		...
		/obj/item/reagent_containers/food/snacks/meat/animal/corgi,
		/obj/item/stack/rods)
	result = /obj/item/reagent_containers/food/snacks/cornydog
...
/datum/recipe/higashikata
	...
	result = /obj/item/reagent_containers/food/snacks/higashikata
...
/datum/recipe/icecreamsandwich
	items = list(/obj/item/reagent_containers/food/snacks/icecream,/obj/item/reagent_containers/food/snacks/chocolatebar)
...
/datum/recipe/avocadomilkshake
	...
	result = /obj/item/reagent_containers/food/snacks/avocadomilkshake
...
/datum/recipe/potatosalad
	...
	result = /obj/item/reagent_containers/food/snacks/potatosalad
...
/datum/recipe/coleslaw
	...
	result = /obj/item/reagent_containers/food/snacks/coleslaw
...
/datum/recipe/potentham
	...
	items = list(
		...
		/obj/item/reagent_containers/food/snacks/meat/box,
		/obj/item/aiModule/core/asimov,
		/obj/item/robot_parts/head,
		/obj/item/handcuffs

		)
	result = /obj/item/reagent_containers/food/snacks/potentham
...
/datum/recipe/cinnamonpie
	...
	result = /obj/item/reagent_containers/food/snacks/cinnamonpie

/datum/recipe/ijzerkoekje
	reagents = list(FLOUR = 30, IRON = 30)
	result = /obj/item/reagent_containers/food/snacks/ijzerkoekje_helper_dummy

/obj/item/reagent_containers/food/snacks/ijzerkoekje_helper_dummy
	name = "Helper Dummy"
	desc = "You should never see this text."

/obj/item/reagent_containers/food/snacks/ijzerkoekje_helper_dummy/New()
	for(var/i = 1 to 6)
		new /obj/item/reagent_containers/food/snacks/ijzerkoekje(get_turf(src))
	qdel(src)
...
/datum/recipe/pimiento
	...
	result = /obj/item/reagent_containers/food/snacks/pimiento
...
/datum/recipe/burrito
	...
	result = /obj/item/reagent_containers/food/snacks/threebeanburrito

/datum/recipe/hauntedjam
	reagents = list(SUGAR = 5, VINEGAR = 5)
	items = list(
		/obj/item/reagent_containers/food/snacks/grown/ghostpepper,
		/obj/item/reagent_containers/food/snacks/grown/ghostpepper,
		/obj/item/reagent_containers/food/snacks/grown/ghostpepper
	)
	result = /obj/item/reagent_containers/food/snacks/hauntedjam

///Vox Food///
/datum/recipe/gravyboat
	reagents = list(WATER = 10)
	items = list(
		/obj/item/reagent_containers/food/snacks/grown/mushroom/chickenshroom
		)
	result = /obj/item/reagent_containers/food/condiment/gravy
...
/datum/recipe/gravybig
	...
	result = /obj/item/reagent_containers/food/condiment/gravy/gravybig
...
/datum/recipe/sundayroast
	...
	result = /obj/item/reagent_containers/food/snacks/sundayroast

/datum/recipe/risenshiny
	reagents = list(FLOUR = 10, GRAVY = 5)
	result = /obj/item/reagent_containers/food/snacks/risenshiny
...
/datum/recipe/mushnslush
	...
	result = /obj/item/reagent_containers/food/snacks/mushnslush

/datum/recipe/breadfruitpie
	reagents = list(FLOUR = 10)
	items = list(
		/obj/item/reagent_containers/food/snacks/grown/breadfruit
		)
	result = /obj/item/reagent_containers/food/snacks/pie/breadfruit

/datum/recipe/woodapplejam
	reagents = list(SUGAR = 20)
	items = list(
		/obj/item/reagent_containers/food/snacks/grown/woodapple
		)
	result = /obj/item/reagent_containers/food/snacks/woodapplejam
...
/datum/recipe/candiedwoodapple
	...
	result = /obj/item/reagent_containers/food/snacks/candiedwoodapple
...
/datum/recipe/voxstew
	...
	result = /obj/item/reagent_containers/food/snacks/voxstew
...
/datum/recipe/flammkuche
	...
	result = /obj/item/reagent_containers/food/snacks/flammkuchen

/datum/recipe/welcomepie
	reagents = list(FLOUR = 10)
	items = list(
		/obj/item/reagent_containers/food/snacks/grown/pitcher
		)
	result = /obj/item/reagent_containers/food/snacks/pie/welcomepie
...
/datum/recipe/zhulongcaofan
	...
	result = /obj/item/reagent_containers/food/snacks/zhulongcaofan

/datum/recipe/zhulongcaofan/make_food(var/obj/container as obj)
	for(var/obj/item/reagent_containers/food/snacks/grown/pitcher/P in container)
		P.reagents.del_reagent(SACID) //This cleanses the plant.
	return ..()

/datum/recipe/bacon
	items = list(/obj/item/reagent_containers/food/snacks/meat/box)
...
/datum/recipe/porktenderloin
	...
	result = /obj/item/reagent_containers/food/snacks/porktenderloin
...
/datum/recipe/sweetandsourpork
	...
	result = /obj/item/reagent_containers/food/snacks/sweetandsourpork
...
/datum/recipe/hoboburger
	...
	result = /obj/item/reagent_containers/food/snacks/hoboburger
...
/datum/recipe/reclaimed
	...
	result = /obj/item/reagent_containers/food/snacks/reclaimed

/datum/recipe/bruisepack
	items = list(/obj/item/reagent_containers/food/snacks/grown/aloe)
...
/datum/recipe/poachedaloe
	reagents = list(WATER = 5)
	items = list(/obj/item/reagent_containers/food/snacks/grown/aloe)
	result = /obj/item/reagent_containers/food/snacks/poachedaloe
...
/datum/recipe/vanishingstew
	...
	result = /obj/item/reagent_containers/food/snacks/vanishingstew
...
/datum/recipe/poutinedangerous
	...
	result = /obj/item/reagent_containers/food/snacks/poutinedangerous
...
/datum/recipe/poutinebarrel
	...
	result = /obj/item/reagent_containers/food/snacks/poutinebarrel
...
/datum/recipe/mapleleaf
	...
	result = /obj/item/reagent_containers/food/snacks/mapleleaf
...
/datum/recipe/poutinesyrup
	...
	result = /obj/item/reagent_containers/food/snacks/poutinesyrup
...
/datum/recipe/mud_pie
	...
	result = /obj/item/reagent_containers/food/snacks/pie/mudpie
...
/datum/recipe/salmonsteak
	reagents = list(SODIUMCHLORIDE = 1, BLACKPEPPER = 1)
	items = list(/obj/item/reagent_containers/food/snacks/salmonmeat)

	result = /obj/item/reagent_containers/food/snacks/salmonsteak

/datum/recipe/boiled_shrimp
	reagents = list(WATER = 5)
	items = list(/obj/item/reagent_containers/food/snacks/shrimp)

	result = /obj/item/reagent_containers/food/snacks/boiled_shrimp

/datum/recipe/sushi_Ebi
	items = list(/obj/item/reagent_containers/food/snacks/boiled_shrimp,
	/obj/item/reagent_containers/food/snacks/boiledrice
	)

	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Ebi
...
/datum/recipe/sushi_Ikura
	...
	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Ikura
...
/datum/recipe/sushi_Sake     // 100000 TIMES FOLDED SUSHI CAN CUT THROUGH DIAMONDS
	...
	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Sake

/datum/recipe/sushi_SmokedSalmon
	items = list(/obj/item/reagent_containers/food/snacks/salmonsteak,
	/obj/item/reagent_containers/food/snacks/boiledrice
	)

	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_SmokedSalmon // this shit sounds fucking delicous IRL

/datum/recipe/sushi_Tamago
	reagents = list(SAKE = 5)
	items = list(/obj/item/reagent_containers/food/snacks/boiledrice,
	/obj/item/reagent_containers/food/snacks/egg
	)

	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Tamago
...
/datum/recipe/sushi_Inari
	...
	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Inari
...
/datum/recipe/sushi_Masago
	...
	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Masago
...
/datum/recipe/sushi_Tobiko
	...
	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Tobiko

/datum/recipe/sushi_TobikoEgg
	items = list(/obj/item/reagent_containers/food/snacks/sushi/sushi_Tobiko,
	/obj/item/reagent_containers/food/snacks/egg
	)
...
/datum/recipe/sushi_Tai
	items = list(/obj/item/reagent_containers/food/snacks/catfishmeat,
	/obj/item/reagent_containers/food/snacks/boiledrice)

	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Tai
...
/datum/recipe/sushi_Unagi
	...
	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_Unagi
...
/datum/recipe/sushi_avocado
	...
	result = /obj/item/reagent_containers/food/snacks/multispawner/sushi_avocado
...
/datum/recipe/friedshrimp
	...
	result = /obj/item/reagent_containers/food/snacks/friedshrimp
...
/datum/recipe/soyscampi
	...
	result = /obj/item/reagent_containers/food/snacks/soyscampi
...
/datum/recipe/friedcatfish
	...
	result = /obj/item/reagent_containers/food/snacks/friedcatfish
...
/datum/recipe/gumbo
	...
	result = /obj/item/reagent_containers/food/snacks/catfishgumbo
...
/datum/recipe/catfishcourtbouillon
	...
	result = /obj/item/reagent_containers/food/snacks/catfishcourtbouillon
...
/datum/recipe/planksalmon
	...
	result = /obj/item/reagent_containers/food/snacks/planksalmon
...
/datum/recipe/salmonavocado
	...
	result = /obj/item/reagent_containers/food/snacks/salmonavocado

/datum/recipe/rumshark
	reagents = list(BLACKPEPPER = 15, RUM = 15)
	items = list(/obj/item/fish/toothless_shark,
	/obj/item/reagent_containers/food/snacks/grown/garlic
	)

	result = /obj/item/reagent_containers/food/snacks/rumshark

/datum/recipe/akutaq
	reagents = list(MILK = 10)
	items = list(/obj/item/reagent_containers/food/snacks/glofishmeat,
	/obj/item/reagent_containers/food/snacks/grown/glowberries
	)

	result = /obj/item/reagent_containers/food/snacks/akutaq

/datum/recipe/carpcurry
	reagents = list(VINEGAR = 5, RICE = 10)
	items = list(/obj/item/reagent_containers/food/snacks/goldfishmeat
	)

	result = /obj/item/reagent_containers/food/snacks/carpcurry
...
/datum/recipe/carpconsomme
	...
	result = /obj/item/reagent_containers/food/snacks/carpconsomme

/datum/recipe/butterstick
	items = list(/obj/item/reagent_containers/food/snacks/butter,
	/obj/item/stack/rods
	)
	result = /obj/item/reagent_containers/food/snacks/butterstick
...
/datum/recipe/ambrosia_brownies
	...
	result = /obj/item/reagent_containers/food/snacks/sliceable/ambrosia_brownies
/datum/recipe/butterfingers_r
	items = list(/obj/item/organ/external/r_hand,
	/obj/item/reagent_containers/food/snacks/butter,
	)

 result = /obj/item/reagent_containers/food/snacks/butterfingers_r/
/datum/recipe/butterfingers_l
	items = list(/obj/item/organ/external/l_hand,
	/obj/item/reagent_containers/food/snacks/butter,
	)

 result = /obj/item/reagent_containers/food/snacks/butterfingers_l/
...
/datum/recipe/sauerkraut
	...
	items = list(/obj/item/reagent_containers/food/snacks/grown/cabbage)
...
/datum/recipe/pickledpears
	...
	result = /obj/item/reagent_containers/food/snacks/pickledpears
...
/datum/recipe/bulgogi
	...
	result = /obj/item/reagent_containers/food/snacks/bulgogi
...
/datum/recipe/candiedpear
	...
	result = /obj/item/reagent_containers/food/snacks/candiedpear
...
/datum/recipe/bakedpears
	...
	result = /obj/item/reagent_containers/food/snacks/bakedpears
...
/datum/recipe/winepear
	...
	result = /obj/item/reagent_containers/food/snacks/winepear
...
/datum/recipe/saltednuts
	...
	result = /obj/item/reagent_containers/food/snacks/saltednuts

/datum/recipe/grapejelly
	reagents = list (SUGAR = 5)
	items = list(/obj/item/reagent_containers/food/snacks/grown/grapes)
	result = /obj/item/reagent_containers/food/snacks/grapejelly
...
/datum/recipe/peanutbutter
	...
	result = /obj/item/reagent_containers/food/snacks/peanutbutter

/datum/recipe/escargot
	reagents = list (SODIUMCHLORIDE = 1)
	items = list(
		/obj/item/reagent_containers/food/snacks/meat/snail,
		/obj/item/clothing/head/helmet/snail_helm,
		/obj/item/reagent_containers/food/snacks/grown/mushroom/plumphelmet,
		/obj/item/reagent_containers/food/snacks/peanutbutter,
	)
	result = /obj/item/reagent_containers/food/snacks/escargot
...
/datum/recipe/es_cargo
	...
	result = /obj/item/reagent_containers/food/snacks/es_cargo
...
/datum/recipe/steamed_lobster_deluxe //the deluxe comes with butter and a slice of lemon
	...
	result = /obj/item/steamed_lobster_deluxe_uncracked //this is the lobster whose shell isnt cracked, break its seal and steal its soul, you vile cretin
...
/datum/recipe/steamed_lobster_simple //the simple has no fancy butter or lemon
	...
	result = /obj/item/steamed_lobster_simple_uncracked //same as the deluxe, wirecutter it to make it edible
...
/datum/recipe/lobster_roll //lobster hot dog
	...
	result = /obj/item/reagent_containers/food/snacks/lobster_roll
...
/datum/recipe/lobster_roll_butter //lobster hot dog, no mayo and buttery
	...
	result = /obj/item/reagent_containers/food/snacks/lobster_roll_butter
...
/datum/recipe/lobster_tail_baked
	...
	result = /obj/item/reagent_containers/food/snacks/lobster_tail_baked
...
/datum/recipe/lobster_dumplings
	...
	result = /obj/item/reagent_containers/food/snacks/lobster_dumplings

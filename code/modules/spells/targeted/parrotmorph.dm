...
/mob/living/simple_animal/parrot/polymorph //invincible parrot for polymorph spell. Turns victim into a parrot for a temporary amount of time. Don't want wizard to secure easy kills.
	health = 99999999999 //got to be better ways of doing this but I haven't figured it out yet

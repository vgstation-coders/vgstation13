	...
	if(islich(user))
		...
		switch(pick(valid_outfits))
			if(ROBES_SUIT)
				...
				equipped_summons = list(
										"[slot_head]" = /obj/item/clothing/head/wizard/skelelich,
		...
		switch(pick(valid_outfits))
			...
			if (ROBES_BLUE)
				equipped_summons = list(
										"[slot_head]" = /obj/item/clothing/head/wizard,
			...
			if (ROBES_RED)
				equipped_summons = list(
										"[slot_head]" = /obj/item/clothing/head/wizard/red,
			...
			if(ROBES_MARISA)
				equipped_summons = list(
										"[slot_head]" = /obj/item/clothing/head/wizard/marisa,

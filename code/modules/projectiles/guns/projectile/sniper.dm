...
/obj/item/weapon/gun/projectile/hecate/hunting
	name = "hunting rifle"
	desc = "A hunting rifle. Made to dominate the lesser beings."
...
/obj/item/weapon/gun/projectile/hecate/hunting/proc/AttachOverlays() //to prevent overlaying issues
	...
	var extended_mag_overlay = image("icon" = 'icons/obj/biggun.dmi', "icon_state" = "hf_extmag")
	if(scoped)
		...
		gun_overlay -= "/obj/item/gun_part/scope"
	if(extended_mag)
		if("/obj/item/gun_part/extended_mag" in gun_overlay)
		else
			overlays += extended_mag_overlay
			gun_overlay += "/obj/item/gun_part/extended_mag"
	else
		overlays -= extended_mag_overlay
		gun_overlay -= "/obj/item/gun_part/extended_mag"

...
/obj/item/gun/energy/decloner/failure_check(var/mob/living/carbon/human/M)
	if(prob(15))
...
/obj/item/gun/energy/decloner/isHandgun()
	return TRUE
...
/obj/item/gun/energy/staff/change
	var/changetype=null
	var/next_changetype=0

/obj/item/gun/energy/staff/change/process_chambered()
	if(!..())
		return 0
...
/obj/item/gun/energy/staff/change/attack_self(var/mob/living/user)
...
/obj/item/gun/energy/staff/sinterklaas
...
#define RAISE_MEAT 3
/obj/item/gun/energy/staff/necro
...
/obj/item/gun/energy/staff/necro/New()
	..()
	processing_objects.Add(src)

/obj/item/gun/energy/staff/necro/Destroy()
	processing_objects.Remove(src)
	..()

/obj/item/gun/energy/staff/necro/process()
	if(islich(loc))
...
/obj/item/gun/energy/staff/necro/attack_self(mob/user)
...
/obj/item/gun/energy/staff/necro/afterattack(atom/target, mob/living/user, flag, params, struggle = 0)
...
/obj/item/gun/energy/staff/necro/proc/canRaise(atom/target, mob/living/user)
	if(ishuman(target))
	...
	if(isanimal(target) || ismonkey(target))
		return RAISE_ANIMAL
	if(istype(target, /obj/item/reagent_containers/food/snacks/meat))
		return RAISE_MEAT
...
/obj/item/gun/energy/staff/necro/proc/meatRaise(var/obj/item/reagent_containers/food/snacks/meat/M, mob/living/user)
...
/obj/item/gun/energy/staff/necro/proc/simpleRaise(var/mob/living/S, mob/living/user)
...
/obj/item/gun/energy/staff/necro/proc/humanRaise(mob/target, mob/user)
	var/mob/living/carbon/human/H = target
...
/obj/item/gun/energy/staff/necro/attack(mob/living/target as mob, mob/living/user as mob)
...
/obj/item/gun/energy/staff/destruction_wand
...
/obj/item/gun/energy/staff/destruction_wand/lifekiller
	lifekiller = 1

/obj/item/gun/energy/staff/destruction_wand/process()
	..()
...
/obj/item/gun/energy/staff/destruction_wand/attack(atom/target as mob|obj|turf|area, mob/living/user as mob, def_zone)
...
/obj/item/gun/energy/staff/destruction_wand/Fire(atom/target, mob/living/user, params, reflex = 0, struggle = 0, var/use_shooter_turf = FALSE)
	if(power_supply.charge == charge_cost || lifekiller)
...
/obj/item/gun/energy/staff/swapper
...
/obj/item/gun/energy/staff/swapper/update_wield(mob/user)
	..()
...
/obj/item/gun/energy/floragun/isHandgun()
	return TRUE
...
/obj/item/gun/energy/floragun/process_chambered()
	. = ..()
...
/obj/item/gun/energy/floragun/verb/SetMutationStrength()
...
/obj/item/gun/energy/floragun/attackby(obj/item/W as obj, mob/user as mob)
...
/obj/item/gun/energy/floragun/afterattack(atom/A, mob/living/user, flag, params, struggle = 0)
...
/obj/item/gun/energy/kinetic_accelerator/shoot_live_shot()
	...
	..()
*/
/obj/item/gun/energy/kinetic_accelerator/attack_self(var/mob/living/user)
...
/obj/item/gun/energy/kinetic_accelerator/cyborg
	...
	item_state = "kineticgun"
	projectile_type = "/obj/item/projectile/kinetic"
	cell_type = "/obj/item/cell/miningborg"
	charge_cost = 50
	var/charge_tick = 0

/obj/item/gun/energy/kinetic_accelerator/cyborg/New()
	..()
	processing_objects.Add(src)
...
/obj/item/gun/energy/kinetic_accelerator/cyborg/process() //Every [recharge_time] ticks, recharge a shot for the cyborg
	charge_tick++
	if(charge_tick < 3)
		return 0
	charge_tick = 0
...
/obj/item/gun/energy/kinetic_accelerator/cyborg/restock()
...
/obj/item/gun/energy/radgun/isHandgun()
	return TRUE

/obj/item/gun/energy/radgun/New()
	..()
	processing_objects.Add(src)


/obj/item/gun/energy/radgun/Destroy()
	processing_objects.Remove(src)
	..()

/obj/item/gun/energy/radgun/process()
	charge_tick++
	if(charge_tick < 4)
		return 0
	charge_tick = 0
...
obj/item/gun/energy/ricochet/Fire(atom/target, mob/living/user, params, reflex = 0, struggle = 0, var/use_shooter_turf = FALSE)
	if(defective && prob(30))
		target = get_ranged_target_turf(user, pick(diagonal), 7)
	..()

/obj/item/gun/energy/bison
...
/obj/item/gun/energy/bison/isHandgun()
	return TRUE

/obj/item/gun/energy/bison/New()
	..()
	power_supply.charge = 0

/obj/item/gun/energy/bison/attack_self(mob/user as mob)
...
/obj/item/gun/energy/bison/update_icon()
	if(power_supply.charge >= power_supply.maxcharge)
		icon_state = "bison100"
...
/obj/item/gun/energy/polarstar/isHandgun()
	return TRUE

/obj/item/gun/energy/polarstar/New()
	..()
	playsound(src, 'sound/weapons/spur_spawn.ogg', 50, 0, null, FALLOFF_SOUNDS, 0)

/obj/item/gun/energy/polarstar/afterattack(atom/A, mob/living/user, flag, params, struggle = 0)
	levelChange()
	..()

/obj/item/gun/energy/polarstar/proc/levelChange()
...
/obj/item/gun/energy/polarstar/proc/set_firesound()
	switch(firelevel)
...
/obj/item/gun/energy/polarstar/update_icon()
	return
...
/obj/item/gun/energy/polarstar/spur/New()
	..()
	processing_objects.Add(src)


/obj/item/gun/energy/polarstar/spur/Destroy()
	processing_objects.Remove(src)
	..()

/obj/item/gun/energy/polarstar/spur/process()
	charge_tick++
	if(charge_tick < 2)
		return 0
	charge_tick = 0

...
/obj/item/circuitboard/shield_gen_ex/solder_improve(var/mob/user)
	to_chat(user, "<span class='notice'>You set the shield generator circuit to project normal shields.</span>")
	new /obj/item/circuitboard/shield_gen(user.loc)
	qdel(src)
...
/obj/item/circuitboard/shield_gen/solder_improve(var/mob/user)
	to_chat(user, "<span class='notice'>You set the shield generator circuit to project external hull shields.</span>")
	new /obj/item/circuitboard/shield_gen_ex(user.loc)
	qdel(src)

...
/obj/machinery/power/port_gen/pacman/crowbarDestroy(mob/user, obj/item/weapon/tool/crowbar/I) //don't like the copy/paste, but the proc has special handling in the middle so we need it
	if(..())
		while ( sheets > 0 )

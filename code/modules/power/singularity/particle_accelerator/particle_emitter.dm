...
/obj/structure/particle_accelerator/particle_emitter/proc/emit_particle(var/strength = 0)
	if((src.last_shot + src.fire_delay) <= world.time)
		...
		switch(strength)
			if(0)
				A = new /obj/effect/accelerated_particle/wide/weak(T, dir)
			if(1)
				A = new /obj/effect/accelerated_particle/wide(T, dir)
			if(2)
				A = new /obj/effect/accelerated_particle/wide/strong(T, dir)
			if(3)
				A = new /obj/effect/accelerated_particle/wide/powerful(T, dir)
		if(A)
			A.startMove(1)
			return 1
	return 0

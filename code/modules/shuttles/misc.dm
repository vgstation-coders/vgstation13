...
/obj/machinery/computer/shuttle_control/exploration/New()
	...
	manual.name = "Exploration Shuttle manual"
	manual.info = "Central Command has procured a new-model Exploration Shuttle for your station.<hr>This shuttle's password is: \"<b>[exploration_shuttle.password]</b>\"."
	.=..()

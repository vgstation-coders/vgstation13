/datum/unit_test/_vector_duplicate/start()
	var/_vector/V
	var/_vector/D
...
/datum/unit_test/_vector_isnull/start()
	var/_vector/V = new /_vector(0,0.0)
	if(!V.is_null())
		fail("Vector not null")

/datum/unit_test/_vector_isint/start()
...
/datum/unit_test/_vector_toangle/start()
...
/datum/unit_test/_vector_mirror/start()
	var/_vector/V = new /_vector(1,-1)
...
/datum/unit_test/_vector_dot/start()

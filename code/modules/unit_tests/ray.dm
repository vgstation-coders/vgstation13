/datum/unit_test/ray_equals/start()
	var/vector/origin = vector(0,3)
	var/vector/direction = vector(4,7)
...
/datum/unit_test/ray_hitsPoint/start()
	var/vector/origin = vector(0,3)
	var/vector/direction = vector(2,10)
	var/vector/P = vector(1,8)
...
/datum/unit_test/ray_getPoint/start()
	var/vector/origin = vector(0,3)
	var/vector/direction = vector(4,10)
	var/distance = 0.5
	var/vector/P = vector(0.2,3.5)
	var/ray/R = new /ray(origin, direction)

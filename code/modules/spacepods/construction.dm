...
/datum/construction/reversible/pod/chassis
	...
	steps = list(
				...
				list(
					...
					Co_BACKSTEP = list(
						Co_KEY      = /obj/item/weapon/tool/wrench,
						Co_VIS_MSG  = "{USER} unbolt{s} {HOLDER}'s bulkhead panelling.",
					),
					Co_NEXTSTEP = list(
						Co_KEY      = /obj/item/weapon/tool/weldingtool,
				...
				list(
					...
					Co_BACKSTEP = list(
						Co_KEY      = /obj/item/weapon/tool/crowbar,
				...
				list(
					...
					Co_BACKSTEP = list(
						Co_KEY      = /obj/item/weapon/tool/screwdriver,
				...
				list(
					...
					Co_BACKSTEP = list(
						Co_KEY      = /obj/item/weapon/tool/wirecutters,

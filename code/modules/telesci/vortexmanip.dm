/obj/item/clothing/gloves/vortexmanip
	name = "Vortex Manipulator"
	desc = "Side effects may include or be limited to: Concussion, Vomiting, and Total Molecular Collapse."
	icon_state = "s-ninja"
	item_state = "s-ninja"

/obj/item/clothing/gloves/vortexmanip/New()

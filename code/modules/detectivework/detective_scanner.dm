...
/obj/item/device/detective_scanner
	...
	attack(mob/living/carbon/human/M as mob, mob/user as mob)
		if (!ishuman(M))
			user << "<span class=\"rose\">[M] is not human and cannot have the fingerprints.</span>"
			return 0
		...
		if (blood_DNA_found.len)
			...
			spawn(15)
				for(var/blood in blood_DNA_found)
					user << "Blood type: <span class=\"rose\">[blood_DNA_found[blood]]</span> \t DNA: <span class=\"rose\"> [blood]</span>"
...
/obj/item/device/detective_scanner/forger
	...
	attack_self(var/mob/user as mob)
		...
		if(forging)
			user << "<span class=\"rose\">You are already forging evidence</span>"
			return 0
		clear_forgery()
		//fingerprint loop
		while(1)
		...
		if(custom_blood.len)
			...
			spawn(15)
				for(var/blood in custom_blood)
					user << "Blood type: <span class=\"rose\">[custom_blood[blood]]</span> \t DNA: <span class=\"rose\">[blood]</span>"

/datum/design/hookshot
	...
	id = "hookshot"
	req_tech = list(Tc_MATERIALS = 2, Tc_ENGINEERING = 5, Tc_MAGNETS = 2, NANOTRASEN = 1)
...
/datum/design/ricochet
	...
	id = "ricochet"
	req_tech = list(Tc_MATERIALS = 3, Tc_POWERSTORAGE = 3, Tc_COMBAT = 3, NANOTRASEN = 1)
	build_type = PROTOLATHE
...
/datum/design/gravitywell
	...
	id = "gravitywell"
	req_tech = list(Tc_MATERIALS = 7, Tc_BLUESPACE = 5, Tc_MAGNETS = 5, NANOTRASEN = 1)
	build_type = PROTOLATHE

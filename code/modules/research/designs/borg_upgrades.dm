...
/datum/design/borg_magnetic_gripper_board
	...
	req_tech = list(Tc_MAGNETS = 5, Tc_ENGINEERING = 5, Tc_PROGRAMMING = 5)
	build_type = MECHFAB
...
/datum/design/medical_module_surgery
	...
	req_tech = list(Tc_BIOTECH = 3, Tc_ENGINEERING = 3, Tc_PROGRAMMING = 5)
	build_type = MECHFAB
...
/datum/design/borg_organ_gripper_board
	...
	req_tech = list(Tc_BIOTECH = 5, Tc_ENGINEERING = 4, Tc_PROGRAMMING = 5)
	build_type = MECHFAB
...
/datum/design/borg_service_upgrade
	...
	req_tech = list(Tc_BIOTECH = 2, Tc_ENGINEERING = 3, Tc_PROGRAMMING = 5)
	build_type = MECHFAB
...
/datum/design/borg_service_upgrade_hydro
	...
	req_tech = list(Tc_BIOTECH = 4, Tc_ENGINEERING = 2, Tc_PROGRAMMING = 5)
	build_type = MECHFAB

...
/obj/item/weapon/reagent_containers/glass/replenishing/New()
	...
	spawning_id = pick(BLOOD,HOLYWATER,CLEANER,LUBE,NOTHING,FROSTOIL,CAPSAICIN,WATER,FUEL,PLASMA,MOONROCKS,CARPPHEROMONES,ETHANOL,DRINK,HIPPIESDELIGHT,PWINE,MANLYDORF,CHANGELINGSTING,CITALOPRAM,PAROXETINE)

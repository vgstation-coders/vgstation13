...
/datum/artifact_trigger/force/New()
	..()
	my_artifact.lazy_register_event(/lazy_event/on_attackby, src, .proc/owner_attackby)
	my_artifact.lazy_register_event(/lazy_event/on_explosion, src, .proc/owner_explode)
	my_artifact.lazy_register_event(/lazy_event/on_projectile, src, .proc/owner_projectile)
...
/datum/artifact_trigger/force/Destroy()
	my_artifact.lazy_unregister_event(/lazy_event/on_attackby, src, .proc/owner_attackby)
	my_artifact.lazy_unregister_event(/lazy_event/on_explosion, src, .proc/owner_explode)
	my_artifact.lazy_unregister_event(/lazy_event/on_projectile, src, .proc/owner_projectile)

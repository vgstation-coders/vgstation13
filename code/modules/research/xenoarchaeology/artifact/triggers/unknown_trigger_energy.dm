...
/datum/artifact_trigger/energy/New()
	...
	my_artifact.lazy_register_event(/lazy_event/on_beam_connect, src, .proc/owner_beam)
...
/datum/artifact_trigger/energy/Destroy()
	...
	my_artifact.lazy_unregister_event(/lazy_event/on_beam_connect, src, .proc/owner_beam)
	..()

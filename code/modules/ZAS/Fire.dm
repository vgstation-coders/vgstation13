...
/obj/effect/fire/process()
	...
	if(air_contents.molar_ratio(GAS_MIASMA) < 0.1 / CELL_VOLUME)
		air_contents[GAS_MIASMA] = 0
...
/datum/gas_mixture/proc/zburn(var/turf/T, force_burn)
	...
	adjust_multi(
		...
		GAS_MIASMA, -min(src[GAS_MIASMA], (src[GAS_MIASMA] * used_fuel_ratio * used_reactants_ratio) * config.miasma_burn_rate)) //Miasma burns 5 times as quick

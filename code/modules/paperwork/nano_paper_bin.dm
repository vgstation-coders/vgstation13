...
/obj/item/paper_bin/nano/MouseDropFrom(mob/user as mob)
...
/obj/item/paper_bin/nano/attack_paw(mob/user as mob)
	return attack_hand(user)


/obj/item/paper_bin/nano/attack_hand(mob/user as mob)
	if(ressources > 0)
		ressources--
		var/obj/item/paper/nano/p
		p = new /obj/item/paper/nano
...
/obj/item/paper_bin/nano/attackby(var/obj/item/stack/sheet/plasteel/i as obj, mob/user as mob)
	if(!istype(i))
		return
	if(ressources > 0)
...
/obj/item/paper_bin/nano/examine(mob/user)
	..()
	if(ressources)
...
/obj/item/paper_bin/nano/update_icon()
	if(ressources < 1)

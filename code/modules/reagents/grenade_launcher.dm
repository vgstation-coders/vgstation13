...
/obj/item/gun/grenadelauncher/examine(mob/user)
	...
	if(!(grenades.len))
		...
		for(var/obj/item/grenade/G in grenades)
...
/obj/item/gun/grenadelauncher/afterattack(atom/target, mob/living/user, flag, params, struggle = 0)
	if(flag)
...
/obj/item/gun/grenadelauncher/verb/TimerOverrideMode()
...
/obj/item/gun/grenadelauncher/verb/Unload()

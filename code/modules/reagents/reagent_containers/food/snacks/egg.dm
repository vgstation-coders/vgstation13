...
/obj/item/reagent_containers/food/snacks/egg/attackby(obj/item/W as obj, mob/user as mob)
	if (istype(W, /obj/item/reagent_containers))
		if(W.reagents.amount_cache.len == 1 && W.reagents.has_reagent(FLOUR, 5))
			...
			new /obj/item/reagent_containers/food/snacks/dough(get_turf(src))
...
/obj/item/reagent_containers/food/snacks/egg/vox
	name = "green egg"
...
/obj/item/reagent_containers/food/snacks/egg/cockatrice
	name = "cockatrice egg"
...
/obj/item/reagent_containers/food/snacks/egg/cockatrice/New()
	..()
...
/obj/item/reagent_containers/food/snacks/egg/bigroach/New()
	..()

	reagents.add_reagent(TOXIN, rand(5,15))
	reagents.add_reagent(RADIUM, rand(1,5))

/obj/item/reagent_containers/food/snacks/egg/parrot
	name = "parrot egg"
...
/obj/item/reagent_containers/food/snacks/egg/snail
	name = "snail egg"
...
/obj/item/reagent_containers/food/snacks/egg/snail/New()
	processing_objects.Add(src)
	snail_egg_count++
	return ..()

/obj/item/reagent_containers/food/snacks/egg/snail/Destroy()
	snail_egg_count--
	return ..()

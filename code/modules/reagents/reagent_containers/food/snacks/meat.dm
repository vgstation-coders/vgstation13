...
/obj/item/reagent_containers/food/snacks/meat/New(atom/A, var/mob/M)
	..()
...
/obj/item/reagent_containers/food/snacks/meat/Destroy()
	..()
	if(poisonsacs)
		qdel(poisonsacs)
		poisonsacs = null

/obj/item/reagent_containers/food/snacks/meat/animal //This meat spawns when an animal is butchered, and its name is set to '[animal.species_name] meat' (like "cat meat")
...
/obj/item/reagent_containers/food/snacks/meat/animal/lizard/New()
	..()
...
/obj/item/reagent_containers/food/snacks/meat/human/after_consume(var/mob/user, var/datum/reagents/reagentreference)
	if(!user)
		return
	if(ishuman(user))
...
/obj/item/reagent_containers/food/snacks/meat/rawchicken/vox
	name = "vox meat"
...
/obj/item/reagent_containers/food/snacks/meat/rawchicken/New()
	..()
	reagents.add_reagent(NUTRIMENT, 3)
	bitesize = 1
...
/obj/item/reagent_containers/food/snacks/meat/crabmeat/New()
	..()
	reagents.add_reagent(NUTRIMENT, 3)
...
/obj/item/reagent_containers/food/snacks/meat/carpmeat/New()
	..()
	poisonsacs = new /obj/item/reagent_containers/food/snacks/carppoisongland
	eatverb = pick("bite","chew","choke down","gnaw","swallow","chomp")
	reagents.add_reagent(NUTRIMENT, 3)
	reagents.add_reagent(CARPOTOXIN, 3)
	bitesize = 6

/obj/item/reagent_containers/food/snacks/meat/carpmeat/imitation
	name = "imitation carp fillet"
	desc = "Almost just like the real thing, kinda."

/obj/item/reagent_containers/food/snacks/carppoisongland
	name = "venomous spines"
	desc = "The toxin-filled spines of a space carp."
	icon_state = "toxicspine"
/obj/item/reagent_containers/food/snacks/carppoisongland/New()
	..()
	reagents.add_reagent(CARPOTOXIN, 3)
	bitesize = 3
...
/obj/item/reagent_containers/food/snacks/meat/xenomeat
	...
	icon_state = "xenomeat"
/obj/item/reagent_containers/food/snacks/meat/xenomeat/New()
	..()
	reagents.add_reagent(NUTRIMENT, 3)
	src.bitesize = 6
...
/obj/item/reagent_containers/food/snacks/meat/spidermeat/New()
	..()
...
/obj/item/reagent_containers/food/snacks/spiderpoisongland
	name = "venomous spittle sac"
	desc = "The toxin-filled poison sac of a giant spider."
	icon_state = "toxicsac"

/obj/item/reagent_containers/food/snacks/spiderpoisongland/New()
	..()
	reagents.add_reagent(TOXIN, 3)
	bitesize = 3
...
/obj/item/reagent_containers/food/snacks/meat/bearmeat/New()
	..()
	reagents.add_reagent(NUTRIMENT, 12)
	reagents.add_reagent(HYPERZINE, 5)
	src.bitesize = 3

/obj/item/reagent_containers/food/snacks/meat/roach
	name = "cockroach meat"
	desc = "A cockroach's severed abdomen, small but nonetheless nutritious."
	icon_state = "roachmeat"

/obj/item/reagent_containers/food/snacks/meat/roach/New()
	..()
	reagents.add_reagent(NUTRIMENT, 0.5)
	reagents.add_reagent(ROACHSHELL, rand(2,6))
	bitesize = 5

/obj/item/reagent_containers/food/snacks/meat/roach/big
	desc = "A chunk of meat from an above-average sized cockroach."
	icon_state = "bigroachmeat"

/obj/item/reagent_containers/food/snacks/meat/roach/big/New()
	..()
	reagents.add_reagent(NUTRIMENT, 5)
	reagents.add_reagent(ROACHSHELL, 16)

/obj/item/reagent_containers/food/snacks/meat/mimic
	name = "mimic meat"
	desc = "Woah! You were eating THIS all along?"
	icon_state = "rottenmeat"
	var/transformed = FALSE

/obj/item/reagent_containers/food/snacks/meat/mimic/New()
	..()
...
/obj/item/reagent_containers/food/snacks/meat/mimic/bless()
	visible_message("<span class='info'>\The [src] starts fizzling!</span>")
	spawn(10)
		shapeshift(/obj/item/storage/bible) //Turn into a bible

/obj/item/reagent_containers/food/snacks/meat/mimic/spook(mob/dead/observer/ghost)
	if(..(ghost, TRUE))
...
var/global/list/valid_random_food_types = existing_typesof(/obj/item/reagent_containers/food/snacks) - typesof(/obj/item/reagent_containers/food/snacks/customizable)

/obj/item/reagent_containers/food/snacks/meat/mimic/before_consume(mob/target)
	if(transformed)
...
/obj/item/reagent_containers/food/snacks/meat/mimic/preattack(atom/movable/target, mob/user, proximity_flag)
	if(!proximity_flag)
		return

	//Forbid creation of custom foods with mimic meat
	if(transformed)
		if(istype(target, /obj/item/trash/plate) || istype(target, /obj/item/reagent_containers/food/snacks))
			to_chat(user, "<span class='danger'>\The [name] shapeshifts as it touches \the [target]!</span>")
			revert()

	return ..()

/obj/item/reagent_containers/food/snacks/meat/mimic/forceMove(atom/destination, no_tp=0, harderforce = FALSE, glide_size_override = 0)
	if(transformed && istype(destination, /obj/machinery/cooking))
		revert()

	return ..()

/obj/item/reagent_containers/food/snacks/meat/mimic/proc/shapeshift(atom/atom_to_copy = null)
	if(!atom_to_copy)
...
/obj/item/reagent_containers/food/snacks/meat/mimic/proc/revert()
	shapeshift(/obj/item/reagent_containers/food/snacks/meat/mimic)
	transformed = FALSE
...
/obj/item/reagent_containers/food/snacks/meat/box/pig
	name = "pork"
	desc = "A slab of pig meat."
	icon_state = "meat"
	gender = PLURAL

/obj/item/reagent_containers/food/snacks/meat/hive
	name = "alien tissue"
	desc = "A long piece of rough, black tissue."
	icon_state = "hivemeat"

/obj/item/reagent_containers/food/snacks/meat/hive/New()
	..()

	reagents.add_reagent(CARBON, 5)
	reagents.add_reagent(pick(IRON, GOLD, SILVER, URANIUM), rand(0,5))

/obj/item/reagent_containers/food/snacks/meat/hive/turret/New()
	..()

	reagents.add_reagent(OXYGEN, rand(1,5))
	reagents.add_reagent(ETHANOL, rand(1,5))

/obj/item/reagent_containers/food/snacks/meat/rawchicken/cockatrice
...
/obj/item/reagent_containers/food/snacks/meat/rawchicken/cockatrice/New()
	..()

	reagents.add_reagent(PETRITRICIN, 3)

/obj/item/reagent_containers/food/snacks/meat/wendigo
	name = "strange meat"
	desc = "Doesn't look very appetizing, but if you're considerably hungry..."
	icon_state = "wendigo_meat"
	bitesize = 30

/obj/item/reagent_containers/food/snacks/meat/wendigo/New()
	..()
	reagents.add_reagent(NUTRIMENT, rand(10,25))


/obj/item/reagent_containers/food/snacks/meat/wendigo/consume(mob/living/carbon/eater, messages = 0)
	. = ..()
	if(ishuman(eater))
...
/obj/item/reagent_containers/food/snacks/meat/slime/New()
	..()
...
/obj/item/reagent_containers/food/snacks/meat/snail/New()
	. = ..()
	reagents.add_reagent(NUTRIMENT,5)

/obj/item/reagent_containers/food/snacks/meat/gingerbroodmother
...
/obj/item/reagent_containers/food/snacks/meat/gingerbroodmother/New()
	..()
	reagents.add_reagent(NUTRIMENT, 10)
	reagents.add_reagent (CARAMEL, 10)

/obj/item/reagent_containers/food/snacks/meat/gingerbroodmother/consume(mob/living/carbon/eater, messages = 0)

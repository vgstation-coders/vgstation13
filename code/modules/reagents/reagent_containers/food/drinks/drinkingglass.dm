		...
		if (reagents.reagent_list.len > 0)
			...
			switch(reagents.get_master_reagent_id())
				...
				if(MARTINI)
					...
					desc = "Damn, the bartender even stirred, not shook it."
				if(VODKAMARTINI)
					icon_state = "martiniglass"
					name = "vodka martini"
		...
		if (reagents.reagent_list.len > 0)
			...
			switch(reagents.get_master_reagent_id())
				...
				if(DETCOFFEE)
					...
					name = "\improper Joe"
					desc = "The lights, the smoke, the grime... the station itself felt alive that day when I stepped into my office, mug in hand. It had been one of those damn days. Some nurse got smoked in the tunnels, and it came down to me to catch the son of a bitch that did it. The dark, stale air of the tunnels sucks the soul out of a man -- sometimes literally -- and I was no closer to finding the killer than when the nurse was still alive. I had barely gotten settled in my chair when an officer burst through the door. Another body in the tunnels, an assistant this time. I grumbled and downed what was left of my joe. This stuff used to taste great when I was a rookie, but now it was like boiled dirt. I guess that's how the station changes you. I set the mug back down on my desk and lit my last cigar. I wrap my fingers around the comforting grip of the .44 snub in my coat and step out, back into the bleak halls of the station. The case was not cold yet."
				if(ETANK)
					icon_state = "etank"

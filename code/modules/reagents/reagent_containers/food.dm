...
/obj/item/reagent_containers/food/fits_in_iv_drip()
	return 1

/obj/item/reagent_containers/food/dipping_sauce
	var/dip_message = ""

/obj/item/reagent_containers/food/dipping_sauce/update_icon()
...
/obj/item/reagent_containers/food/dipping_sauce/New()
	..()
	reagents.add_reagent(DIPPING_SAUCE,30)

/obj/item/reagent_containers/food/dipping_sauce/attackby(obj/item/reagent_containers/food/snacks/S, mob/user) //Dipping sauce is not a snack because you can't just pick it up and eat it. Instead, you need to dip snacks in it.
	if(..()) return
	if(istype(S))
		...
		if(istype(S,/obj/item/reagent_containers/food/snacks/tortillachip))
			S.desc = "A particularly delicious morsel!"
		update_icon()
	return 1

/obj/item/reagent_containers/food/dipping_sauce/queso
	name = "queso"
	desc = "A classic dipping sauce that you can't go wrong with."
	icon_state = "queso"
	dip_message = "It's a flavor fiesta!"

/obj/item/reagent_containers/food/dipping_sauce/guacamole
	name = "guacamole"
...
/obj/item/reagent_containers/food/dipping_sauce/hummus
	name = "hummus"
...
/obj/item/chipbasket/New()
	..()
	for(var/i = 1 to 10)
		new /obj/item/reagent_containers/food/snacks/tortillachip(src)

/obj/item/chipbasket/update_icon()
	if(contents.len>5)
		icon_state = "chipbasket-full"
...
/obj/item/chipbasket/attack_hand(mob/user)
	if(contents)
...
/obj/item/chipbasket/attackby(obj/item/reagent_containers/food/snacks/tortillachip/T, mob/user)
	if(..()) return
	if(istype(T))
		if(contents.len >= 10)
...
/obj/item/chipbasket/MouseDropFrom(over_object)
...
/obj/item/reagent_containers/food/snacks/tortillachip/New()
	..()
...
/obj/structure/poutineocean
	...
	var/type_to_dispense = /obj/item/reagent_containers/food/snacks/poutine
...
/obj/structure/poutineocean/poutinecitadel
	...
	pixel_x = -16 * PIXEL_MULTIPLIER
	pixel_y = -8 * PIXEL_MULTIPLIER
	type_to_dispense = /obj/item/reagent_containers/food/snacks/poutinesyrup

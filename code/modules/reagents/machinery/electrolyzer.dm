/obj/item/electrolyzer
	...
	var/list/allowed_containers = list(/obj/item/reagent_containers/glass, /obj/item/reagent_containers/food/drinks/soda_cans/)

/obj/item/electrolyzer/New()
	. = ..()

/obj/item/electrolyzer/attack_self(mob/user as mob)
	if(beakers.len)
...
/obj/item/electrolyzer/attackby(obj/item/W as obj, mob/user as mob)
	if(iswirecutter(W))
		if(beakers.len)
			...
			new /obj/item/grenade/chem_grenade(T)
			qdel(src)
			return
		...
		if(beakers.len == 2)
			...
			var/obj/item/reagent_containers/glass/other = beakers[1]
		...
		var/obj/item/reagent_containers/active = null
		var/obj/item/reagent_containers/empty = null
...
/obj/item/electrolyzer/proc/insert_beaker(obj/item/W as obj, mob/user as mob)

...
/obj/item/weapon/gun/syringe/examine()
	...
	usr << "<span class=\"notice\">[syringes.len] / [max_syringes] syringes.</span>"
	...
	if(istype(I, /obj/item/weapon/reagent_containers/syringe))
		...
		if(S.mode != 2)//SYRINGE_BROKEN in syringes.dm
			if(syringes.len < max_syringes)
				...
				usr << "<span class=\"rose\">[src] cannot hold more syringes.</span>"
		else
			usr << "<span class=\"rose\">This syringe is broken!</span>"

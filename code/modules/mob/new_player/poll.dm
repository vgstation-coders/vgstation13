...
<hr>"}
		...
		while(select_query.NextRow())
			...
			output += "<tr bgcolor='[ (i % 2 == 1) ? color1 : color2 ]'><td><br>[!client.holder && client.player_age <= 30 ? "<b>[pollquestion]</b> (<span class='danger'>You cannot vote on this</span>)" : "<a href=\"byond://?src=\ref[src];pollid=[pollid]\"><b>[pollquestion]</b></a>"][config.poll_results_url ? " | <a href=\"byond://?src=\ref[src];pollresult=[pollid]\">Results</a>" : ""]<br> </td></tr>"
			i++

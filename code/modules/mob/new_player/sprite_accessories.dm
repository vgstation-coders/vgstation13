...
/datum/sprite_accessory/hair
	...
	bald
		...
		icon_state = "bald"
		gender = MALE
		species_allowed = list("Human","Unathi","Grey","Phoronman","Skellington","Diona","Muton","Golem","Skeletal Vox","Horror")
...
/datum/sprite_accessory/facial_hair
	...
	shaved
		...
		icon_state = "bald"
		gender = NEUTER
		species_allowed = list("Human","Unathi","Tajaran","Skrell","Vox","Grey","Phoronman","Skellington","Diona","Muton","Golem","Skeletal Vox","Horror")

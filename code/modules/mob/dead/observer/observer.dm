...
/mob/living/verb/ghost()
	...
	if(src.health < 0 && stat != DEAD) //crit people
		...
		var/response = alert(src, "Are you -sure- you want to ghost?\n(You are alive. If you ghost, you will not be able to continue and must re-enter the round through a new life!  You can't change your mind so choose wisely!)","Are you sure you want to ghost?","Ghost","Stay in body")

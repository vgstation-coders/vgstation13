...
/mob/living/simple_animal/vox/armalis/Die()
	...
	dead_mob_list += src
	stat = DEAD
	visible_message("<span class=\"danger\">[src] shudders violently and explodes!</span>","<span class=\"danger\">You feel your body rupture!</span>")
...
/mob/living/simple_animal/vox/armalis/verb/fire_quill(mob/target as mob in oview())
	...
	src << "<span class=\"rose\">You launch a razor-sharp quill at [target]!</span>"
	for(var/mob/O in oviewers())
		if ((O.client && !( O.blinded )))
			O << "<span class=\"rose\">[src] launches a razor-sharp quill at [target]!</span>"
	...
	spawn(100)
		src << "<span class=\"rose\">You feel a fresh quill slide into place.</span>"
		quills++
...
/mob/living/simple_animal/vox/armalis/verb/message_mob()
	...
	if(istype(M,/mob/living/carbon/human))
		...
		if(H.species.name == "Vox")
			return
		H << "<span class=\"rose\">Your nose begins to bleed...</span>"
		H.drip(1)

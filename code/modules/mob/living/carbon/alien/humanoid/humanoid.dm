...
/mob/living/carbon/alien/humanoid/proc/add_spells_and_verbs()
	add_spell(new /spell/aoe_turf/alienregurgitate, "alien_spell_base", /obj/screen/movable/spell_master/alien)
	add_spell(new /spell/aoe_turf/conjure/alienweeds, "alien_spell_base", /obj/screen/movable/spell_master/alien)
	add_spell(new /spell/targeted/alienwhisper, "alien_spell_base", /obj/screen/movable/spell_master/alien)
	add_spell(new /spell/targeted/alientransferplasma, "alien_spell_base", /obj/screen/movable/spell_master/alien)

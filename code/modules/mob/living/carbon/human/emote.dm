	...
	switch(act)
		...
		if("fart")
			if(src.op_stage.butt = 4)
				src << "\blue You dont even have a butt."
				visible_message("[src] lets out a [pick("shameful","disgusting","laughable","horrible","hollow")] noise out of his disgusting anus hole thing.")
			else	

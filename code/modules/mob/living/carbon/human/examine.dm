...
/mob/living/carbon/human/proc/get_examine_text(mob/user)
	...
	if(w_uniform && !(slot_w_uniform in obscured) && w_uniform.is_visible())
		if(w_uniform.blood_DNA && w_uniform.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(w_uniform)] [w_uniform.gender==PLURAL?"some":"a"] [w_uniform.get_stain_text()] [w_uniform.name]! [format_examine(w_uniform, "Examine")][w_uniform.description_accessories()]</span>\n"
		else
	...
	if(head && head.is_visible())
		if(head.blood_DNA && head.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(head)] [head.gender==PLURAL?"some":"a"] [head.get_stain_text()] [head.name] on [t_his] head! [format_examine(head, "Examine")][head.description_accessories()]</span>\n"
		else
	...
	if(wear_suit && wear_suit.is_visible())
		if(wear_suit.blood_DNA && wear_suit.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(wear_suit)] [wear_suit.gender==PLURAL?"some":"a"] [wear_suit.get_stain_text()] [wear_suit.name]!  [format_examine(wear_suit, "Examine")][wear_suit.description_accessories()]</span>\n"
		else
		...
		if(s_store)
			if(s_store.blood_DNA && s_store.blood_DNA.len)
				msg += "<span class='warning'>[t_He] [t_is] carrying [bicon(s_store)] [s_store.gender==PLURAL?"some":"a"] [s_store.get_stain_text()] [s_store.name] on [t_his] [wear_suit.name]!  [format_examine(s_store, "Examine")]</span>\n"
			else
	...
	if(back && back.is_visible())
		if(back.blood_DNA && back.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(back)] [back.gender==PLURAL?"some":"a"] [back.get_stain_text()] [back] on [t_his] back! [format_examine(back, "Examine")][back.description_accessories()]</span>\n"
		else
	...
	for(var/obj/item/I in held_items)
		if(I.is_visible())
			if(I.blood_DNA && I.blood_DNA.len)
				msg += "<span class='warning'>[t_He] [t_is] holding [bicon(I)] [I.gender==PLURAL?"some":"a"] [I.get_stain_text()] [I.name] in [t_his] [get_index_limb_name(is_holding_item(I))]!  [format_examine(I, "Examine")]</span>\n"
			else
	...
	if(gloves && !(slot_gloves in obscured) && gloves.is_visible())
		if(gloves.blood_DNA && gloves.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(gloves)] [gloves.gender==PLURAL?"some":"a"] [gloves.get_stain_text()] [gloves.name] on [t_his] hands! [format_examine(gloves, "Examine")][gloves.description_accessories()]</span>\n"
		else
	...
	if(belt && belt.is_visible())
		if(belt.blood_DNA && belt.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(belt)] [belt.gender==PLURAL?"some":"a"] [belt.get_stain_text()] [belt.name] about [t_his] waist! [format_examine(belt, "Examine")][belt.description_accessories()]</span>\n"
		else
	...
	if(shoes && !(slot_shoes in obscured) && shoes.is_visible())
		if(shoes.blood_DNA && shoes.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(shoes)] [shoes.gender==PLURAL?"some":"a"] [shoes.get_stain_text()] [shoes.name] on [t_his] feet! [format_examine(shoes, "Examine")][shoes.description_accessories()]</span>\n"
		else
	...
	if(wear_mask && !(slot_wear_mask in obscured) && wear_mask.is_visible())
		if(wear_mask.blood_DNA && wear_mask.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(wear_mask)] [wear_mask.gender==PLURAL?"some":"a"] [wear_mask.get_stain_text()] [wear_mask.name] [wear_mask.goes_in_mouth ? "in" : "on"] [t_his] [wear_mask.goes_in_mouth ? "mouth" : "face"]! [format_examine(wear_mask, "Examine")][wear_mask.description_accessories()]</span>\n"
		else
	...
	if(glasses && !(slot_glasses in obscured) && glasses.is_visible())
		if(glasses.blood_DNA && glasses.blood_DNA.len)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(glasses)] [glasses.gender==PLURAL?"some":"a"] [glasses.get_stain_text()] [glasses] covering [t_his] eyes! [format_examine(glasses, "Examine")][glasses.description_accessories()]</span>\n"
		else

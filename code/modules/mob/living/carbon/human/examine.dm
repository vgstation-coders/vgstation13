...
*/
	...
	//uniform
	if(w_uniform && !(slot_w_uniform in obscured) && !(w_uniform.invisibility || w_uniform.alpha <= 1))
	...
	//suit/armour
	if(wear_suit && !(wear_suit.invisibility || wear_suit.alpha <= 1))
	...
	//gloves
	if(gloves && !(slot_gloves in obscured) && !(gloves.invisibility || gloves.alpha <= 1))
	...
	//shoes
	if(shoes && !(slot_shoes in obscured) && !(shoes.invisibility || shoes.alpha <= 1))
	...
	//mask
	if(wear_mask && !(slot_wear_mask in obscured) && !(wear_mask.invisibility || wear_mask.alpha <= 1))
	...
	//eyes
	if(glasses && !(slot_glasses in obscured) && !(glasses.invisibility || glasses.alpha <= 1))
	...
	//ears
	if(ears && !(slot_ears in obscured) && !(ears.invisibility || ears.alpha <= 1))

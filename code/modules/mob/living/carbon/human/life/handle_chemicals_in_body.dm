...
/mob/living/carbon/human/proc/handle_chemicals_in_body()
	...
	if(species.flags & REQUIRE_LIGHT)
		...
		if(species.flags & IS_PLANT)
			if(nutrition > 500)
				nutrition = 500
			if(light_amount >= 3 && !reagents.has_reagent(HYPERZINE) && !reagents.has_reagent(PLANTBGONE)) //If there's enough light, you do not have hyperzine in body, and you don't have plant-b-gone inside you, heal

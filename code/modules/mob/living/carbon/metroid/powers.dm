...
/mob/living/carbon/slime/proc/Feedon(var/mob/living/carbon/M)
	...
	//if(M.client) M << "<span class=\"rose\">You legs become paralyzed!</span>"
	...
	while(Victim && M.health > -70 && stat != 2)
		...
		if(M in view(1, src))
			...
			if(prob(15) && M.client && istype(M, /mob/living/carbon))
				M << "<span class=\"rose\"> [pick("You can feel your body becoming weak!</span>", \
				"You feel like you're about to die!</span>", \
				"You feel every part of your body screaming in agony!</span>", \
				"A low, rolling pain passes through your body!</span>", \
				"Your body feels as if it's falling apart!</span>", \
				"You feel extremely weak!</span>", \

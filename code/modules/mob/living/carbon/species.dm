...
/datum/species/avali
	...
	flags = IS_WHITELISTED
	anatomy_flags = MULTICOLOR

	body_temperature = 230

	cold_level_1 = 220  // Cold damage level 1 below this point.
	cold_level_2 = 200  // Cold damage level 2 below this point.
	cold_level_3 = 160  // Cold damage level 3 below this point.

	heat_level_1 = 240  // Heat damage level 1 above this point.
	heat_level_2 = 250  // Heat damage level 2 above this point.
	heat_level_3 = 275 // Heat damage level 3 above this point.

	burn_mod = 10

	uniform_icons = 'icons/mob/species/avali/uniform.dmi'
	gloves_icons    = 'icons/mob/species/avali/gloves.dmi'
	...
	species_intro = "You are an Avali. You're some kind of space bird and your blood evaporates at room temperature."

/datum/species/avali/handle_death(mob/living/carbon/human/H)
	H.visible_message("<span class='warning'>Holy shit, [src] bursts into steam in front of your eyes!</span>","<span class='notice'>Your body swells with a blistering pain and you suddenly explode into steam!</span>")
	spawn(50)
		H.dust()
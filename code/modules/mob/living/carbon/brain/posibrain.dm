...
/obj/item/device/mmi/posibrain/proc/transfer_personality(var/mob/candidate)
	...
	to_chat(src.brainmob, "<b>Remember, the purpose of your existence is to serve the crew and the station. Above all else, do no harm to the station or it's crew.</b>")

...
/obj/item/weapon/robot_module/medical/New()
	...
	modules += new /obj/item/weapon/tool/scalpel(src)
	modules += new /obj/item/weapon/tool/hemostat(src)
	modules += new /obj/item/weapon/tool/retractor(src)
	modules += new /obj/item/weapon/tool/circular_saw(src)
	modules += new /obj/item/weapon/tool/cautery(src)
	modules += new /obj/item/weapon/tool/bonegel(src)
	modules += new /obj/item/weapon/tool/bonesetter(src)
	modules += new /obj/item/weapon/tool/FixOVein(src)
	modules += new /obj/item/weapon/tool/surgicaldrill(src)
...
/obj/item/weapon/robot_module/engineering/New()
	...
	modules += new /obj/item/weapon/tool/weldingtool/largetank(src)
...
/obj/item/weapon/robot_module/syndicate/blitzkrieg/New()
	...
	modules += new /obj/item/weapon/tool/wrench(src) //This thing supposed to be a hacked and modded combat cyborg, is it really going to be stopped by a chair or table?
...
/obj/item/weapon/robot_module/combat/New()
	...
	modules += new /obj/item/weapon/tool/wrench(src) //Is a combat machine really going to be stopped by a chair?

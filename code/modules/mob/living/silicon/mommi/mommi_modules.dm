...
/obj/item/weapon/robot_module/mommi/New(var/mob/living/silicon/robot/R)
	...
	//modules += new /obj/item/weapon/rcd/borg(src)     // Too OP
	//modules += new /obj/item/device/flashlight(src)   // Broken
	...
	modules += new /obj/item/weapon/extinguisher(src) // Aurx sed so

...
/datum/loot_table/bedsheet
	loot = list(
		/obj/item/bedsheet/black = COMMON_LOOT,
		/obj/item/bedsheet/blue = COMMON_LOOT,
		/obj/item/bedsheet/brown = COMMON_LOOT,
		/obj/item/bedsheet/green = COMMON_LOOT,
		/obj/item/bedsheet/medical = COMMON_LOOT,
		/obj/item/bedsheet/orange = COMMON_LOOT,
		/obj/item/bedsheet/plaid = UNCOMMON_LOOT,
		/obj/item/bedsheet/purple = COMMON_LOOT,
		/obj/item/bedsheet/red = COMMON_LOOT,
		/obj/item/bedsheet/yellow = COMMON_LOOT,
		/obj/item/bedsheet/clown = UNCOMMON_LOOT,
		/obj/item/bedsheet/linen = UNCOMMON_LOOT,
		/obj/item/bedsheet/mime = UNCOMMON_LOOT,
		/obj/item/bedsheet/rainbow = UNCOMMON_LOOT,
		/obj/item/bedsheet/rd = RARE_LOOT,
		/obj/item/bedsheet/hop = RARE_LOOT,
		/obj/item/bedsheet/hos = RARE_LOOT,
		/obj/item/bedsheet/captain = RARE_LOOT,
		/obj/item/bedsheet/ce = RARE_LOOT,
	)
...
/datum/loot_table/bureaucracy
	loot = list(
		...
		/obj/item/weapon/pen/sleepy = UNCOMMON_LOOT,
		...
		/obj/item/weapon/tempglue = UNCOMMON_LOOT,

...
/datum/surgery_step/appendectomy/cut_appendix
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/datum/organ/external/groin = target.get_organ("groin")
		user.visible_message("<span class=\"rose\">[user]'s hand slips, slicing an artery inside [target]'s abdomen with \the [tool]!</span>", \
		"<span class=\"rose\">Your hand slips, slicing an artery inside [target]'s abdomen with \the [tool]!</span>")
...
/datum/surgery_step/appendectomy/remove_appendix
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		user.visible_message("<span class=\"rose\">[user]'s hand slips, nicking internal organs in [target]'s abdomen with \the [tool]!</span>", \
		"<span class=\"rose\">Your hand slips, nicking internal organs in [target]'s abdomen with \the [tool]!</span>")

...
///////MEND ROOTS///////
/datum/surgery_step/tooth/mend_roots
	allowed_tools = list(
...
/datum/surgery_step/tooth/mend_roots/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.face == 1


/datum/surgery_step/tooth/mend_roots/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/tooth/mend_roots/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	target.op_stage.tooth = 1

/datum/surgery_step/tooth/mend_roots/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/datum/organ/external/affected = target.get_organ(target_zone)
...
////////ADD NEW TEETH//////
/datum/surgery_step/tooth/new_teeth
	allowed_tools = list(
...
/datum/surgery_step/tooth/new_teeth/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	return ..() && target.op_stage.tooth == 1 && teeth_missing

/datum/surgery_step/tooth/new_teeth/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/tooth/new_teeth/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/tooth/new_teeth/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/datum/organ/external/affected = target.get_organ(target_zone)
...
///////SET JAWS///////
/datum/surgery_step/extract/set_jaws
	allowed_tools = list(
...
/datum/surgery_step/extract/set_jaws/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	return ..()


/datum/surgery_step/extract/set_jaws/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/extract/set_jaws/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	target.op_stage.extract = 1

/datum/surgery_step/extract/set_jaws/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/datum/organ/external/affected = target.get_organ(target_zone)
	...
	///////EXTRACT TOOTH///////
/datum/surgery_step/extract/pull_tooth
	allowed_tools = list(
...
/datum/surgery_step/extract/pull_tooth/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	return ..() && target.op_stage.extract == 1 && has_teeth


/datum/surgery_step/extract/pull_tooth/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/extract/pull_tooth/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/extract/pull_tooth/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/datum/organ/external/affected = target.get_organ(target_zone)
...
///////RESET JAWS///////
/datum/surgery_step/extract/reset
	allowed_tools = list(
		/obj/item/weapon/bonesetter = 100,
		/obj/item/weapon/wrench = 75,
		)
...
/datum/surgery_step/extract/reset/can_use(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	return ..() && target.op_stage.extract == 1


/datum/surgery_step/extract/reset/begin_step(mob/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/extract/reset/end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	...
	target.op_stage.extract = 0

/datum/surgery_step/extract/reset/fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
	var/datum/organ/external/affected = target.get_organ(target_zone)
	user.visible_message("<span class='warning'>[user]'s hand slips, painfully popping [target]'s jaw with \the [tool]!</span>", \
	"<span class='warning'>Your hand slips, painfully popping [user]'s jaw with \the [tool]!</span>")
	target.apply_damage(5, BRUTE, affected)
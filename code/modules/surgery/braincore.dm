...
/datum/surgery_step/brain/saw_skull
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, cracking [target]'s skull with \the [tool]!</span>" , \
		"<span class=\"rose\">Your hand slips, cracking [target]'s skull with \the [tool]!</span>" )
...
/datum/surgery_step/brain/cut_brain
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, cutting a vein in [target]'s brain with \the [tool]!</span>", \
		"<span class=\"rose\">Your hand slips, cutting a vein in [target]'s brain with \the [tool]!</span>")
...
/datum/surgery_step/brain/bone_chips
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, jabbing \the [tool] in [target]'s brain!</span>", \
		"<span class=\"rose\">Your hand slips, jabbing \the [tool] in [target]'s brain!</span>")
		target.apply_damage(30, BRUTE, "head", 1)
...
/datum/surgery_step/brain/hematoma
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, bruising [target]'s brain with \the [tool]!</span>", \
		"<span class=\"rose\">Your hand slips, bruising [target]'s brain with \the [tool]!</span>")
...
/datum/surgery_step/slime/cut_flesh
	...
	fail_step(mob/living/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, tearing [target]'s flesh with \the [tool]!</span>", \
		"<span class=\"rose\">Your hand slips, tearing [target]'s flesh with \the [tool]!</span>")
...
/datum/surgery_step/slime/cut_innards
	...
	fail_step(mob/living/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, tearing [target]'s innards with \the [tool]!</span>", \
		"<span class=\"rose\">Your hand slips, tearing [target]'s innards with \the [tool]!</span>")
...
/datum/surgery_step/slime/saw_core
	...
	fail_step(mob/living/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, failing to cut core out!</span>", \
		"<span class=\"rose\">Your hand slips, failing to cut core out!</span>")
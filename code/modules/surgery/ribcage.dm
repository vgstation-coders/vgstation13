...
/datum/surgery_step/ribcage/saw_ribcage
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user]'s hand slips, cracking [target]'s ribcage with \the [tool]!</span>" , \
		"<span class=\"rose\">Your hand slips, cracking [target]'s ribcage with \the [tool]!</span>" )
		var/datum/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/ribcage/retract_ribcage
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/msg = "<span class=\"rose\">[user]'s hand slips, breaking [target]'s ribcage!</span>"
		var/self_msg = "<span class=\"rose\">Your hand slips, breaking [target]'s ribcage!</span>"
		user.visible_message(msg, self_msg)
		var/datum/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/ribcage/close_ribcage
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/msg = "<span class=\"rose\">[user]'s hand slips, bending [target]'s ribcage in a wrong shape!</span>"
		var/self_msg = "<span class=\"rose\">Your hand slips, bending [target]'s ribcage in a wrong shape!</span>"
		user.visible_message(msg, self_msg)
		var/datum/organ/external/chest/affected = target.get_organ("chest")
		affected.createwound(BRUISE, 20)
		affected.fracture()
		if (prob(40))
			user.visible_message("<span class=\"rose\">Rib pierces the lung!</span>")
			target.rupture_lung()
...
/datum/surgery_step/ribcage/remove_embryo
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		user.visible_message("<span class=\"rose\">[user] rips the larva out of [target]'s ribcage!</span>",
...
/datum/surgery_step/ribcage/fix_chest_internal
	...
	fail_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		var/datum/organ/external/chest/affected = target.get_organ("chest")
		user.visible_message("<span class=\"rose\">[user]'s hand slips, slicing an artery inside [target]'s chest with \the [tool]!</span>", \
		"<span class=\"rose\">Your hand slips, slicing an artery inside [target]'s chest with \the [tool]!</span>")
		affected.createwound(CUT, 20)

...
/datum/seed/proc/random_name(var/seed_suffix = "plant", var/plant_suffix = "plants")

	var/prefix = pick("strange","experimental","alien","unidentified","mysterious")

	seed_name = prefix + " " + seed_suffix
	display_name = prefix + " " + plant_suffix
...
/datum/seed/proc/randomize_icon(var/change_packet = 1)
	var/list/plant_icons = pick(list(
		list("seed-chili",              "chili",				6,	"plant",	"plants"),
		list("seed-icepepper",          "chiliice",				6,	"plant",	"plants"),
		list("seed-berry",              "berry",				6,	"plant",	"plants"),
		list("seed-glowberry",          "glowberry",			6,	"plant",	"plants"),
		list("seed-poisonberry",        "poisonberry",			6,	"plant",	"plants"),
		list("seed-deathberry",         "deathberry",			6,	"plant",	"plants"),
		list("seed-nettle",             "nettle",				6,	"plant",	"weeds"),
		list("seed-deathnettle",        "deathnettle",			6,	"plant",	"weeds"),
		list("seed-tomato",             "tomato",				6,	"plant",	"vines"),
		list("seed-bloodtomato",        "bloodtomato",			6,	"plant",	"vines"),
		list("seed-killertomato",       "killertomato",			2,	"plant",	"vines"),
		list("seed-bluetomato",         "bluetomato",			6,	"plant",	"vines"),
		list("seed-bluespacetomato",    "bluespacetomato",		6,	"plant",	"vines"),
		list("seed-eggplant",           "eggplant",				6,	"plant",	"plants"),
		list("seed-eggy",               "eggy",					6,	"plant",	"plants"),
		list("seed-apple",              "apple",				6,	"fruit",	"trees"),
		list("seed-goldapple",          "goldapple",			6,	"fruit",	"trees"),
		list("seed-ambrosiavulgaris",   "ambrosiavulgaris",		6,	"plant",	"weeds"),
		list("seed-ambrosiadeus",       "ambrosiadeus",			6,	"plant",	"weeds"),
		list("mycelium-chanter",        "chanter",				3,	"fungal",	"mushrooms"),
		list("mycelium-plump",          "plump",				3,	"fungal",	"mushrooms"),
		list("mycelium-reishi",         "reishi",				4,	"fungal",	"mushrooms"),
		list("mycelium-liberty",        "liberty",				3,	"fungal",	"mushrooms"),
		list("mycelium-amanita",        "amanita",				3,	"fungal",	"mushrooms"),
		list("mycelium-angel",          "angel",				3,	"fungal",	"mushrooms"),
		list("mycelium-tower",          "towercap",				3,	"fungal",	"mushrooms"),
		list("mycelium-glowshroom",     "glowshroom",			4,	"fungal",	"mushrooms"),
		list("mycelium-walkingmushroom","walkingmushroom",		3,	"fungal",	"mushrooms"),
		list("mycelium-plast",          "plastellium",			3,	"fungal",	"mushrooms"),
		list("seed-harebell",           "harebell",				4,	"flower",	"flowers"),
		list("seed-poppy",              "poppy",				3,	"flower",	"flowers"),
		list("seed-sunflower",          "sunflower",			3,	"flower",	"flowers"),
		list("seed-moonflower",         "moonflower",			3,	"flower",	"flowers"),
		list("seed-novaflower",         "novaflower",			3,	"flower",	"flowers"),
		list("seed-grapes",             "grape",				2,	"fruit",	"vines"),
		list("seed-greengrapes",        "greengrape",			2,	"fruit",	"vines"),
		list("seed-peanut",             "peanut",				6,	"plant",	"plants"),
		list("seed-cabbage",            "cabbage",				1,	"plant",	"plants"),
		list("seed-shand",              "shand",				3,	"plant",	"plants"),
		list("seed-mtear",              "mtear",				4,	"plant",	"plants"),
		list("seed-banana",             "banana",				6,	"fruit",	"trees"),
		list("seed-corn",               "corn",					3,	"plant",	"stalks"),
		list("seed-potato",             "potato",				4,	"plant",	"plants"),
		list("seed-soybean",            "soybean",				6,	"bean",		"plants"),
		list("seed-koibean",            "soybean",				6,	"bean",		"plants"),
		list("seed-wheat",              "wheat",				6,	"plant",	"plants"),
		list("seed-rice",               "rice",					4,	"plant",	"plants"),
		list("seed-carrot",             "carrot",				3,	"plant",	"plants"),
		list("seed-ambrosiavulgaris",   "weeds",				4,	"plant",	"weeds"),
		list("seed-whitebeet",          "whitebeet",			6,	"plant",	"beets"),
		list("seed-sugarcane",          "sugarcane",			3,	"plant",	"canes"),
		list("seed-watermelon",         "watermelon",			6,	"plant",	"melons"),
		list("seed-pumpkin",            "pumpkin",				2,	"plant",	"plants"),
		list("seed-lime",               "lime",					6,	"fruit",	"trees"),
		list("seed-lemon",              "lemon",				6,	"fruit",	"trees"),
		list("seed-orange",             "orange",				6,	"fruit",	"trees"),
		list("seed-grass",              "grass",				2,	"grass",	"grass"),
		list("seed-cocoapod",           "cocoapod",				5,	"plant",	"plants"),
		list("seed-cherry",             "cherry",				5,	"fruit",	"trees"),
		list("seed-kudzu",              "kudzu",				4,	"vine",		"vines"),
		list("seed-pear",               "pear", 				6,	"fruit",	"trees"),
		))
	...
	random_name(plant_icons[4], plant_icons[5])

...
// return 0 if the implant fails (ex. Revhead gets a loyalty implant.)
// return 1 if the implant succeeds (ex. Nonrevhead gets a loyalty implant.)
...
/obj/item/weapon/implant/loyalty/attempt_implant(mob/M)
	if(!iscarbon(M))
		return 0
...
/obj/item/weapon/implant/traitor/attempt_implant(mob/M, mob/user)
	if(!iscarbon(M))
...
/obj/item/weapon/implant/adrenalin/attempt_implant(mob/source)
		...
		to_chat(source, "The attempt_implant freedom implant can be activated by using the pale emote, <B>say *pale</B> to attempt to activate.")
		return 1
...
/obj/item/weapon/implant/compressed/attempt_implant(mob/source as mob)
...
/obj/item/weapon/implant/peace/attempt_implant(mob/host)

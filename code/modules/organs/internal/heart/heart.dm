...
/datum/organ/internal/heart/cell/proc/create_cell()
	cell = new /obj/item/weapon/cell/empty()

/datum/organ/internal/heart/cell/full/create_cell()
	cell = new /obj/item/weapon/cell()

/datum/organ/internal/heart/cell/Life()
	if(owner && owner.nutrition > 200) //200 is currently just around low nutrition, so starting nutrition takes an empty cell to 60%

...
/datum/lung_gas/toxic
	...
	var/reagent_id = PHORON // What reagent to add
	var/reagent_mult = 10

/datum/lung_gas/toxic/New(var/gas_id, var/trace_gas=0, var/max_pp=0, var/max_pp_mask=0, var/reagent_id=PHORON, var/reagent_mult=10)
	..(gas_id,trace_gas)
	src.max_pp = max_pp

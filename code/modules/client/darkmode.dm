...
/client/proc/dark_theme()
	...
	//Buttons
	winset(src, "textb", 			"background-color = #3a3a3a;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "infob", 			"background-color = #3a3a3a;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "wikib", 			"background-color = #494949;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "forumb", 		"background-color = #494949;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "rulesb", 		"background-color = #494949;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "changelog", 	"background-color = #494949;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "mapb", 			"background-color = #3a3a3a;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "github", 		"background-color = #3a3a3a;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "special_button", "background-color = #3a3a3a;text-color = [COLOR_DARKMODE_TEXT]")
	//Status and verb tabs

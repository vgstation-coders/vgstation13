...
/obj/item/clothing/head/helmet/space/rig
	...
	eyeprot = 3
	species_fit = list(GREY_SHAPED, TAJARAN_SHAPED, INSECT_SHAPED, AVALI_SHAPED)
...
/obj/item/clothing/suit/space/rig/mining
	...
	species_restricted = list("exclude",VOX_SHAPED, AVALI_SHAPED)
	pressure_resistance = 40 * ONE_ATMOSPHERE
	clothing_flags = GOLIATHREINFORCE
...
/obj/item/clothing/head/helmet/space/rig/syndi
	...
	species_fit = list(VOX_SHAPED, GREY_SHAPED, SKRELL_SHAPED, UNATHI_SHAPED, TAJARAN_SHAPED, INSECT_SHAPED, AVALI_SHAPED)
	_color = "syndi"
...
/obj/item/clothing/suit/space/rig/syndi
	...
	species_fit = list(VOX_SHAPED, SKRELL_SHAPED, UNATHI_SHAPED, TAJARAN_SHAPED, INSECT_SHAPED, AVALI_SHAPED)

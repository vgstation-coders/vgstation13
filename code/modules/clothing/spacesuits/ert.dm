...
/obj/item/clothing/head/helmet/space/ert/equipped(var/mob/M)
	...
	if(H.get_item_by_slot(slot_head) == src)
		var/obj/item/card/id/worn_id = H.get_item_by_slot(slot_wear_id)
		if(istype(worn_id))
...
/obj/item/clothing/suit/space/ert
	...
	clothing_flags = PLASMAGUARD
	pressure_resistance = 200 * ONE_ATMOSPHERE
	allowed = list(/obj/item/device/flashlight, /obj/item/tank, /obj/item/device/t_scanner, /obj/item/device/rcd, /obj/item/crowbar, \
...
/obj/item/clothing/suit/space/ert/medical
	...
	/obj/item/screwdriver, /obj/item/weldingtool, /obj/item/wirecutters, /obj/item/wrench, /obj/item/device/multitool, \
	/obj/item/device/radio, /obj/item/device/analyzer, /obj/item/gun/energy/laser, /obj/item/gun/energy/pulse_rifle, \
	/obj/item/gun/energy/taser, /obj/item/melee/baton, /obj/item/gun/energy/gun, /obj/item/roller)

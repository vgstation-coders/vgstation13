...
/datum/event/money_lotto/announce()
	...
	LA.message = "A lotto number draw is scheduled to happen within the next [delaytime] minutes. All nearby entertainment monitors will be broadcasting the results"
	command_alert(LA)

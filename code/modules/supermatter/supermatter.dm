...
/obj/machinery/power/supermatter/process()
	...
	removed.adjust_gas(GAS_PLASMA, max(device_energy / PLASMA_RELEASE_MODIFIER, 0), FALSE)

	removed.adjust_gas(GAS_OXYGEN, max((device_energy + removed.temperature - T0C) / OXYGEN_RELEASE_MODIFIER, 0))

	...
	if(candidates.len)
		...
		for (var/obj/effect/landmark/L in world)
			if(L.name == "voxstart")
				...
				new_vox << "<span class=\"notice\">You are a Vox Primalis, fresh out of the Shoal. Your ship has arrived at the Tau Ceti system hosting the NSV Exodus... or was it the Luna? NSS? Utopia? Nobody is really sure, but everyone is raring to start pillaging! Your current goal is: </span><span class=\"danger\">[input]</span>"
				new_vox << "<span class=\"rose\">Don't forget to turn on your nitrogen internals!</span>"

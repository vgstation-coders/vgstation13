...
/client/proc/cmd_admin_prison(mob/M as mob in mob_list)
	...
	if (ismob(M))
		...
		spawn(50)
			M << "<span class=\"rose\">You have been sent to the prison station!</span>"
...
/client/proc/cmd_admin_world_narrate() // Allows administrators to fluff events a little easier -- TLE
	...
	message_admins("<span class=\"notice\"><b>GlobalNarrate: [key_name_admin(usr)] : [msg]</b></span><BR>", 1)
...
/client/proc/cmd_admin_direct_narrate(var/mob/M)	// Targetted narrate -- TLE
	...
	message_admins("<span class=\"notice\"><b>DirectNarrate: [key_name(usr)] to ([M.name]/[M.key]): [msg]</b></span><BR>", 1)
...
/client/proc/toggle_antagHUD_use()
	...
	if(config.antag_hud_allowed)
		...
		src << "<span class=\"danger\">ntagHUD usage has been disabled</span>"
		action = "disabled"
	else
		for(var/mob/dead/observer/g in get_ghosts())
	...
	for(var/mob/living/silicon/ai/M in mob_list)
		if (M.stat == 2)
			...
			for(var/mob/living/silicon/ai/O in mob_list)
				O << "<span class=\"rose\">" + input + "</span><span class=\"rose\">...LAWS UPDATED</span>"
...
/client/proc/cmd_admin_rejuvenate(mob/living/M as mob in mob_list)
	...
	if(config.allow_admin_rev)
		...
		message_admins("<span class=\"rose\">Admin [key_name_admin(usr)] healed / revived [key_name_admin(M)]!</span>", 1)
	else
...
/client/proc/cmd_admin_create_centcom_report()
	...
	switch(alert("Should this be announced to the general population?",,"Yes","No"))
		...
		if("No")
			world << "<span class=\"rose\">New NanoTrasen Update available at all communication consoles.</span>"
...
/client/proc/cmd_manual_ban()
	...
	if("Yes")
		...
		if(M)
			...
			M << "<span class=\"rose\">To try to resolve this matter head to http://ss13.donglabs.com/forum/</span>"

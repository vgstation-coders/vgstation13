...
//Spawns commandos and equips them.
	for(var/obj/effect/landmark/L in landmarks_list)
		...
		if (L.name == "Syndicate-Commando")
			...
			if(nuke_code)
				new_syndicate_commando.mind.store_memory("<B>Nuke Code: </B> <span class=\"rose\">[nuke_code].</span>")
			new_syndicate_commando.mind.store_memory("<B>Mission:</B><span class=\"rose\">[input].</span>")

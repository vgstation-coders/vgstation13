...
//				message_admins("[key_name_admin(usr)] has triggered a battle to the death (only one)")
			...
			if("meteorstorm")
				...
				if(choice == "BRING ME MY FRIDGE")
					var/choice_second = input("Are you still sure you want to summon a meteor storm? I REPEAT, DO NOT USE THIS IF SHUTTLE IS ACTIVE IN ANY DIRECTION. Misuse of this could result in removal of flags or hilarity.") in list("WORKED FOR INDIANA JONES", "Cancel")

...
/turf/unsimulated/mineral/New()
	...
	spawn(1)
		...
		if((istype(get_step(src, NORTH), /turf/simulated/floor)) || (istype(get_step(src, NORTH), /turf/space)) || (istype(get_step(src, NORTH), /turf/simulated/shuttle/floor)))
			...
			if (T)
				T.overlays += image('icons/turf/walls.dmi', "rock_side", dir = 2)
		if((istype(get_step(src, SOUTH), /turf/simulated/floor)) || (istype(get_step(src, SOUTH), /turf/space)) || (istype(get_step(src, SOUTH), /turf/simulated/shuttle/floor)))
			T = get_step(src, SOUTH)
			if (T)
				T.overlays += image('icons/turf/walls.dmi', "rock_side", layer=6, dir = 1)
		if((istype(get_step(src, EAST), /turf/simulated/floor)) || (istype(get_step(src, EAST), /turf/space)) || (istype(get_step(src, EAST), /turf/simulated/shuttle/floor)))
			T = get_step(src, EAST)
			if (T)
				T.overlays += image('icons/turf/walls.dmi', "rock_side", layer=6, dir = 8)
		if((istype(get_step(src, WEST), /turf/simulated/floor)) || (istype(get_step(src, WEST), /turf/space)) || (istype(get_step(src, WEST), /turf/simulated/shuttle/floor)))
			T = get_step(src, WEST)
			if (T)
				T.overlays += image('icons/turf/walls.dmi', "rock_side", layer=6, dir = 4)
	/*
...
/turf/unsimulated/floor/asteroid/proc/updateMineralOverlays()
	...
	if(istype(get_step(src, NORTH), /turf/unsimulated/mineral))
		src.overlays += image('icons/turf/walls.dmi', "rock_side", dir = 1)
	if(istype(get_step(src, SOUTH), /turf/unsimulated/mineral))
		src.overlays += image('icons/turf/walls.dmi', "rock_side", layer=6, dir = 2)
	if(istype(get_step(src, EAST), /turf/unsimulated/mineral))
		src.overlays += image('icons/turf/walls.dmi', "rock_side", layer=6, dir = 4)
	if(istype(get_step(src, WEST), /turf/unsimulated/mineral))
		src.overlays += image('icons/turf/walls.dmi', "rock_side", layer=6, dir = 8)

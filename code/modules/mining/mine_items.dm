...
proc/move_mining_shuttle()
	...
	spawn(mining_shuttle_launchdelay)
		var/area/fromArea
		var/area/transitArea
		var/area/toArea
		transitArea = locate(/area/shuttle/mining/transit)
		if(mining_shuttle_location == 1) //Currently at the mining outpost
			fromArea = locate(/area/shuttle/mining/outpost)
			toArea = locate(/area/shuttle/mining/station)
			mining_loc_expected = 0 //It's going to the station
		else if(mining_shuttle_location == 0) //Currently at the station
			fromArea = locate(/area/shuttle/mining/station)
			toArea = locate(/area/shuttle/mining/outpost)
			mining_loc_expected = 1 //It's going to the outpost
		...
		spawn(mining_shuttle_transitdelay)
			...
			mining_shuttle_location = mining_loc_expected

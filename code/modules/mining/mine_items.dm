...
/obj/item/weapon/pickaxe/drill/orangetransparentchainsaw
	...
	origin_tech = Tc_MATERIALS + "=4;" + Tc_POWERSTORAGE + "=4;" + Tc_ENGINEERING + "=6;" + Tc_PLASMATECH + "=4;" + Tc_BIOTECH + "=5;" + Tc_COMBAT + "=4"
	desc = "Yours is the saw that will cut the ice! And people, I guess."
	starting_materials = list(MAT_IRON = 6000, MAT_GLASS = 1000, MAT_PLASMA = 6000, MAT_PLASTIC = 3000)
	drill_verb = "cutting"

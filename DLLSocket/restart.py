...
sock.settimeout(60*5) # 10 minute timeout
while True:
    try:
        ...
        subprocess.call("killall -9 DreamDaemon", shell=True)
        subprocess.call("screen -S ss13 -X exec .\!\! echo /home/ss13/vgstation13/1.sh", shell=True)

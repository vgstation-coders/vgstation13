...
type Data = {
  ...
  first_flow_cap: number,
  first_in_pressure: number,
  first_in_temp: number,
  first_out_pressure: number,
  first_out_temp: number,

  second_flow_cap: number,
  second_in_pressure: number,
  second_in_temp: number,
  second_out_pressure: number,
  second_out_temp: number,
}

...
#define CYBORG_ENGINEERING_SPEED_MODIFIER 0.8
#define CYBORG_MEDICAL_SPEED_MODIFIER 0.8
#define CYBORG_SYNDICATE_SPEED_MODIFIER 0.8
#define CYBORG_SUPPLY_SPEED_MODIFIER 0.9
#define CYBORG_JANITOR_SPEED_MODIFIER 0.9
#define CYBORG_COMBAT_SPEED_MODIFIER 0.9
...
#define MOMMI_SOVIET_SPEED_MODIFIER 0.9
#define MOMMI_NT_SPEED_MODIFIER 1

#define SILICON_MOBILITY_MODULE_SPEED_MODIFIER 0.75

#define SILICON_NO_CHARGE_SLOWDOWN 3

...
#define CARGO_POSITION list("Head of Personnel", "Quartermaster", "Cargo Technician", "Shaft Miner")
#define SECURITY_POSITION list("Head of Security", "Warden", "Detective", "Security Officer")
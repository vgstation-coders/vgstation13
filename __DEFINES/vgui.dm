...
#define VGUI_WINDOW_SOFT_LIMIT 0

/// Maximum number of open windows
#define VGUI_WINDOW_HARD_LIMIT 9

/// Maximum ping timeout allowed to detect zombie windows
#define VGUI_PING_TIMEOUT 4 SECONDS

/// Window does not exist
#define VGUI_WINDOW_CLOSED 0
/// Window was just opened, but is still not ready to be sent data
#define VGUI_WINDOW_LOADING 1
/// Window is free and ready to receive data
#define VGUI_WINDOW_READY 2

/// Get a window id based on the provided pool index
#define VGUI_WINDOW_ID(index) "vgui-window-[index]"
/// Get a pool index of the provided window id
#define VGUI_WINDOW_INDEX(window_id) text2num(copytext(window_id, 13))
...
#define VGUI_CREATE_MESSAGE(type, payload) ( \

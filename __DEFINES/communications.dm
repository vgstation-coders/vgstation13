...
var/list/freq_text = list(COMMON,SECURITY_COMM,ENGINEERING,COMMAND,MEDICAL,SCIENCE,SERVICE,CARGO,DEATHSQUAD_COMM,RESPONSE,AIPRIVATE,DJ,REV_COMM, SYND, RAIDER)

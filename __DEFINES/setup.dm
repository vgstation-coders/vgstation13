...
#define SERRATED_BLADE	4 // Has saw-like teeth to cut through harder materials. The serrated edge may not necessarily be sharp!
...
#define INSULATED_EDGE 	16 // One of the edges of this thing is insulated, so you could cut through a live wire even if the handle or thing itself isn't insulated.

...
# From TGstation: https://github.com/tgstation/tgstation/tree/master/tools/dmi
# Modified by /vg/station
...
class DmiDriver(MergeDriver):
    driver_id = 'merge-dmi'  # Must match .gitattributes: *.dmi merge=merge-dmi
